...
| [`tinycortex::memory::ingest::canonicalize`](../../../vendor/tinycortex/src/memory/ingest/canonicalize/) | Source → canonical markdown (chat / email / document), owned by TinyCortex and used at ingest time. |
