...
const it1: TranslationMap = {
  ...
  'settings.search.localManagedUnavailable':
    'La ricerca gestita OpenHuman non è disponibile per gli utenti locali. Aggiungi la tua chiave API di Parallel, Brave o Querit per abilitare la ricerca sul web.',
