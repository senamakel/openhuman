        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-3">
            ...
            <textarea
              ...
              className="w-full resize-y rounded-lg border border-ocean-200 bg-white px-2.5 py-1.5 text-sm text-ink shadow-inner outline-none focus:border-ocean-400 disabled:opacity-50 dark:border-ocean-800 dark:bg-surface-canvas dark:text-content"
            />
