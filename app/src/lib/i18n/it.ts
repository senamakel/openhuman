...
const messages: TranslationMap = {
  ...
  'settings.sandbox.menuDesc': "Configura i backend sandbox per l'isolamento degli strumenti agente.",
  ...
  'settings.sandbox.backendDesc': "Scegli quale backend di isolamento utilizzare per l'esecuzione in sandbox.",
