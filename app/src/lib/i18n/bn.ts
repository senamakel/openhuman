...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'প্রতি ৩০ মিনিটে শুধুমাত্র পঠনযোগ্য পর্যবেক্ষণ। শুধু মেমরি ও ফাইল অ্যাক্সেস।',
  'subconscious.mode.aggressive.title': 'আক্রমণাত্মক',
  'subconscious.mode.aggressive.desc': 'প্রতি ৫ মিনিটে সম্পূর্ণ টুল অ্যাক্সেস। লিখতে, এজেন্ট তৈরি ও কাজ অর্পণ করতে পারে।',
  'subconscious.mode.aggressiveWarning': 'আক্রমণাত্মক মোড অবচেতনকে লেখা ও সাব-এজেন্ট তৈরিসহ সম্পূর্ণ টুল অ্যাক্সেস দেয়।',
