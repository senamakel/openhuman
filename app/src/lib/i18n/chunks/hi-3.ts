...
const hi3: TranslationMap = {
  ...
  'app.connectionIndicator.reconnecting': 'कनेक्ट हो रहा है',
  ...
  'app.openhumanLink.notifications.sent': 'भेज दिया',
  ...
  'app.routeLoading.initializing': 'इनिशियलाइज़ हो रहा है',
  ...
  'app.update.progress.downloaded': '${formatBytes(downloaded)} डाउनलोड हुआ',
