...
const zhCN3: TranslationMap = {
  ...
  'app.connectionIndicator.reconnecting': '连接中',
  ...
  'app.openhumanLink.notifications.sent': '已发送',
  ...
  'app.routeLoading.initializing': '初始化中',
  ...
  'channels.discord.picker.serverChannelSelection': '选择服务器和频道',
