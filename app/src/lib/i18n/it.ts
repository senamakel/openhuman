...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.denied.next': 'Niente da fare — non è stata eseguita. Richiedila di nuovo se cambi idea.',
  'conversations.toolFailure.approvalExpired.cause': 'La richiesta di approvazione è scaduta prima che qualcuno rispondesse.',
  'conversations.toolFailure.approvalExpired.next': 'Richiedila di nuovo per eseguirla — OpenHuman non riproverà da solo.',
