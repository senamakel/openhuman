...
const en1: TranslationMap = {
  ...
  'settings.notifications.channelControlsDesc': 'Configure notification preferences for each channel',
  ...
  'welcome.subtitle': 'Your personal AI super intelligence. Private, simple and extremely powerful.',
  ...
  'home.statusOk': 'Your device is connected. Keep the app running to keep the connection alive. Message your agent with the button below.',
  ...
  'home.statusInternetOffline': 'Your device is offline right now. Check your network or restart the app to reconnect.',
  ...
  'onboarding.welcomeDesc': 'Your super-intelligent AI assistant that runs on your computer. Private, simple, and extremely powerful.',
  ...
  'onboarding.runtimeChoice.subtitle': 'Pick the setup that fits you best. You can change this later in Settings.',
  ...
  'mnemonic.copyWarning': 'Never share your recovery phrase. Anyone with these words can access your account.',
