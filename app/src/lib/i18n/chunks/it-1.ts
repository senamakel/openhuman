...
const it1: TranslationMap = {
  ...
  'skills.integrationsSubtitle': 'Cloud-based OAuth connections — sign in with your account and Composio brokers the tokens so agents can read and act on your behalf. No API keys to manage.',
  ...
  'settings.about.connectionHelperLocal': 'Spawned in-process by the Tauri shell on app launch. The port is chosen at startup, so this URL changes between launches.',
  'settings.about.connectionHelperCloud': 'Connected to a remote core. Change this in BootCheck or the cloud mode picker.',
  ...
  'settings.search.menuDesc': 'Default to OpenHuman-managed search or wire up your own provider with an API key.',
  'settings.search.description': 'Pick the search engine the agent uses. Managed uses OpenHuman’s backend (no setup). Parallel and Brave run direct from your machine using your API key.',
  'settings.search.engineAria': 'Search engine',
  'settings.search.engineManagedLabel': 'OpenHuman Managed',
  'settings.search.engineManagedDesc': 'Default. Routed through the OpenHuman backend — no API key required.',
  'settings.search.engineParallelLabel': 'Parallel',
  'settings.search.engineParallelDesc': 'Direct Parallel API: search, extract, chat, research, enrich, dataset tools.',
  ...
  'settings.search.fallbackToManaged': 'No key configured — search will fall back to Managed until a key is saved.',
