        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              onClick={() => void loadCouponState()}
              disabled={loading}
              className="text-xs font-medium text-stone-500 dark:text-neutral-400 dark:text-neutral-400 transition-colors hover:text-stone-700 dark:hover:text-neutral-200 dark:text-neutral-200 dark:hover:text-neutral-200 dark:text-neutral-200 disabled:opacity-50">
              {t('common.refresh')}
            </button>
          </div>
                ...
                <tbody className="divide-y divide-stone-100 dark:divide-neutral-800 dark:divide-neutral-800">
                  {redeemedCoupons.map(coupon => (
                    <tr
                      ...
                      <td className="px-3 py-2 text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400">
