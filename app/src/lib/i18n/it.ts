...
const messages: TranslationMap = {
  ...
  'settings.tokenUsage.menuDesc': 'Impostazioni di compressione e quanti token e dollari hanno fatto risparmiare',
  ...
  'settings.tokenUsage.compressionDesc': 'Compattazione consapevole del contenuto dei grandi output degli strumenti prima che entrino nel contesto del modello.',
  ...
  'settings.tokenUsage.searchDesc': 'Ordina l’output di grep/ricerca per pertinenza, mantenendo le corrispondenze migliori.',
  ...
  'settings.tokenUsage.mlDesc': 'Modello ModernBERT locale per testo semplice (richiede l’ambiente di esecuzione Python).',
  'settings.tokenUsage.ccrTitle': 'Cache e recupero (CCR)',
  'settings.tokenUsage.ccrDesc': 'Gli originali compattati vengono memorizzati nella cache così l’agente può recuperare il testo completo su richiesta.',
  'settings.tokenUsage.ccrEnabled': 'Conserva gli originali per il recupero',
  'settings.tokenUsage.ccrEnabledDesc': 'Sposta l’originale e aggiungi un indicatore di recupero così non si perde nulla.',
  'settings.tokenUsage.ccrMinTokens': 'Dimensione minima da memorizzare nella cache',
  'settings.tokenUsage.ccrMinTokensDesc': 'Memorizza nella cache e compatta con perdita solo i risultati stimati a questo numero di token o più.',
  'settings.tokenUsage.tokensUnit': 'token',
  'settings.tokenUsage.ccrDisk': 'Mantieni la cache su disco',
  'settings.tokenUsage.ccrDiskDesc': 'Conserva gli originali recuperabili tra un riavvio e l’altro.',
