      ...
      <div className="max-w-2xl mx-auto w-full p-4 space-y-4">
        ...
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 space-y-3">
          ...
          <div className="space-y-1">
            <div className="text-xs text-stone-600 dark:text-neutral-300">Context Override (optional)</div>
            <textarea
        ...
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">Live Logs</h3>
            <button
              type="button"
              onClick={clearLogs}
        ...
        {/* ------------------------------------------------------------------ */}
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 space-y-3">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">Advanced Settings</h3>
          ...
          <div className="space-y-1">
            <div className="text-xs text-stone-600 dark:text-neutral-300">Style Examples (one per line)</div>
            <textarea
        ...
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">Personalization History</h3>
            <button
              type="button"
