            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <label className="block space-y-1">
                ...
                <select
                  ...
                  className="w-full rounded-md border border-stone-200 dark:border-neutral-800 dark:border-neutral-700 bg-white dark:bg-neutral-900 dark:bg-neutral-800 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 dark:text-neutral-100 focus:outline-none focus:ring-1 focus:ring-primary-400">
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  <span
                    ...
                    className={`text-[11px] ${
                      whisperReady
                        ? 'text-emerald-600 dark:text-emerald-300 dark:text-emerald-400'
                        : whisperInstall?.state === 'error'
                          ? 'text-red-600 dark:text-red-300 dark:text-red-400'
                          : 'text-stone-500 dark:text-neutral-400 dark:text-neutral-400'
                    }`}>
                ...
                <label className="block space-y-1">
                  ...
                  {!PIPER_VOICE_PRESETS.some(v => v.id === ttsVoice) && (
                    <input
                      ...
                      className="mt-1 w-full rounded-md border border-stone-200 dark:border-neutral-800 dark:border-neutral-700 bg-white dark:bg-neutral-900 dark:bg-neutral-800 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 dark:text-neutral-100 placeholder:text-stone-400 dark:placeholder:text-neutral-500 dark:text-neutral-500 dark:placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-primary-400"
                    />
                  )}
                  <p className="text-[11px] text-stone-500 dark:text-neutral-400 dark:text-neutral-400 mt-0.5">
                    Voices come from{' '}
            ...
            <div className="bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 p-4 space-y-4">
              ...
              {isCustomMascotVoice && (
                <label className="block space-y-1">
                  ...
                  <p className="text-[11px] text-stone-500 dark:text-neutral-400 dark:text-neutral-400">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs rounded-md border border-stone-300 dark:border-neutral-700 dark:border-neutral-700 hover:border-stone-400 dark:hover:border-neutral-600 disabled:opacity-60 text-stone-700 dark:text-neutral-200 dark:text-neutral-200">
                  Reset to default
                </button>
                <span
                  data-testid="mascot-voice-current"
                  className="ml-1 text-[11px] text-stone-500 dark:text-neutral-400 dark:text-neutral-400 truncate max-w-[18rem]"
              ...
              {mascotVoicePreviewError && (
                <div
                  ...
                  className="rounded-md border border-amber-200 dark:border-amber-500/30 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/10 dark:bg-amber-500/15 p-3 text-xs text-amber-800 dark:text-amber-200 dark:text-amber-300">
          ...
          <div className="bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 p-4 space-y-4">
            ...
            {!disabled && settings && (
              <>
                ...
                <label className="flex items-center gap-2 text-sm text-stone-700 dark:text-neutral-200 dark:text-neutral-200">
                  <input
                    type="checkbox"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 rounded-md border border-stone-200 dark:border-neutral-800 dark:border-neutral-700 bg-white dark:bg-neutral-900 dark:bg-neutral-800 px-3 py-1.5 text-sm text-stone-900 dark:text-neutral-100 dark:text-neutral-100 placeholder:text-stone-400 dark:placeholder:text-neutral-500 dark:text-neutral-500 dark:placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-primary-400"
                    />
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  {settings.custom_dictionary.length > 0 && (
                    <div className="flex flex-wrap gap-1.5">
                      {settings.custom_dictionary.map(word => (
                        <span
                          key={word}
                          className="inline-flex items-center gap-1 rounded-full bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800 px-2.5 py-0.5 text-xs text-stone-700 dark:text-neutral-200 dark:text-neutral-200">
                          {word}
                          <button
                            type="button"
                            onClick={() =>
                            ...
                            className="ml-0.5 text-stone-400 dark:text-neutral-500 dark:text-neutral-500 hover:text-stone-700 dark:hover:text-neutral-200 dark:text-neutral-200 dark:hover:text-neutral-200">
                            &times;
                          </button>
                        </span>
                      ))}
            ...
            {disabled && (
              <div className="rounded-md border border-amber-200 dark:border-amber-500/30 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/10 dark:bg-amber-500/15 p-4 text-sm text-amber-800 dark:text-amber-200 dark:text-amber-300">
