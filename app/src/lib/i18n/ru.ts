...
const messages: TranslationMap = {
  ...
  'subconscious.scratchpadInfo': 'Подсознание ведёт постоянный блокнот наблюдений между циклами. Проверьте Настройки → Доступ агента для настройки режима и частоты.',
