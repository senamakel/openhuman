...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'Rada',
  'modelCouncil.title': 'Rada modeli',
  'modelCouncil.intro':
    'Zadaj jedno pytanie, uzyskaj niezależne odpowiedzi od kilku modeli równolegle, a potem przewodniczący syntetyzuje, gdzie się zgadzają, gdzie różnią i co każdy wnosi.',
  'modelCouncil.listTitle': 'Rady',
  'modelCouncil.listIntro':
    'Wybierz zapisaną radę, edytuj jej agentów i sędziego albo utwórz nową radę dla określonego rodzaju decyzji.',
  ...
  'modelCouncil.backToCouncils': 'Wróć do rad',
  'modelCouncil.saveCouncil': 'Zapisz radę',
  'modelCouncil.savingCouncil': 'Zapisywanie…',
  'modelCouncil.cancelEdit': 'Anuluj',
  'modelCouncil.loadingCouncils': 'Ładowanie rad…',
  'modelCouncil.noCouncils': 'Nie ma jeszcze rad. Dodaj jedną, aby zacząć.',
  'modelCouncil.noCouncilDescription': 'Brak opisu',
  'modelCouncil.registryErrorPrefix': 'Rejestr rad nie powiódł się:',
  'modelCouncil.councilNameLabel': 'Nazwa rady',
  'modelCouncil.councilDescriptionLabel': 'Opis',
  'modelCouncil.councilDescriptionPlaceholder': 'Kiedy używać tej rady',
  'modelCouncil.selectModel': 'Wybierz',
  'modelCouncil.modelPickerHelp':
    'Wybierz wskazówkę routingu albo przypnij konkretny model dostawcy.',
  'modelCouncil.closeModelPicker': 'Zamknij',
  'modelCouncil.modelPickerHints': 'Wskazówki',
  ...
  'modelCouncil.questionLabel': 'Pytanie',
  ...
  'modelCouncil.modelHint.default': 'Domyślny',
  'modelCouncil.modelHint.chat': 'Czat',
  'modelCouncil.modelHint.reasoning': 'Rozumowanie',
  'modelCouncil.modelHint.code': 'Kod',
  'modelCouncil.modelHint.summarize': 'Podsumowanie',
  'modelCouncil.defaultSeat.analyst.name': 'Analityk',
  'modelCouncil.defaultSeat.analyst.brief': 'Dowody, założenia i ryzyko.',
  'modelCouncil.defaultSeat.builder.name': 'Budowniczy',
  'modelCouncil.defaultSeat.builder.brief': 'Praktyczna ścieżka wdrożenia.',
  'modelCouncil.defaultSeat.skeptic.name': 'Sceptyk',
  'modelCouncil.defaultSeat.skeptic.brief': 'Tryby awarii i brakujący kontekst.',
  'modelCouncil.defaultCouncilName': 'Nowa rada',
  'modelCouncil.defaultJudgeName': 'Główny sędzia',
  'modelCouncil.untitledCouncilName': 'Rada bez tytułu',
  ...
  'modelCouncil.debateRoundsLabel': 'Tury debaty',
  'modelCouncil.debateRoundsHelp':
    'Każdy juror debatuje przez kolejne tury, zanim sędzia napisze końcową syntezę.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Aktualizacje jurorów są dopisywane tutaj po każdej rundzie, a potem trafiają do następnej rundy.',
  'modelCouncil.liveScratchpadBadge': 'Na żywo',
  ...
  'modelCouncil.chairHelp': 'Przewodniczący czyta każdą odpowiedź członka i pisze syntezę.',
  'modelCouncil.run': 'Zwołaj radę',
  'modelCouncil.running': 'Zwoływanie…',
  'modelCouncil.runningHint': 'Odpytuję członków równolegle, potem syntetyzuję…',
  'modelCouncil.deliberationHeading': 'Narada rady',
  'modelCouncil.deliberationHelp':
    'Maskotki pokazują, jak każdy agent myśli, gdy używany jest wspólny plik rozumowania.',
  'modelCouncil.debateRoundInstruction':
    'Odpowiedz dotychczasowym jurorom. Zachowaj spory, zrewiduj pogląd, gdy warto, i jasno pokaż bieżący wniosek.',
  'modelCouncil.debateFinalInstruction':
    'To twoja ostatnia tura jurora. Zbliż stanowisko tam, gdzie wspierają to dowody, wskaż pozostały spór i przekaż sędziemu jasny wniosek.',
  'modelCouncil.roundLabel': 'Runda {round}',
  'modelCouncil.currentRoundThinking': 'Kontynuuje następną turę…',
  'modelCouncil.thinkingBadge': 'Myśli',
  'modelCouncil.thinkingWithBrief': 'Pracuje z tej perspektywy: {brief}',
  'modelCouncil.thought.evidence':
    'Sprawdza dowody, założenia i to, co wspólny plik rozumowania już zawiera.',
  'modelCouncil.thought.plan':
    'Szkicuje praktyczną ścieżkę i miejsca, w których wykonanie może utknąć.',
  'modelCouncil.thought.risk': 'Szuka trybów awarii, brakującego kontekstu i kruchych wniosków.',
  'modelCouncil.thought.tradeoffs':
    'Porównuje kompromisy przed przekazaniem sędziemu zwięzłego stanowiska.',
  'modelCouncil.thought.synthesis':
    'Przygotowuje odrębny pogląd, aby sędzia mógł porównać realny spór.',
  'modelCouncil.judgeWaitingBadge': 'Sędzia',
  'modelCouncil.judgeWaitingThought':
    'Czeka na odpowiedzi jurorów, potem czyta wspólny plik rozumowania, aby syntetyzować.',
  'modelCouncil.judgeSynthesizingBadge': 'Syntetyzuje',
  'modelCouncil.judgeSynthesizingThought':
    'Czyta myśli jurorów na żywo i pisze końcową syntezę rady.',
  'modelCouncil.errorPrefix': 'Rada nie powiodła się:',
  'modelCouncil.resultsHeading': 'Wyniki rady',
  'modelCouncil.memberAnswered': 'Odpowiedział',
  'modelCouncil.memberFailed': 'Nie powiodło się',
  'modelCouncil.synthesisHeading': 'Synteza',
  'modelCouncil.synthesisBy': 'przez {model}',
  'modelCouncil.usageHeading': 'Użycie debaty',
  'modelCouncil.usageEstimated':
    'Szacowane z promptów i odpowiedzi debaty, dopóki użycie dostawcy nie zostanie dołączone do RPC rady.',
  'modelCouncil.usageEstimatedBadge': 'Szacowane tokeny',
  'modelCouncil.usageInputTokens': 'Wejście',
  'modelCouncil.usageOutputTokens': 'Wyjście',
  'modelCouncil.usageTotalTokens': 'Razem',
