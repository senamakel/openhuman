...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.denied.next': 'Tidak ada yang perlu dilakukan — tindakan ini tidak dijalankan. Minta lagi jika Anda berubah pikiran.',
  'conversations.toolFailure.approvalExpired.cause': 'Permintaan persetujuan kedaluwarsa sebelum ada yang merespons.',
  'conversations.toolFailure.approvalExpired.next': 'Minta lagi untuk menjalankannya — OpenHuman tidak akan mencobanya sendiri.',
