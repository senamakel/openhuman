...
const en: TranslationMap = {
  ...
  'composio.connect.idleDescriptionSuffix': 'account. We\'ll open a browser window, you approve access there, and this app will detect the connection automatically.',
  'composio.connect.isConnected': 'is connected.',
  'composio.connect.manage': 'Manage',
  'composio.connect.needsSubdomain': 'To connect',
  'composio.connect.needsSubdomainSuffix': 'enter your Atlassian subdomain (e.g. acme for acme.atlassian.net) and try again.',
  ...
  'composio.connect.permissionsNoteSuffix': 'OpenHuman\'s own agent permissions are controlled below as read, write, and admin toggles.',
  ...
  'composio.connect.subdomainInvalid': 'Enter the short subdomain only (e.g. "acme"), not the full URL. It should contain only letters, numbers, and hyphens.',
  ...
  'onboarding.contextGathering.errorDesc': 'We couldn\'t build your full profile right now, but that\'s okay — you can continue and your profile will build over time.',
  ...
  'rewards.coupon.redeemAccepted': '{code} accepted. {amount} will unlock after the required action is completed.',
