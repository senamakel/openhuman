...
const id1: TranslationMap = {
  ...
  'settings.search.localManagedUnavailable':
    'Pencarian OpenHuman Managed tidak tersedia bagi pengguna lokal. Tambahkan kunci Parallel sendiri, Brave, atau Querit API untuk mengaktifkan pencarian web.',
  ...
  'settings.billing.inferenceBudget.title': 'Anggaran Inferensi',
