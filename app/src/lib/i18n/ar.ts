...
const messages: TranslationMap = {
  ...
  'memorySources.repoUrl': 'Repository xqx0xx',
  'memorySources.branch': 'الفرع',
  'memorySources.feedUrl': 'Feed xqx0xx',
  'memorySources.pageUrl': 'Page xqx0xx',
  'memorySources.cssSelector': 'Xqx0xqor (optional)',
  ...
  'settings.localModel.status.contextOkBadge': 'Xqx0xx ctx √',
  ...
  'settings.skillsRunner.repoPicker.notConnected':
    'Xqx0xx &apos; not connected via xqx1x. اتصل به تحت سكايلز ×2x أولا.',
  ...
  'settings.agentAccess.confine.desc':
    'Restrict the agent to the workspace directory (plus any granted folders), whichever access mode is selected. وعندما تنتهي، يمكن أن تصل إلى أي مكان يمكن لمستعملك - باستثناء دليل الإبداع والنظام المغلق دائما.',
  ...
  'settings.taskSources.description':
    'جمع بنود العمل من Xqx0xx, Notion, Linear, and ClickUp, enrich them, and route them into the agent todo board.',
  ...
  'settings.taskSources.github.repo': 'Repository ( xqx0xx, optional)',
  ...
  'settings.taskSources.fetchResult': 'Routed xqx0xxx of xqx1x task(s)',
