    ...
    return (
      <div className="h-full flex items-center justify-center p-4 pt-6">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm text-stone-500 dark:text-neutral-400">{t('common.loading')}</span>
        </div>
      </div>
    );
  }
    ...
    <div className="h-full overflow-y-auto p-4 pt-6">
      <div className="max-w-2xl mx-auto space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <h2 className="text-xl font-semibold text-stone-900 dark:text-neutral-100">{t('skills.integrations')}</h2>
          <span
            className={`inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium rounded-full ${
              coreConnected ? 'bg-sage-100 text-sage-700' : 'bg-stone-100 dark:bg-neutral-800 text-stone-500 dark:text-neutral-400'
            }`}>
            <span
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-soft border border-stone-200 dark:border-neutral-800 p-6">
          <div className="space-y-3">
            <h3 className="text-lg font-semibold text-stone-900 dark:text-neutral-100">{t('skills.search')}</h3>
