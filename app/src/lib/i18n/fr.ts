...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'Observation en lecture seule toutes les 30 minutes. Accès mémoire et fichiers uniquement.',
  'subconscious.mode.aggressive.title': 'Agressif',
  'subconscious.mode.aggressive.desc': 'Accès complet aux outils toutes les 5 minutes. Peut écrire, créer des agents et déléguer des tâches.',
  'subconscious.mode.aggressiveWarning': "Le mode agressif donne au subconscient un accès complet aux outils, y compris l'écriture et la création de sous-agents.",
