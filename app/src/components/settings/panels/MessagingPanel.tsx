    ...
    <div>
      ...
      <div className="p-4 space-y-4">
        ...
        <section className="rounded-xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 space-y-3">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">{t('channels.defaultMessaging')}</h3>
        ...
        {!loading && (
          <section className="rounded-xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 space-y-3">
            ...
            <p className="text-xs text-stone-400 dark:text-neutral-500">{t('channels.configureAuthModes')}</p>
              ...
              {configurableChannels.map(def => {
                ...
                return (
                  <button
                    ...
                    className="w-full rounded-lg border border-stone-200 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 p-3 text-left transition-colors hover:bg-white dark:hover:bg-neutral-800 hover:border-stone-300 dark:hover:border-neutral-700">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-stone-500 dark:text-neutral-400 mt-0.5">{def.description}</p>
                      </div>
                      <svg
