...
const zhCN5: TranslationMap = {
  ...
  'settings.localModel.download.runPromptTest': '运行中...',
  'settings.localModel.download.runSummaryTest': '运行中...',
  ...
  'settings.localModel.status.diagnosticsHint': '如遇问题，运行诊断可获取详细信息',
  ...
  'settings.localModel.status.forceRebootstrap': '处理中...',
  ...
  'settings.localModel.status.issuesFound': '发现 {n} 个问题',
  ...
  'settings.memoryWindow.description': '控制每次对话中注入的长期记忆量',
  ...
  'skills.resource.preview.failed': '加载失败',
  ...
  'skills.uninstall.couldNotUninstall': '无法卸载技能：{msg}',
  ...
  'walkthrough.tooltip.letsGo': '开始',
  'walkthrough.tooltip.next': '下一步',
  'walkthrough.tooltip.skip': '跳过',
