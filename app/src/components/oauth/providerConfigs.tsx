...
export const oauthProviderConfigs: OAuthProviderConfig[] = [
  {
    ...
    name: 'Google',
    icon: GoogleIcon,
    color: 'bg-surface border border-gray-200 dark:border-line-strong',
    hoverColor:
      'hover:bg-gray-50 hover:border-gray-300 dark:hover:bg-surface-muted dark:hover:border-neutral-600',
    textColor: 'text-gray-900 dark:text-content',
    showOnWelcome: true,
  },
  {
    id: 'github',
