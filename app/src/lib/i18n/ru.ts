...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'Наблюдение в режиме чтения каждые 30 минут. Только доступ к памяти и файлам.',
  'subconscious.mode.aggressive.title': 'Агрессивный',
  'subconscious.mode.aggressive.desc': 'Полный доступ к инструментам каждые 5 минут. Может писать, создавать агентов и делегировать задачи.',
