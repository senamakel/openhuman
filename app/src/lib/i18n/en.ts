...
const en: TranslationMap = {
  ...
  'modelCouncil.modelHint.summarize': 'Summarize',
  'modelCouncil.defaultSeat.analyst.name': 'Analyst',
  'modelCouncil.defaultSeat.analyst.brief': 'Evidence, assumptions, and risk.',
  'modelCouncil.defaultSeat.builder.name': 'Builder',
  'modelCouncil.defaultSeat.builder.brief': 'Practical implementation path.',
  'modelCouncil.defaultSeat.skeptic.name': 'Skeptic',
  'modelCouncil.defaultSeat.skeptic.brief': 'Failure modes and missing context.',
  'modelCouncil.defaultCouncilName': 'New council',
  'modelCouncil.defaultJudgeName': 'Chief Judge',
  'modelCouncil.untitledCouncilName': 'Untitled council',
