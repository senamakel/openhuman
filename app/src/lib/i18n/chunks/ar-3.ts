...
const ar3: TranslationMap = {
  ...
  'app.connectionIndicator.reconnecting': 'جارٍ الاتصال',
  ...
  'app.openhumanLink.notifications.sent': 'تم الإرسال',
  ...
  'app.routeLoading.initializing': 'جارٍ التهيئة',
  ...
  'app.update.progress.downloaded': '${formatBytes(downloaded)} تم تنزيله',
  ...
  'channels.discord.picker.serverChannelSelection': 'اختيار قناة الخادم',
