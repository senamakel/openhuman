...
describe('SettingsHome', () => {
  ...
  describe('local session gating', () => {
    ...
    it('shows "Exit local session" instead of "Log out" in local mode', () => {
      renderSettingsHome();
      expect(screen.queryByText('Log out')).not.toBeInTheDocument();
      expect(screen.getByText('Exit local session')).toBeInTheDocument();
    });
    ...
    it('shows "Log out" when not in local mode', () => {
      mockSessionToken = null;
      renderSettingsHome();
      expect(screen.getByText('Log out')).toBeInTheDocument();
      expect(screen.queryByText('Exit local session')).not.toBeInTheDocument();
    });
  });
