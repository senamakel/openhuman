...
export const PRESET_THEMES: Theme[] = [
  ...
  },
  {
    ...
    isDark: true,
    builtIn: true,
    // Surfaces step up clearly from the canvas so cards/panels separate, with a
    // visible border line — a too-flat ramp made elevated content disappear.
    colors: {
      'surface-canvas': '7 10 20',
      'surface': '26 33 56',
      'surface-muted': '33 42 68',
      'surface-subtle': '30 38 62',
      'surface-strong': '42 53 84',
      'surface-hover': '40 50 80',
      'surface-overlay': '0 0 0',
      'line': '50 63 99',
      'line-strong': '70 86 130',
      'line-subtle': '38 48 76',
      'content': '226 232 240',
      'content-secondary': '184 194 214',
      'content-muted': '142 154 182',
      'content-faint': '104 116 146',
