...
const fr4: TranslationMap = {
  ...
  'composio.connect.connectionFailed': 'Connexion échouée (statut : ${hit.status}).',
  ...
  'conversations.toolTimeline.turn': 'tour ${subagent.childIteration}/${subagent.childMaxIterations}',
  ...
  'intelligence.tasks.threadPrefix': 'Fil ${shortId(threadId)}',
  ...
  'settings.ai.addCloudProvider': 'Modifier ${initial.label}',
  ...
  'settings.ai.editProvider': 'Modifier ${initial.label}',
  ...
  'settings.autocomplete.completionStyle.acceptedCompletion': '${String(historyEntries.length)} complétion${historyEntries.length === 1 ? \'\' : \'s\'} acceptée${historyEntries.length === 1 ? \'\' : \'s\'} — utilisée pour personnaliser les suggestions futures.',
  'settings.autocomplete.completionStyle.acceptedCompletions': '${String(historyEntries.length)} complétion${historyEntries.length === 1 ? \'\' : \'s\'} acceptée${historyEntries.length === 1 ? \'\' : \'s\'} — utilisée pour personnaliser les suggestions futures.',
