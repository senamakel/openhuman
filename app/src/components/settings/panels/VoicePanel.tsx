      ...
      <div className={embedded ? 'space-y-4' : 'p-4 space-y-4'}>
        <section className="space-y-3">
          <div
            ...
            <div>
              <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">Voice Providers</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <label className="block space-y-1">
                <span className="text-xs font-medium text-stone-600 dark:text-neutral-300">Speech-to-Text Provider</span>
                <select
                  ...
                  className="w-full rounded-md border border-stone-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 focus:outline-none focus:ring-1 focus:ring-primary-400">
              ...
              {sttProvider === 'whisper' && (
                <label className="block space-y-1">
                  <span className="text-xs font-medium text-stone-600 dark:text-neutral-300">Whisper Model</span>
                  <select
              ...
              <label className="block space-y-1">
                <span className="text-xs font-medium text-stone-600 dark:text-neutral-300">Text-to-Speech Provider</span>
                <select
              ...
              {ttsProvider === 'piper' && (
                <label className="block space-y-1">
                  <span className="text-xs font-medium text-stone-600 dark:text-neutral-300">Piper Voice</span>
                  <select
                  ...
                  {!PIPER_VOICE_PRESETS.some(v => v.id === ttsVoice) && (
                    <input
                      ...
                      className="mt-1 w-full rounded-md border border-stone-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 placeholder:text-stone-400 dark:placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-primary-400"
                    />
                  )}
        ...
        {ttsProvider !== 'piper' && (
          <section className="space-y-3" data-testid="mascot-voice-section">
            <div className="bg-stone-50 dark:bg-neutral-800/60 rounded-lg border border-stone-200 dark:border-neutral-800 p-4 space-y-4">
              <div>
                <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">Mascot Voice</h3>
                <p className="text-xs text-stone-500 dark:text-neutral-400 mt-1">
              ...
              <label className="block space-y-1">
                <span className="text-xs font-medium text-stone-600 dark:text-neutral-300">Voice preset</span>
                <select
              ...
              {isCustomMascotVoice && (
                <label className="block space-y-1">
                  <span className="text-xs font-medium text-stone-600 dark:text-neutral-300">Custom voice id</span>
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 rounded-md border border-stone-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 placeholder:text-stone-400 dark:placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-primary-400"
                    />
                    <button
                      type="button"
              ...
              {mascotVoicePreviewError && (
                <div
                  ...
                  className="rounded-md border border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/15 p-3 text-xs text-amber-800 dark:text-amber-300">
        ...
        <section className={`space-y-3 ${disabled ? 'opacity-60' : ''}`}>
          <div className="bg-stone-50 dark:bg-neutral-800/60 rounded-lg border border-stone-200 dark:border-neutral-800 p-4 space-y-4">
            <div>
              <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">{t('voice.settings')}</h3>
              <p className="text-xs text-stone-500 dark:text-neutral-400 mt-1">{t('voice.settingsDesc')}</p>
            </div>

            {!disabled && settings && (
              <>
                <label className="block space-y-1">
                  <span className="text-xs font-medium text-stone-600 dark:text-neutral-300">{t('voice.hotkey')}</span>
                  <input
                    value={settings.hotkey}
                    onChange={e => updateSetting('hotkey', e.target.value)}
                    placeholder="Fn"
                    className="w-full rounded-md border border-stone-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 placeholder:text-stone-400 dark:placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-primary-400"
                  />
                </label>
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="text-[11px] text-stone-400 dark:text-neutral-500">{t('voice.customDictionaryDesc')}</p>
                  </div>
                  <div className="flex gap-2">
                    <input
                      value={newDictWord}
                      ...
                      className="flex-1 rounded-md border border-stone-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-1.5 text-sm text-stone-900 dark:text-neutral-100 placeholder:text-stone-400 dark:placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-primary-400"
                    />
                    <button
                      type="button"
                      onClick={() => {
                      ...
                      {settings.custom_dictionary.map(word => (
                        <span
                          ...
                          <button
                            ...
                            className="ml-0.5 text-stone-400 dark:text-neutral-500 hover:text-stone-700 dark:hover:text-neutral-200">
                            &times;
                          </button>
                        </span>
                      ))}
            ...
            {disabled && (
              <div className="rounded-md border border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/15 p-4 text-sm text-amber-800 dark:text-amber-300">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-xs text-stone-400 dark:text-neutral-500 hover:text-stone-600 dark:hover:text-neutral-300 transition-colors">
          {t('settings.advanced')}
