...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'हर 30 मिनट में केवल-पठन अवलोकन। केवल मेमोरी और फ़ाइल एक्सेस।',
  'subconscious.mode.aggressive.title': 'आक्रामक',
  'subconscious.mode.aggressive.desc': 'हर 5 मिनट में पूर्ण टूल एक्सेस। लिख सकता है, एजेंट बना सकता है और कार्य सौंप सकता है।',
