...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.denied.next': '할 일이 없습니다 — 실행되지 않았습니다. 마음이 바뀌면 다시 요청하세요.',
  'conversations.toolFailure.approvalExpired.cause': '아무도 응답하기 전에 승인 요청이 만료되었습니다.',
  'conversations.toolFailure.approvalExpired.next': '실행하려면 다시 요청하세요 — OpenHuman이 스스로 재시도하지 않습니다.',
