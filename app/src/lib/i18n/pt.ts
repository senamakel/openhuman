...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'Observação somente leitura a cada 30 minutos. Apenas acesso a memória e arquivos.',
  'subconscious.mode.aggressive.title': 'Agressivo',
  'subconscious.mode.aggressive.desc': 'Acesso completo a ferramentas a cada 5 minutos. Pode escrever, criar agentes e delegar tarefas.',
  'subconscious.mode.aggressiveWarning': 'O modo agressivo concede ao subconsciente acesso completo a ferramentas, incluindo escrita e criação de subagentes.',
