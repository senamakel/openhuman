...
//! ([`crate::platform::socket::medulla::workflows::WorkflowBridge`]) with this
...
use crate::platform::socket::medulla::payloads::{
    CopilotOutcome, WorkflowDescriptor, WorkflowInputDescriptor,
};
use crate::platform::socket::medulla::workflows::{set_workflow_bridge, WorkflowBridge};
...
fn node_kind_json(contract: &crate::flows::node_contracts::NodeKindContract) -> Value {
    json!({
        "kind": contract.kind,
