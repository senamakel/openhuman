...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'مراقبة للقراءة فقط كل 30 دقيقة. الوصول للذاكرة والملفات فقط.',
  'subconscious.mode.aggressive.title': 'مكثف',
  'subconscious.mode.aggressive.desc': 'وصول كامل للأدوات كل 5 دقائق. يمكنه الكتابة وإنشاء وكلاء وتفويض المهام.',
