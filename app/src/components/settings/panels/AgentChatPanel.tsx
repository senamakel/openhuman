    ...
    <div>
      ...
      <div className="p-4 space-y-4">
        <section className="space-y-3">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">{t('chat.overrides')}</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">{t('chat.conversation')}</h3>
          {error && (
          ...
          <div className="rounded-xl border border-stone-200 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 p-4 space-y-3">
            {messages.length === 0 && (
              <div className="text-sm text-stone-400 dark:text-neutral-500">{t('chat.startAgentConversation')}</div>
            )}
              ...
              <div key={`${message.role}-${index}`} className="space-y-1">
                ...
                <div
                  className={`text-sm whitespace-pre-wrap ${
                    message.role === 'user' ? 'text-stone-900 dark:text-neutral-100' : 'text-emerald-700'
                  }`}>
                  {message.text}
                </div>
              </div>
