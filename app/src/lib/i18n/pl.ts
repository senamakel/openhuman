...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'Obserwacja tylko do odczytu co 30 minut. Tylko dostęp do pamięci i plików.',
  'subconscious.mode.aggressive.title': 'Agresywny',
  'subconscious.mode.aggressive.desc': 'Pełny dostęp do narzędzi co 5 minut. Może pisać, tworzyć agentów i delegować zadania.',
