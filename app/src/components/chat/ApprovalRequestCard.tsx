    ...
    <div
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          {approval.command && (
            <pre className="mt-2 max-h-40 overflow-auto whitespace-pre-wrap break-all rounded border border-amber-200/80 bg-white px-2 py-1.5 font-mono text-xs text-ink shadow-inner dark:border-amber-700 dark:bg-surface-canvas dark:text-content">
              {approval.command}
            </pre>
          )}
