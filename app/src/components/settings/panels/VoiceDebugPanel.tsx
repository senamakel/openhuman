      ...
      <div className="p-4 space-y-4">
        ...
        <section className="space-y-3">
          <div className="bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 p-4 space-y-3">
            ...
            {serverStatus && (
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs text-stone-600 dark:text-neutral-300 dark:text-neutral-300">
              ...
              <>
                <label className="block space-y-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 dark:text-neutral-100 focus:outline-none focus:ring-1 focus:ring-primary-400"
                  />
                </label>
