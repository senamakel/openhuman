...
const zhCN1: TranslationMap = {
  ...
  'onboarding.runtimeChoice.title': '你想如何运行 OpenHuman？',
  'onboarding.runtimeChoice.subtitle': '选择最适合你的方式。你可以在设置中随时更改。',
  ...
  'onboarding.runtimeChoice.cloud.f2': '令牌压缩，让你的用量更充裕',
  'onboarding.runtimeChoice.cloud.f3': '一个订阅，涵盖所有模型',
  ...
  'onboarding.runtimeChoice.custom.tagline': '自带密钥，完全掌控使用内容。',
  'onboarding.runtimeChoice.custom.f1': '几乎所有功能都需要 API 密钥',
  'onboarding.runtimeChoice.custom.f2': '复用你已付费的服务',
  'onboarding.runtimeChoice.custom.f3': '本地运行所有内容可免费使用',
  'onboarding.runtimeChoice.custom.f4': '更多设置，更多可调选项',
  'onboarding.runtimeChoice.custom.f5': '适合高级用户和开发者',
  'onboarding.runtimeChoice.cloud.creditHighlight': '$1 免费配额供试用',
  'onboarding.runtimeChoice.continueCloud': '以简单模式继续',
  ...
  'onboarding.custom.configureTitle': '自定义配置',
