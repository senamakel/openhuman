...
//! [`crate::config::Config`]. Keeping it module-local means the
...
//! name below, that is *not* [`crate::config::Config::workspace_dir`]
...
/// [`crate::config::Config::workspace_dir`]. A missing or
...
/// a thin delegator.
pub fn load_for_config(config: &crate::config::Config) -> ClaudeCodeSettings {
