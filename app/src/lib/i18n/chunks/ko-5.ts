...
const ko5: TranslationMap = {
  ...
  'settings.developerMenu.ai.desc': 'Cloud providers, local Ollama models, and per-workload routing',
  'settings.developerMenu.screenAwareness.title': 'Screen Awareness',
  'settings.developerMenu.screenAwareness.desc': 'Screen capture permissions, monitoring policy, and session controls',
  'settings.developerMenu.messagingChannels.title': 'Messaging Channels',
  'settings.developerMenu.messagingChannels.desc': 'Configure Telegram/Discord auth modes and default channel routing',
  'settings.developerMenu.tools.title': 'Tools',
  'settings.developerMenu.tools.desc': 'Enable or disable capabilities OpenHuman can use on your behalf',
  'settings.developerMenu.agentChat.title': 'Agent Chat',
  'settings.developerMenu.agentChat.desc': 'Test agent conversation with model and temperature overrides',
  ...
  'settings.developerMenu.localModelDebug.desc': 'Ollama config, asset downloads, model tests, and diagnostics',
  ...
  'settings.developerMenu.webhooks.desc': 'Inspect runtime webhook registrations and captured request logs',
  'settings.developerMenu.intelligence.title': 'Intelligence',
  'settings.developerMenu.intelligence.desc': 'Memory workspace, subconscious engine, dreams, and settings',
  'settings.developerMenu.notificationRouting.title': 'Notification Routing',
  'settings.developerMenu.notificationRouting.desc': 'AI importance scoring and orchestrator escalation for integration alerts',
  ...
  'settings.developerMenu.composioRouting.desc': 'Bring your own Composio API key and route calls directly to backend.composio.dev',
