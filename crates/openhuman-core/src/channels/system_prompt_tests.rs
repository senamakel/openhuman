use super::*;
use crate::agent::profiles::home::profile_home;
use crate::agent::profiles::store::built_in_default_profile;
...
fn activate_profile_with(
    ...
    id: &str,
    soul: &str,
    adjust: impl FnOnce(&mut crate::agent::profiles::AgentProfile),
) {
...
fn profile_prompt_suffix_renders_as_the_desktop_agent_profile_block() {
    ...
    let text = prompt.current();
    let block = crate::agent::profiles::prompt_section::render_agent_profile_block(
