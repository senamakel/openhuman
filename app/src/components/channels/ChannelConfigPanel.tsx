  ...
  return (
    <div className="space-y-4">
      <section className="rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 p-4 space-y-3">
        <div>
          <h3 className="text-base font-semibold text-stone-900 dark:text-neutral-100 dark:text-neutral-100">{definition.display_name}</h3>
          <p className="text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400 mt-1">{definition.description}</p>
        </div>
