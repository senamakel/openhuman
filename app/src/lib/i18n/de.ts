...
const messages: TranslationMap = {
  ...
  'flows.promptBar.heroSubtitle': 'Sag dem Generator, was automatisiert werden soll, und prüfe seinen Vorschlag.',
  'flows.promptBar.error': 'Der Workflow-Generator ist nicht erreichbar. Bitte erneut versuchen.',
  'flows.promptBar.offline': 'Du bist offline. Verbinde dich erneut, um einen Workflow zu erstellen.',
  'flows.copilot.open': 'Assistent',
  'flows.copilot.title': 'Workflow-Assistent',
  'flows.copilot.subtitle': 'Bitte um Änderungen und prüfe jeden Vorschlag, bevor du ihn übernimmst.',
  ...
  'flows.copilot.emptyState': 'Beschreibe eine Änderung an diesem Workflow, und der Generator schlägt eine Aktualisierung vor.',
  ...
  'flows.copilot.previewHint': 'Ein vorgeschlagener Entwurf wird geprüft — es wurde noch nichts gespeichert.',
  'flows.copilot.repairDisplay': 'Eine Ausführung ist fehlgeschlagen; sieh sie dir an und schlage eine Lösung vor.',
