...
/// `crates/openhuman-app/Cargo.toml` set `default-features = false`, dropping the
...
/// `crates/openhuman-app/src/lib.rs`), turning that silent runtime failure into a build
/// failure.
