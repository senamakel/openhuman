---
description: >-
  OpenHuman's visual language — colors, typography, components and motion —
  for designers and contributors building on top of the app.
icon: palette
---
...
OpenHuman's design system embodies three core principles:
