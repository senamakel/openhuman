...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'Conseil',
  'modelCouncil.title': 'Conseil de modèles',
  'modelCouncil.intro':
    'Posez une question, obtenez des réponses indépendantes de plusieurs modèles en parallèle, puis un président synthétise leurs accords, leurs désaccords et ce que chacun apporte.',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro':
    'Choisissez un conseil enregistré, modifiez ses agents et son juge, ou créez un nouveau conseil pour un type de décision précis.',
  ...
  'modelCouncil.savingCouncil': 'Enregistrement…',
  'modelCouncil.cancelEdit': 'Annuler',
  ...
  'modelCouncil.registryErrorPrefix': 'Échec du registre des conseils :',
  ...
  'modelCouncil.selectModel': 'Sélectionner',
  'modelCouncil.modelPickerHelp':
    'Sélectionnez un indice de routage ou épinglez un modèle fournisseur exact.',
  'modelCouncil.closeModelPicker': 'Fermer',
  'modelCouncil.modelPickerHints': 'Indices',
  ...
  'modelCouncil.useProviderModel': 'Utiliser le modèle fournisseur',
  ...
  'modelCouncil.removeMemberAria': 'Retirer le modèle membre {n}',
  'modelCouncil.addMember': '+ Ajouter un modèle',
  'modelCouncil.modelHint.default': 'Par défaut',
  'modelCouncil.modelHint.chat': 'Chat',
  'modelCouncil.modelHint.reasoning': 'Raisonnement',
  'modelCouncil.modelHint.code': 'Code',
  'modelCouncil.modelHint.summarize': 'Résumer',
  'modelCouncil.defaultSeat.analyst.name': 'Analyste',
  'modelCouncil.defaultSeat.analyst.brief': 'Preuves, hypothèses et risques.',
  'modelCouncil.defaultSeat.builder.name': 'Bâtisseur',
  'modelCouncil.defaultSeat.builder.brief': 'Chemin de mise en œuvre pratique.',
  'modelCouncil.defaultSeat.skeptic.name': 'Sceptique',
  'modelCouncil.defaultSeat.skeptic.brief': 'Modes d’échec et contexte manquant.',
  'modelCouncil.defaultCouncilName': 'Nouveau conseil',
  'modelCouncil.defaultJudgeName': 'Juge principal',
  'modelCouncil.untitledCouncilName': 'Conseil sans titre',
  ...
  'modelCouncil.debateRoundsHelp':
    'Chaque juré continue de débattre pendant plusieurs tours avant que le juge rédige la synthèse finale.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Les mises à jour des jurés sont ajoutées ici après chaque tour, puis transmises au tour suivant.',
  'modelCouncil.liveScratchpadBadge': 'En direct',
  ...
  'modelCouncil.running': 'Convocation…',
  ...
  'modelCouncil.deliberationHelp':
    'Les mascottes montrent chaque agent en train de réfléchir pendant que le fichier de raisonnement partagé est utilisé.',
  'modelCouncil.debateRoundInstruction':
    'Répondez aux autres jurés jusqu’ici. Préservez les désaccords, révisez votre point de vue si nécessaire et gardez votre conclusion actuelle explicite.',
  'modelCouncil.debateFinalInstruction':
    'C’est votre dernier tour de juré. Convergez là où les preuves le justifient, signalez le désaccord restant et remettez au juge une conclusion claire.',
  'modelCouncil.roundLabel': 'Tour {round}',
  'modelCouncil.currentRoundThinking': 'Poursuite du tour suivant…',
  'modelCouncil.thinkingBadge': 'Réflexion',
  'modelCouncil.thinkingWithBrief': 'Travaille depuis cette perspective : {brief}',
  'modelCouncil.thought.evidence':
    'Vérifie les preuves, les hypothèses et ce que le fichier de raisonnement partagé contient déjà.',
  'modelCouncil.thought.plan':
    'Esquisse le chemin pratique et les points où l’exécution pourrait se bloquer.',
  'modelCouncil.thought.risk':
    'Cherche les modes d’échec, le contexte manquant et les conclusions fragiles.',
  'modelCouncil.thought.tradeoffs':
    'Compare les compromis avant de remettre au juge une position concise.',
  'modelCouncil.thought.synthesis':
    'Prépare un point de vue distinct afin que le juge puisse comparer les vrais désaccords.',
  'modelCouncil.judgeWaitingBadge': 'Juge',
  'modelCouncil.judgeWaitingThought':
    'Attend les réponses des jurés, puis lit le fichier de raisonnement partagé pour synthétiser.',
  'modelCouncil.judgeSynthesizingBadge': 'Synthèse',
  'modelCouncil.judgeSynthesizingThought':
    'Lit les pensées des jurés en direct et rédige la synthèse finale du conseil.',
  'modelCouncil.errorPrefix': 'Échec du conseil :',
  'modelCouncil.resultsHeading': 'Résultats du conseil',
  'modelCouncil.memberAnswered': 'A répondu',
  'modelCouncil.memberFailed': 'Échec',
  'modelCouncil.synthesisHeading': 'Synthèse',
  'modelCouncil.synthesisBy': 'par {model}',
  'modelCouncil.usageHeading': 'Utilisation du débat',
  'modelCouncil.usageEstimated':
    'Estimé à partir des prompts et réponses du débat jusqu’à ce que l’usage fournisseur soit attaché au RPC du conseil.',
  'modelCouncil.usageEstimatedBadge': 'Jetons estimés',
  'modelCouncil.usageInputTokens': 'Entrée',
  'modelCouncil.usageOutputTokens': 'Sortie',
