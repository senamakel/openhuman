    ...
    <div className="z-10 relative">
      ...
      <div className="max-w-2xl mx-auto w-full p-4 space-y-4">
        ...
        <section className="space-y-3">
          ...
          <label className="flex items-center justify-between rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 px-3 py-2">
            ...
            <select
              ...
              className="rounded border border-stone-200 dark:border-neutral-800 dark:border-neutral-700 bg-white dark:bg-neutral-900 dark:bg-neutral-800 px-2 py-1 text-xs text-stone-700 dark:text-neutral-200 dark:text-neutral-200">
        ...
        {status !== null && !status.platform_supported && (
          <div className="rounded-xl border border-amber-300 dark:border-amber-500/40 bg-amber-50 dark:bg-amber-500/10 dark:bg-amber-500/15 dark:border-amber-500/30 p-3 text-sm text-amber-700 dark:text-amber-300 dark:text-amber-300">
