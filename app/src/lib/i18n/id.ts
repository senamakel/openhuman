...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'Dewan',
  'modelCouncil.title': 'Dewan Model',
  'modelCouncil.intro':
    'Ajukan satu pertanyaan, dapatkan jawaban independen dari beberapa model secara paralel, lalu ketua menyintesis di mana mereka sepakat, berbeda, dan apa kontribusi unik tiap model.',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro':
    'Pilih dewan tersimpan, edit agen dan jurinya, atau buat dewan baru untuk jenis keputusan tertentu.',
  ...
  'modelCouncil.backToCouncils': 'Kembali ke dewan',
  'modelCouncil.saveCouncil': 'Simpan dewan',
  'modelCouncil.savingCouncil': 'Menyimpan…',
  'modelCouncil.cancelEdit': 'Batal',
  'modelCouncil.loadingCouncils': 'Memuat dewan…',
  'modelCouncil.noCouncils': 'Belum ada dewan. Tambahkan satu untuk memulai.',
  'modelCouncil.noCouncilDescription': 'Tidak ada deskripsi',
  'modelCouncil.registryErrorPrefix': 'Registri dewan gagal:',
  'modelCouncil.councilNameLabel': 'Nama dewan',
  'modelCouncil.councilDescriptionLabel': 'Deskripsi',
  'modelCouncil.councilDescriptionPlaceholder': 'Kapan memakai dewan ini',
  'modelCouncil.selectModel': 'Pilih',
  'modelCouncil.modelPickerHelp': 'Pilih petunjuk perutean atau pin model penyedia yang tepat.',
  'modelCouncil.closeModelPicker': 'Tutup',
  'modelCouncil.modelPickerHints': 'Petunjuk',
  ...
  'modelCouncil.questionLabel': 'Pertanyaan',
  ...
  'modelCouncil.modelHint.default': 'Default',
  'modelCouncil.modelHint.chat': 'Chat',
  'modelCouncil.modelHint.reasoning': 'Penalaran',
  'modelCouncil.modelHint.code': 'Kode',
  'modelCouncil.modelHint.summarize': 'Ringkas',
  'modelCouncil.defaultSeat.analyst.name': 'Analis',
  'modelCouncil.defaultSeat.analyst.brief': 'Bukti, asumsi, dan risiko.',
  'modelCouncil.defaultSeat.builder.name': 'Pembangun',
  'modelCouncil.defaultSeat.builder.brief': 'Jalur implementasi praktis.',
  'modelCouncil.defaultSeat.skeptic.name': 'Skeptis',
  'modelCouncil.defaultSeat.skeptic.brief': 'Mode kegagalan dan konteks yang hilang.',
  'modelCouncil.defaultCouncilName': 'Dewan baru',
  'modelCouncil.defaultJudgeName': 'Hakim utama',
  'modelCouncil.untitledCouncilName': 'Dewan tanpa judul',
  ...
  'modelCouncil.debateRoundsLabel': 'Giliran debat',
  'modelCouncil.debateRoundsHelp':
    'Setiap juri terus berdebat dalam beberapa giliran sebelum juri utama menulis sintesis akhir.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Pembaruan juri ditambahkan di sini setelah setiap ronde, lalu dipakai di ronde berikutnya.',
  'modelCouncil.liveScratchpadBadge': 'Langsung',
  'modelCouncil.scratchpadRoundHeading': 'Pembaruan ronde {round}',
  ...
  'modelCouncil.run': 'Panggil dewan',
  'modelCouncil.running': 'Memanggil…',
  'modelCouncil.runningHint': 'Menanyakan anggota secara paralel, lalu menyintesis…',
  'modelCouncil.deliberationHeading': 'Musyawarah dewan',
  'modelCouncil.deliberationHelp':
    'Maskot menampilkan setiap agen sedang berpikir saat file penalaran bersama digunakan.',
  'modelCouncil.debateRoundInstruction':
    'Tanggapi juri lain sejauh ini. Pertahankan perbedaan pendapat, revisi pandangan bila perlu, dan jelaskan kesimpulan saat ini.',
  'modelCouncil.debateFinalInstruction':
    'Ini giliran juri terakhir Anda. Satukan posisi saat bukti mendukung, sebutkan sisa perbedaan, dan berikan kesimpulan jelas kepada juri utama.',
  'modelCouncil.roundLabel': 'Ronde {round}',
  'modelCouncil.currentRoundThinking': 'Melanjutkan giliran berikutnya…',
  'modelCouncil.thinkingBadge': 'Berpikir',
  'modelCouncil.thinkingWithBrief': 'Bekerja dari perspektif ini: {brief}',
  'modelCouncil.thought.evidence':
    'Memeriksa bukti, asumsi, dan apa yang sudah ditangkap file penalaran bersama.',
  'modelCouncil.thought.plan': 'Menyusun jalur praktis dan titik tempat eksekusi bisa tersendat.',
  'modelCouncil.thought.risk': 'Mencari mode kegagalan, konteks yang hilang, dan kesimpulan rapuh.',
  'modelCouncil.thought.tradeoffs':
    'Membandingkan tradeoff sebelum menyerahkan posisi ringkas kepada juri utama.',
  'modelCouncil.thought.synthesis':
    'Menyiapkan pandangan berbeda agar juri utama bisa membandingkan perbedaan nyata.',
  'modelCouncil.judgeWaitingBadge': 'Juri',
  'modelCouncil.judgeWaitingThought':
    'Menunggu jawaban juri, lalu membaca file penalaran bersama untuk sintesis.',
  'modelCouncil.judgeSynthesizingBadge': 'Menyintesis',
  'modelCouncil.judgeSynthesizingThought':
    'Membaca pikiran juri langsung dan menulis sintesis akhir dewan.',
  'modelCouncil.errorPrefix': 'Dewan gagal:',
  'modelCouncil.resultsHeading': 'Hasil dewan',
  'modelCouncil.memberAnswered': 'Menjawab',
  'modelCouncil.memberFailed': 'Gagal',
  ...
  'modelCouncil.usageEstimated':
    'Diperkirakan dari prompt dan respons debat sampai penggunaan penyedia terhubung ke RPC dewan.',
  'modelCouncil.usageEstimatedBadge': 'Token perkiraan',
