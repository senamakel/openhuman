...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.denied.next': 'Nichts zu tun — sie wurde nicht ausgeführt. Frag erneut, wenn du es dir anders überlegst.',
  'conversations.toolFailure.approvalExpired.cause': 'Die Genehmigungsanfrage ist abgelaufen, bevor jemand geantwortet hat.',
  'conversations.toolFailure.approvalExpired.next': 'Frag erneut, um sie auszuführen — OpenHuman versucht es nicht von selbst erneut.',
