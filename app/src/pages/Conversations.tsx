  ...
  return (
    <div
      ...
      {!isSidebar && effectiveShowSidebar && (
        <div className="w-64 flex-shrink-0 flex flex-col bg-white dark:bg-neutral-900 dark:bg-neutral-900 rounded-2xl shadow-soft border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-stone-100 dark:border-neutral-800 dark:border-neutral-800">
            <h2 className="text-sm font-semibold text-stone-700 dark:text-neutral-200 dark:text-neutral-200">{t('chat.threads')}</h2>
            {/* [#1123] welcomeLocked guard removed — always show new thread button */}
            <button
              onClick={() => void handleCreateNewThread()}
              className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-stone-100 dark:hover:bg-neutral-800 dark:bg-neutral-800 dark:hover:bg-neutral-800/60 text-stone-500 dark:text-neutral-400 dark:text-neutral-400 hover:text-stone-700 dark:hover:text-neutral-200 dark:text-neutral-200 dark:hover:text-neutral-200 transition-colors"
          ...
          <div className="flex-1 overflow-y-auto">
            {sortedThreads.length === 0 ? (
              <p className="px-4 py-6 text-xs text-stone-400 dark:text-neutral-500 dark:text-neutral-500 text-center">
                {selectedLabel === 'all'
                  ? t('chat.noThreads')
                ...
                <div
                  ...
                  <div className="flex items-center justify-between">
                    <p
                      className={`text-sm truncate flex-1 ${
                        selectedThreadId === thread.id
                          ...
                          : 'text-stone-700 dark:text-neutral-200 dark:text-neutral-200'
                      }`}>
                    ...
                    <button
                      ...
                      className="ml-2 p-1 rounded opacity-0 group-hover:opacity-100 hover:bg-stone-200 dark:bg-neutral-800 dark:hover:bg-neutral-800 text-stone-400 dark:text-neutral-500 dark:text-neutral-500 hover:text-coral-500 transition-all flex-shrink-0"
                      title={t('chat.deleteThread')}>
                      <svg
                        className="w-3 h-3"
                        fill="none"
      ...
      <div
        className={
          isSidebar
            ? 'flex-1 flex flex-col min-w-0 bg-white dark:bg-neutral-900 dark:bg-neutral-900 border-l border-stone-200 dark:border-neutral-800 dark:border-neutral-800 overflow-hidden'
            : 'flex-1 flex flex-col min-w-0 max-w-2xl bg-white dark:bg-neutral-900 dark:bg-neutral-900 rounded-2xl shadow-soft border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 overflow-hidden'
        }>
        ...
        {!isSidebar && (
          <div
            className="flex items-center gap-2 px-4 py-2.5 border-b border-stone-100 dark:border-neutral-800 dark:border-neutral-800"
            ...
            <div className="flex flex-col min-w-0 flex-1">
              ...
              <h3 className="text-sm font-medium text-stone-700 dark:text-neutral-200 dark:text-neutral-200 truncate">
            ...
            <>
              <div className="flex items-center gap-1">
                <select
                  ...
                  className="h-7 max-w-[120px] rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 px-2 text-xs text-stone-700 dark:text-neutral-200 dark:text-neutral-200 outline-none transition-colors focus:border-primary-400">
                ...
                <button
                  ...
                  className="h-7 w-7 rounded-lg text-xs font-medium text-stone-500 dark:text-neutral-400 dark:text-neutral-400 transition-colors hover:bg-stone-100 dark:hover:bg-neutral-800 dark:bg-neutral-800 dark:hover:bg-neutral-800/60 hover:text-stone-700 dark:hover:text-neutral-200 dark:text-neutral-200 dark:hover:text-neutral-200"
        ...
        {!isSidebar && profileDraftOpen && (
          <div className="border-b border-stone-100 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 px-4 py-3">
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[1fr_140px]">
              <input
                value={profileDraft.name}
                onChange={event => setProfileDraft(prev => ({ ...prev, name: event.target.value }))}
                placeholder="Profile name"
                className="h-8 rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-200 px-3 text-xs outline-none focus:border-primary-400"
              />
              <select
                ...
                className="h-8 rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-200 px-2 text-xs outline-none focus:border-primary-400">
            ...
            <textarea
              ...
              rows={2}
              className="mt-2 w-full resize-none rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-200 px-3 py-2 text-xs outline-none focus:border-primary-400"
            />
            <div className="mt-2 flex items-center gap-2">
              <input
                ...
                className="h-8 min-w-0 flex-1 rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-200 px-3 text-xs outline-none focus:border-primary-400"
              />
              <button
                type="button"
              ...
              <button
                ...
                className="h-8 rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 px-3 text-xs font-medium text-stone-600 dark:text-neutral-300 dark:text-neutral-300 transition-colors hover:bg-stone-50 dark:hover:bg-neutral-800/60 dark:bg-neutral-800/60 dark:hover:bg-neutral-800/60">
                Cancel
              </button>
            </div>
          </div>
        ...
        <div ref={messagesContainerRef} className="flex-1 overflow-y-auto px-5 py-4 bg-[#f6f6f6]">
          {isLoadingMessages ? (
            <div className="space-y-4">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className={`flex ${i % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                  <div
                    className={`h-12 rounded-2xl animate-pulse bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800 ${
                      i % 2 === 0 ? 'w-2/3' : 'w-1/2'
                    }`}
                  />
                </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center h-full">
              ...
              <p className="text-sm text-stone-400 dark:text-neutral-500 dark:text-neutral-500 mb-1">{t('chat.failedToLoadMessages')}</p>
              <p className="text-xs text-stone-600 dark:text-neutral-300 dark:text-neutral-300 mb-3 text-center">{messagesError}</p>
              <button
            ...
            <div className="space-y-3">
                      ...
                      {msg.sender === 'agent' ? (
                        <div className="space-y-1">
                          ...
                          {latestVisibleMessage?.id === msg.id && (
                            <p className="px-1 text-[10px] text-stone-400 dark:text-neutral-500 dark:text-neutral-500">
                          ...
                          <div className="mt-1 flex items-center gap-1 flex-wrap min-h-[20px]">
                            ...
                            {msg.sender === 'agent' &&
                              (reactionPickerMsgId === msg.id ? (
                                <div className="flex items-center gap-0.5 px-1 py-0.5 rounded-full bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800">
                                  {['👍', '❤️', '😂', '🔥', '👀', '🎯'].map(emoji => (
                                    <button
                                      key={emoji}
                                      onClick={() => {
                                  ...
                                  <button
                                    ...
                                    className="ml-0.5 text-stone-600 dark:text-neutral-300 dark:text-neutral-300 hover:text-stone-400 dark:text-neutral-500 dark:hover:text-neutral-500 text-xs px-0.5">
                                    ✕
                                  </button>
                                </div>
                              ) : (
              ...
              {selectedStreamingAssistant &&
                (selectedStreamingAssistant.content.length > 0 ||
                  ...
                  <div className="flex justify-start">
                    <div className="relative w-fit max-w-[75%]">
                      {selectedStreamingAssistant.thinking.length > 0 && (
                        <details className="mb-1.5 bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800 rounded-lg px-3 py-1.5 text-xs text-stone-600 dark:text-neutral-300 dark:text-neutral-300 open:bg-stone-100 dark:bg-neutral-800 dark:open:bg-neutral-800">
                          ...
                          <pre className="whitespace-pre-wrap break-words mt-1.5 font-sans text-[11px] text-stone-500 dark:text-neutral-400 dark:text-neutral-400">
                            {selectedStreamingAssistant.thinking.slice(-STREAMING_PREVIEW_CHARS)}
                          </pre>
                        </details>
                      )}
                      {selectedStreamingAssistant.content.length > 0 && (
                        <div className="rounded-2xl rounded-bl-md px-3 py-1.5 bg-stone-200/80 dark:bg-neutral-800 text-stone-900 dark:text-neutral-100 dark:text-neutral-100">
                          <p className="text-xs text-stone-700 dark:text-neutral-200 dark:text-neutral-200 font-mono whitespace-pre-wrap break-words leading-snug">
                            {selectedStreamingAssistant.content.length >
                              STREAMING_PREVIEW_CHARS && <span className="text-stone-400 dark:text-neutral-500 dark:text-neutral-500">…</span>}
              ...
              {selectedInferenceStatus && (
                <div className="flex items-center gap-2 px-1 py-1.5 text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400">
              ...
              {isSending && rustChat && (
                <div className="flex justify-start px-1">
                  <button
                    ...
                    className="text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400 hover:text-stone-700 dark:hover:text-neutral-200 dark:text-neutral-200 dark:hover:text-neutral-200 transition-colors">
                    {t('common.cancel')}
                  </button>
                </div>
              )}
            ...
            <div className="flex-1 flex items-center justify-center h-full">
              <p className="text-sm text-stone-600 dark:text-neutral-300 dark:text-neutral-300">{t('chat.noMessages')}</p>
            </div>
          )}
        </div>

        <div className="flex-shrink-0 border-t border-stone-200 dark:border-neutral-800 dark:border-neutral-800 px-4 py-3">
              ...
              {(isLoadingBudget || teamUsage) && (
                <div className="relative group">
                  {teamUsage ? (
                    ...
                    <span className="text-[10px] text-stone-400 dark:text-neutral-500 dark:text-neutral-500 animate-pulse">
                      {t('common.loading')}
                    </span>
                  )}
                  {teamUsage && (
                      ...
                      <div className="bg-stone-900 text-white text-[10px] rounded-lg px-3 py-2 shadow-lg whitespace-nowrap space-y-1.5">
                        {!teamUsage.bypassCycleLimit && (
                          <div className="flex items-center justify-between gap-4">
                            <span className="text-stone-400 dark:text-neutral-500 dark:text-neutral-500">{t('chat.fiveHourLimit')}</span>
                            <span>
                              ${(teamUsage.cycleLimit5hr ?? 0).toFixed(2)} / $
                              {(teamUsage.fiveHourCapUsd ?? 0).toFixed(2)}
                              {teamUsage.fiveHourResetsAt && (
                                <span className="text-stone-400 dark:text-neutral-500 dark:text-neutral-500 ml-1">
                        ...
                        <div className="flex items-center justify-between gap-4">
                          <span className="text-stone-400 dark:text-neutral-500 dark:text-neutral-500">{t('chat.weeklyLimit')}</span>
                          <span>
          ...
          {sendAdvisory && (
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400 hover:text-stone-700 dark:hover:text-neutral-200 dark:text-neutral-200 dark:hover:text-neutral-200 transition-colors ml-2">
                {t('common.dismiss')}
              </button>
            </div>
          )}
          ...
          {composer === 'mic-cloud' ? (
            ...
            <div className="flex items-end gap-3">
              <div className="relative flex flex-1 items-center justify-center rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 transition-all focus-within:border-primary-500/50 focus-within:ring-1 focus-within:ring-primary-500/50">
                <div
                  aria-hidden
                  ...
                  <span className="text-stone-500 dark:text-neutral-400/50 dark:text-neutral-400/50">{inlineCompletionSuffix}</span>
                </div>
                <textarea
                  ref={textInputRef}
                  value={inputValue}
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs text-stone-400 dark:text-neutral-500 dark:text-neutral-500 truncate">
                {voiceStatus ??
