    ...
    return (
      <div className="rounded-2xl border border-stone-200 bg-white p-8 shadow-soft animate-fade-up">
        <div className="flex flex-col items-center justify-center gap-5">
          <h1 className="text-xl font-bold text-stone-900">{t('onboarding.contextGathering.title')}</h1>
          <p className="text-sm text-stone-600 text-center max-w-xs leading-relaxed">
            {t('onboarding.contextGathering.errorDesc')}
          </p>
          <OnboardingNextButton label={t('onboarding.contextGathering.continueToChat')} onClick={continueToChat} />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-2xl border border-stone-200 bg-white p-8 shadow-soft animate-fade-up">
      <div className="flex flex-col items-center justify-center gap-6 py-8">
        ...
        {/* Title */}
        <h1 className="text-xl font-bold text-stone-900 animate-pulse">{t('onboarding.contextGathering.buildingProfile')}</h1>
