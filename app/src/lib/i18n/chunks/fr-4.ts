...
const fr4: TranslationMap = {
  ...
  'conversations.toolTimeline.turn':
    'tour ${subagent.childIteration}/${subagent.childMaxIterations}',
  ...
  'settings.autocomplete.completionStyle.acceptedCompletion':
    "${String(historyEntries.length)} complétion${historyEntries.length === 1 ? '' : 's'} acceptée${historyEntries.length === 1 ? '' : 's'} — utilisée pour personnaliser les suggestions futures.",
