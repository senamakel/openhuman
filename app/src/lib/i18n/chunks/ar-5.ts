...
const ar5: TranslationMap = {
  ...
  'settings.composio.apiKeyStoredPlaceholder': '••••••••••••  (المفتاح محفوظ — الصق مفتاحًا جديدًا للاستبدال)',
  ...
  'settings.localModel.deviceCapability.installOllamaFirst': 'ثبّت Ollama أولاً لاستخدام هذا المستوى',
