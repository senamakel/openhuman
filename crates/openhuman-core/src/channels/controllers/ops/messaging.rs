...
pub async fn channel_send_message(
    ...
    let result = client
        ...
        .await
        .map_err(|e| format!("failed to send channel message: {}", crate::api::flatten_authed_error(e)))?;
...
pub async fn channel_send_reaction(
    ...
    let result = client
        ...
        .await
        .map_err(|e| format!("failed to send channel reaction: {}", crate::api::flatten_authed_error(e)))?;
...
pub async fn channel_create_thread(
    ...
    let result = client
        ...
        .await
        .map_err(|e| format!("failed to create channel thread: {}", crate::api::flatten_authed_error(e)))?;
...
pub async fn channel_update_thread(
    ...
    let result = client
        ...
        .await
        .map_err(|e| format!("failed to update channel thread: {}", crate::api::flatten_authed_error(e)))?;
...
pub async fn channel_list_threads(
    ...
    let result = client
        ...
        .await
        .map_err(|e| format!("failed to list channel threads: {}", crate::api::flatten_authed_error(e)))?;
