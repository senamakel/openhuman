...
const DiscordServerChannelPicker = ({
  ...
  return (
    <div className="mt-3 space-y-3">
      <p className="text-xs font-medium text-stone-600 dark:text-neutral-300 dark:text-neutral-300">
      ...
      {/* Guild selector */}
      <div>
        <label htmlFor="discord-guild-select" className="block text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400 mb-1">
        ...
        <select
          ...
          className="w-full rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 dark:text-neutral-100 focus:border-primary-500 focus:outline-none disabled:opacity-50">
          <option value="">
        ...
        {guilds.length === 0 && state === 'guilds_loaded' && (
          <p className="mt-1 text-xs text-stone-400 dark:text-neutral-500 dark:text-neutral-500">
      ...
      {selectedGuildId && (
        <div>
          <label htmlFor="discord-channel-select" className="block text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400 mb-1">
      ...
      {state === 'checking_permissions' && (
        <div className="flex items-center gap-2 text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400">
          <span className="inline-block h-3 w-3 animate-spin rounded-full border-2 border-stone-300 dark:border-neutral-700 dark:border-neutral-700 border-t-primary-500" />
