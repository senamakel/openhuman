...
const en3: TranslationMap = {
  ...
  'backend.cloudDescription': 'Fast, powerful models hosted on our servers. Ready to use immediately.',
  'backend.privacyNote': 'No personal data, messages, or keys are ever sent to our servers.',
  'backend.local': 'Local',
  'backend.advanced': 'Advanced',
  'backend.localDescription': 'Run models on your own machine using Ollama. Full privacy, requires setup.',
  ...
  'bootCheck.validUrlRequired': 'That doesn\'t look like a valid URL (try https://core.example.com/rpc)',
  ...
  'bootCheck.webDescription': 'On the web, OpenHuman connects to a runtime you control. Drop in its URL and auth token below, or grab the desktop app to run one right on your machine.',
  ...
  'bootCheck.localDescription': 'Runs right here on your computer. Fastest, fully private, nothing to set up.',
  'bootCheck.cloudMode': 'Run on the Cloud (Complex)',
  'bootCheck.cloudDescription': 'Connect to a runtime you\'re hosting elsewhere. Stays online 24×7 so you don\'t need to keep this device running.',
  ...
  'bootCheck.legacyDescription': 'A separately-installed OpenHuman daemon is already running on this device. We need to clear it out before the built-in runtime can take over.',
  ...
  'bootCheck.localNeedsRestartDesc': 'Your local runtime is on a different version than this app. A quick restart will get them back in sync.',
  ...
  'bootCheck.cloudNeedsUpdateDesc': 'Your cloud runtime is on a different version than this app. Run the updater to bring them back in sync.',
  ...
  'bootCheck.versionCheckFailedDesc': 'Your runtime is up but isn\'t reporting its version. It may be outdated. Restart or update it to continue.',
