...
//!
//! [`MemoryGoals`](crate::memory::api::provider::MemoryGoals) has
...
//! [`safety`](crate::memory::safety) is where they started.
...
use crate::memory::api::goals::{GoalItem, GoalsDoc};
use crate::memory::safety::{has_likely_email, has_likely_pii, has_likely_secret, sanitize_text};
