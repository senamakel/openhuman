...
use crate::openhuman::memory_tree::summarizer::store;
use crate::openhuman::memory_tree::summarizer::types::{
    ...
    for entry in std::fs::read_dir(dir)? {
        ...
        } else if ft.is_file() && name.ends_with(".md") && name != "summary.md" && name != "root.md"
        {
            ...
            if level == NodeLevel::Hour {
                ...
                let node =
                    crate::openhuman::memory_tree::summarizer::store::parse_node_markdown_pub(
