      ...
      <div className="flex items-end justify-center gap-3 px-3 pb-2 max-w-full overflow-x-auto">
        {models.map(model => (
          <div
            ...
            <div
              className="mt-1 max-w-[88px] rounded-md border border-white/70 bg-white/85 px-1.5 py-0.5 text-center text-[9px] leading-tight text-stone-600 shadow-soft backdrop-blur dark:border-line-strong dark:bg-surface/85 dark:text-neutral-200"
