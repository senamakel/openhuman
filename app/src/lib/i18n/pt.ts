...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'Conselho',
  'modelCouncil.title': 'Conselho de modelos',
  'modelCouncil.intro':
    'Faça uma pergunta, receba respostas independentes de vários modelos em paralelo e então um presidente sintetiza onde concordam, onde discordam e o que cada um acrescenta.',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro':
    'Escolha um conselho salvo, edite seus agentes e juiz, ou crie um novo conselho para um tipo específico de decisão.',
  ...
  'modelCouncil.savingCouncil': 'Salvando…',
  'modelCouncil.cancelEdit': 'Cancelar',
  'modelCouncil.loadingCouncils': 'Carregando conselhos…',
  'modelCouncil.noCouncils': 'Ainda não há conselhos. Adicione um para começar.',
  'modelCouncil.noCouncilDescription': 'Sem descrição',
  'modelCouncil.registryErrorPrefix': 'Registro de conselhos falhou:',
  'modelCouncil.councilNameLabel': 'Nome do conselho',
  'modelCouncil.councilDescriptionLabel': 'Descrição',
  'modelCouncil.councilDescriptionPlaceholder': 'Quando usar este conselho',
  'modelCouncil.selectModel': 'Selecionar',
  'modelCouncil.modelPickerHelp':
    'Selecione uma dica de roteamento ou fixe um modelo exato do provedor.',
  'modelCouncil.closeModelPicker': 'Fechar',
  'modelCouncil.modelPickerHints': 'Dicas',
  ...
  'modelCouncil.questionLabel': 'Pergunta',
  ...
  'modelCouncil.modelHint.default': 'Padrão',
  'modelCouncil.modelHint.chat': 'Chat',
  'modelCouncil.modelHint.reasoning': 'Raciocínio',
  'modelCouncil.modelHint.code': 'Código',
  'modelCouncil.modelHint.summarize': 'Resumir',
  'modelCouncil.defaultSeat.analyst.name': 'Analista',
  'modelCouncil.defaultSeat.analyst.brief': 'Evidências, premissas e risco.',
  'modelCouncil.defaultSeat.builder.name': 'Construtor',
  'modelCouncil.defaultSeat.builder.brief': 'Caminho prático de implementação.',
  'modelCouncil.defaultSeat.skeptic.name': 'Cético',
  'modelCouncil.defaultSeat.skeptic.brief': 'Modos de falha e contexto ausente.',
  'modelCouncil.defaultCouncilName': 'Novo conselho',
  'modelCouncil.defaultJudgeName': 'Juiz principal',
  'modelCouncil.untitledCouncilName': 'Conselho sem título',
  ...
  'modelCouncil.debateRoundsLabel': 'Turnos de debate',
  'modelCouncil.debateRoundsHelp':
    'Cada jurado continua debatendo por vários turnos antes de o juiz escrever a síntese final.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'As atualizações dos jurados são adicionadas aqui após cada rodada e depois entram na próxima rodada.',
  'modelCouncil.liveScratchpadBadge': 'Ao vivo',
  ...
  'modelCouncil.deliberationHelp':
    'As mascotes mostram cada agente pensando enquanto o arquivo de raciocínio compartilhado está em uso.',
  'modelCouncil.debateRoundInstruction':
    'Responda aos outros jurados até agora. Preserve discordâncias, revise sua visão quando necessário e mantenha sua conclusão atual explícita.',
  'modelCouncil.debateFinalInstruction':
    'Este é seu turno final como jurado. Converja onde as evidências apoiam, destaque a discordância restante e entregue ao juiz uma conclusão clara.',
  'modelCouncil.roundLabel': 'Rodada {round}',
  'modelCouncil.currentRoundThinking': 'Continuando o próximo turno…',
  'modelCouncil.thinkingBadge': 'Pensando',
  'modelCouncil.thinkingWithBrief': 'Trabalhando desta perspectiva: {brief}',
  'modelCouncil.thought.evidence':
    'Verificando evidências, premissas e o que o arquivo de raciocínio compartilhado já captura.',
  ...
  'modelCouncil.thought.tradeoffs':
    'Comparando tradeoffs antes de entregar ao juiz uma posição concisa.',
  'modelCouncil.thought.synthesis':
    'Preparando uma visão distinta para que o juiz compare discordâncias reais.',
  'modelCouncil.judgeWaitingBadge': 'Juiz',
  'modelCouncil.judgeWaitingThought':
    'Aguardando respostas dos jurados, depois lendo o arquivo de raciocínio compartilhado para sintetizar.',
  ...
  'modelCouncil.errorPrefix': 'Conselho falhou:',
  'modelCouncil.resultsHeading': 'Resultados do conselho',
  'modelCouncil.memberAnswered': 'Respondeu',
  'modelCouncil.memberFailed': 'Falhou',
  'modelCouncil.synthesisHeading': 'Síntese',
  'modelCouncil.synthesisBy': 'por {model}',
  'modelCouncil.usageHeading': 'Uso do debate',
  'modelCouncil.usageEstimated':
    'Estimado a partir dos prompts e respostas do debate até que o uso do provedor seja anexado ao RPC do conselho.',
  'modelCouncil.usageEstimatedBadge': 'Tokens estimados',
  'modelCouncil.usageInputTokens': 'Entrada',
  'modelCouncil.usageOutputTokens': 'Saída',
