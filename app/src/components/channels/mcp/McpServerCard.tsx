...
const McpServerCard = ({ server, onSelect }: McpServerCardProps) => {
  return (
    <button
      ...
      className="w-full text-left rounded-lg border border-line bg-stone-50 dark:bg-neutral-800/60 p-3 flex items-start gap-3 hover:border-primary-300 dark:hover:border-primary-500/40 hover:bg-stone-100/50 dark:hover:bg-neutral-800 transition-colors cursor-pointer">
      {server.icon_url ? (
        <img
          src={server.icon_url}
          alt=""
