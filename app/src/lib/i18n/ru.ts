...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.denied.next': 'Ничего делать не нужно — оно не было выполнено. Попросите снова, если передумаете.',
  'conversations.toolFailure.approvalExpired.cause': 'Срок запроса на подтверждение истёк, прежде чем кто-либо ответил.',
  'conversations.toolFailure.approvalExpired.next': 'Попросите снова, чтобы выполнить его — OpenHuman не повторит попытку сам.',
