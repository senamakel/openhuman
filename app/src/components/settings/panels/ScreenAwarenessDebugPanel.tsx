  ...
  return (
    <section className="space-y-3">
      <button
        ...
        <span className="text-xs text-stone-400 dark:text-neutral-500">{isOpen ? 'Collapse' : 'Expand'}</span>
      </button>
  ...
  return (
    <div className="z-10 relative">
      ...
      <div className="max-w-2xl mx-auto w-full p-4 space-y-4">
        ...
        <section className="space-y-3">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">Screen Intelligence Policy</h3>
          ...
          <div className="space-y-1">
            <div className="text-xs text-stone-600 dark:text-neutral-300">Allowlist (one rule per line)</div>
            <textarea
              value={allowlistText}
          ...
          <div className="space-y-1">
            <div className="text-xs text-stone-600 dark:text-neutral-300">Denylist (one rule per line)</div>
            <textarea
              value={denylistText}
        ...
        {/* Session stats */}
        <section className="space-y-3">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">Session Stats</h3>
        ...
        <section className="space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">Vision Summaries</h3>
            <button
              type="button"
            ...
            <div className="space-y-2">
              {recentVisionSummaries.map(summary => (
                <div
                  ...
                  <div className="mt-1 text-stone-800 dark:text-neutral-100">{summary.actionable_notes}</div>
                </div>
              ))}
            </div>
          )}
