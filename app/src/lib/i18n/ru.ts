...
const messages: TranslationMap = {
  ...
  'home.statusOk': 'Ваш ассистент готов, когда вы будете готовы. Напишите что-нибудь ниже, чтобы начать.',
  ...
  'home.banners.promoCreditsBody': 'У вас есть {amount} Описание промо-кредитов',
