...
pub fn built_in_profiles() -> Vec<AgentProfile> {
    vec![
        ...
        AgentProfile {
            id: "pro-reasoning".to_string(),
            name: "Pro-reasoning".to_string(),
            description: "Premium reasoning tier (always managed).".to_string(),
            agent_id: "orchestrator".to_string(),
            model_override: Some("hint:pro-reasoning".to_string()),
            temperature: None,
            system_prompt_suffix: None,
            allowed_tools: None,
            built_in: true,
