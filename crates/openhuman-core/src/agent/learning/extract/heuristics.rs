...
//!
//! Three detectors feed [`crate::agent::learning::candidate::global()`]:
//!
...
//! intended to be called from [`crate::agent::learning::ReflectionHook`] or a
...
use crate::agent::learning::candidate::{
