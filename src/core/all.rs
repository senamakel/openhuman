...
fn build_registered_controllers() -> Vec<RegisteredController> {
    ...
    controllers.extend(crate::openhuman::memory_sync::sync_status::all_memory_sync_status_registered_controllers());
...
fn build_declared_controller_schemas() -> Vec<ControllerSchema> {
    ...
    schemas.extend(crate::openhuman::memory_sync::sync_status::all_memory_sync_status_controller_schemas());
