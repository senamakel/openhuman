...
const messages: TranslationMap = {
  ...
  'migration.description': '다른 로컬 어시스턴트의 메모리와 노트를 이 워크스페이스로 마이그레이션합니다. 먼저 미리 보기로 변경 사항을 확인한 다음 적용하여 데이터를 복사하세요. 현재 메모리는 먼저 백업됩니다.',
  ...
  'migration.sourceHint': '비워두면 공급업체의 기본 위치를 사용합니다. 워크스페이스를 다른 위치로 이동한 경우 명시적인 경로를 설정하세요.',
  'migration.previewAction': '미리 보기',
  'migration.previewRunning': '미리보기 중…',
  'migration.applyAction': '가져오기 적용',
  'migration.applyRunning': '가져오는 중…',
  'migration.applyDisclaimer': '동일한 소스에서 미리 보기를 성공적으로 완료한 후 적용이 활성화됩니다. 가져오기 전에 기존 메모리가 백업됩니다.',
  ...
  'migration.report.previewHint': '아직 데이터를 가져오지 않았습니다. 가져오기 적용을 클릭하여 복사하세요.',
  'migration.report.appliedHint': '가져온 항목이 이제 메모리에 있습니다. 다시 비교하려면 미리 보기를 다시 실행하세요.',
  'migration.confirmImport.singular': '현재 워크스페이스로 {count}개의 항목을 가져오시겠습니까?\n\n소스: {source}\n대상: {target}\n\n가져오기 실행 전에 기존 메모리가 백업됩니다.',
  'migration.confirmImport.plural': '현재 워크스페이스로 {count}개의 항목을 가져오시겠습니까?\n\n소스: {source}\n대상: {target}\n\n가져오기 실행 전에 기존 메모리가 백업됩니다.',
  ...
  'welcome.clearAppDataWarning': '이 작업은 이 기기에 로컬로 저장된 비밀 정보와 계정을 초기화합니다. 클라우드 계정은 영향을 받지 않으며 즉시 다시 로그인할 수 있습니다.',
  'welcome.resetErrorFallback': '앱 데이터를 지울 수 없습니다. OpenHuman을 종료하고 다시 열어 재시도하세요.',
  ...
  'home.statusOk': '기기가 연결되었습니다. 연결을 유지하려면 앱을 계속 실행해 주세요. 아래 버튼으로 에이전트에게 메시지를 보내세요.',
  'home.statusBackendOnly': '백엔드에 다시 연결하는 중입니다… 곧 에이전트를 다시 사용할 수 있습니다.',
  'home.statusCoreUnreachable': '로컬 코어 사이드카가 응답하지 않습니다. OpenHuman 백그라운드 프로세스가 중단되었거나 시작하지 못했을 수 있습니다.',
  'home.statusInternetOffline': '현재 기기가 오프라인 상태입니다. 네트워크를 확인하거나 앱을 다시 시작하여 다시 연결하세요.',
  ...
  'home.usageExhaustedBody': '현재 포함된 사용량을 모두 소진했습니다. 더 많은 지속 용량을 사용하려면 구독을 시작하세요.',
  ...
  'routines.emptyHint': '어시스턴트는 아침 브리핑이나 일일 요약처럼 일정에 따라 작업을 실행할 수 있습니다.',
  ...
  'skills.integrationsSubtitle': '클라우드 기반 OAuth 연결 — 계정으로 로그인하면 Composio가 토큰을 관리하여 에이전트가 사용자를 대신해 읽고 작동할 수 있습니다. API 키 관리가 필요 없습니다.',
  'skills.composio.noApiKeyTitle': '아니요 Composio API 키가 구성됨',
  'skills.composio.noApiKeyDescription': '로컬 모드에서는 자체 Composio API 키를 사용합니다. 설정 → 고급 → Composio에서 키를 추가한 후 여기서 통합을 연결하세요.',
  ...
  'graphCentrality.intro': '메모리 그래프에 PageRank를 적용해 핵심 허브와, 단순 빈도 계산으로는 드러나지 않는 분리된 클러스터를 연결하는 엔터티를 드러냅니다.',
  ...
  'graphCentrality.emptyHint': '어시스턴트가 사용자에 대한 사실을 기록하면 가장 많이 연결된 엔터티가 여기에 표시됩니다.',
  ...
  'memoryTree.status.autoSyncDescription': '새 수집을 중지하려면 일시 중지하세요. 기존 위키는 계속 쿼리할 수 있습니다.',
  ...
  'rewards.coupons': '교환',
  'rewards.localUnavailable': '로컬 로그인은 리워드, 쿠폰 또는 추천 크레딧을 적립할 수 없습니다. 리워드를 적립하려면 로그아웃하고 OpenHuman 계정으로 로그인하세요.',
  ...
  'onboarding.welcomeDesc': '컴퓨터에서 실행되는 초지능 AI 어시스턴트입니다. 비공개이며, 간단하고, 매우 강력합니다.',
  ...
  'onboarding.runtimeChoice.subtitle': '가장 잘 맞는 설정을 선택하세요. 나중에 설정에서 변경할 수 있습니다.',
  ...
  'onboarding.apiKeys.subtitle': '지금 붙여넣거나 건너뛰고 나중에 설정 › AI에서 추가할 수 있습니다. 키는 이 기기에 저장되며 저장 시 암호화됩니다.',
  'onboarding.apiKeys.openaiLabel': 'OpenAI API 키',
  'onboarding.apiKeys.openaiPlaceholder': 'sk-...',
  'onboarding.apiKeys.openaiOauthHint': 'ChatGPT Plus/Pro(구독) 또는 OpenAI API 키를 사용하세요. 둘 다 필수는 아닙니다.',
  ...
  'onboarding.custom.configureLater': '온보딩 후에 이 설정을 마칠 수 있습니다. 완료되면 해당 설정 페이지로 이동합니다.',
  'onboarding.custom.openSettings': '설정에서 열기',
  'onboarding.custom.inference.title': '추론(텍스트)',
  'onboarding.custom.inference.subtitle': '어떤 언어 모델이 질문에 답하고 에이전트를 실행해야 하나요?',
  'onboarding.custom.inference.defaultDesc': 'OpenHuman은 모든 작업을 적절한 기본 모델로 라우팅합니다. 키도 필요 없고 설정도 필요 없습니다.',
  'onboarding.custom.inference.configureDesc': '직접 OpenAI 또는 Anthropic 키를 가져오세요. 모든 텍스트 기반 작업에 이 키를 사용합니다.',
  'onboarding.custom.voice.title': '음성',
  'onboarding.custom.voice.subtitle': '음성 모드를 위한 음성-텍스트 변환 및 텍스트-음성 변환입니다.',
  'onboarding.custom.voice.defaultDesc': 'OpenHuman에는 바로 사용할 수 있는 관리형 STT/TTS가 포함되어 있습니다. 별도로 연결할 필요가 없습니다.',
  'onboarding.custom.voice.configureDesc': '직접 ElevenLabs / OpenAI Whisper 등을 사용하세요. 설정 › 음성에서 구성할 수 있습니다.',
  'onboarding.custom.oauth.title': '연결(OAuth)',
  'onboarding.custom.oauth.subtitle': 'OAuth가 필요한 Gmail, Slack, Notion 및 기타 연결 서비스입니다.',
  'onboarding.custom.oauth.defaultDesc': 'OpenHuman은 관리형 Composio 워크스페이스를 실행합니다. 나중에 각 서비스를 한 번의 클릭으로 연결할 수 있습니다.',
  'onboarding.custom.oauth.configureDesc': '직접 Composio 계정 또는 API 키를 가져오세요. 설정 › 연결에서 구성할 수 있습니다.',
  'onboarding.custom.search.title': '웹 검색',
  'onboarding.custom.search.subtitle': 'OpenHuman이 사용자를 대신해 웹을 검색하는 방식입니다.',
  'onboarding.custom.search.defaultDesc': 'OpenHuman은 관리형 검색 백엔드를 사용합니다. 키가 필요 없습니다.',
  'onboarding.custom.search.configureDesc': '직접 검색 제공업체 키(Tavily, Brave 등)를 가져오세요. 설정 › 도구에서 구성할 수 있습니다.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle': 'OpenHuman이 시맨틱 메모리 검색을 위한 벡터 임베딩을 생성하는 방식입니다.',
  'onboarding.custom.embeddings.defaultDesc': 'OpenHuman이 관리형 임베딩 서비스를 사용합니다. API 키가 필요 없습니다.',
  'onboarding.custom.embeddings.configureDesc': '자체 임베딩 공급자(OpenAI, Voyage, Ollama 등)를 사용하세요.',
  'onboarding.custom.memory.title': '메모리',
  'onboarding.custom.memory.subtitle': 'OpenHuman이 사용자의 컨텍스트, 선호도, 이전 대화를 기억하는 방식입니다.',
  'onboarding.custom.memory.defaultDesc': 'OpenHuman은 메모리 저장과 검색을 자동으로 관리합니다. 설정할 것이 없습니다.',
  'onboarding.custom.memory.configureDesc': '메모리를 직접 검사, 내보내기 또는 삭제할 수 있습니다. 설정 › 메모리에서 구성할 수 있습니다.',
  ...
  'accounts.disconnectClearMemoryHint': '이 연결과 연관된 로컬 메모리 조각을 영구적으로 삭제합니다.',
  ...
  'devOptions.toolPolicyDiagnostics.mcpAllowlists.summary': '활성화됨: {enabled} · 서버: {enabledCount}/{totalCount}',
  ...
  'devOptions.toolPolicyDiagnostics.mcpWriteAudit.summary': '활성화됨: {enabled} · 최근(24시간): {recentRows}',
  ...
  'devOptions.toolPolicyDiagnostics.redactedSurfaces.summary': '쓰기 가능: {writeCount} · 정책 표면: {policyCount}',
  ...
  'misc.beta': 'OpenHuman은 초기 베타 버전입니다. 피드백을 공유하거나 발견한 버그를 신고해 주세요 — 모든 신고는 더 빠른 출시를 돕습니다.',
  'misc.betaFeedback': '피드백 보내기',
  'mnemonic.title': '복구 문구',
  'mnemonic.warning': '이 단어들을 순서대로 적어 안전한 곳에 보관하세요.',
  'mnemonic.copyWarning': '복구 문구를 절대 공유하지 마세요. 이 단어를 가진 사람은 누구나 계정에 접근할 수 있습니다.',
  ...
  'privacy.shareAnonymizedDataDesc': '익명 충돌 보고서와 사용 분석을 공유하여 OpenHuman 개선을 도와주세요. 모든 데이터는 완전히 익명화되며, 개인 데이터, 메시지, 지갑 키 또는 세션 정보는 절대 수집되지 않습니다.',
  'privacy.meetingFollowUps': '회의 후속 조치',
  'privacy.autoHandoffMeet': 'Google Meet transcript를 오케스트레이터에 자동 전달',
  'privacy.autoHandoffMeetDesc': 'Google Meet 통화가 끝나면 OpenHuman의 오케스트레이터가 transcript를 읽고 메시지 초안 작성, 후속 일정 예약, 연결된 Slack 워크스페이스에 요약 게시 같은 작업을 수행할 수 있습니다. 기본값은 꺼짐입니다.',
  'privacy.analyticsDisclaimer': '모든 분석 및 버그 보고서는 완전히 익명화됩니다. 활성화하면 충돌 정보, 기기 유형, 오류 파일 위치만 수집합니다. 메시지, 세션 데이터, 지갑 키, API 키 또는 개인 식별 정보에는 절대 접근하지 않습니다. 이 설정은 언제든지 변경할 수 있습니다.',
  ...
  'settings.about.connectionHelperLocal': '앱 실행 시 Tauri 셸이 프로세스 내부에서 시작합니다. 포트는 시작할 때 선택되므로 이 URL은 실행할 때마다 달라집니다.',
  'settings.about.connectionHelperCloud': '원격 코어에 연결되었습니다. BootCheck 또는 클라우드 모드 선택기에서 변경하세요.',
  ...
  'settings.costDashboard.desc': '전체 스웜의 7일 지출과 토큰 사용량, 예산 속도 및 모델별 세부 내역입니다.',
  ...
  'settings.costDashboard.disabledHint': '비용 대시보드가 config에서 비활성화되어 있습니다. 다시 활성화하려면 config.toml에서 [cost.dashboard] enabled = true로 설정하세요.',
  'settings.costDashboard.subtitle': '전체 스웜의 실시간 지출과 토큰 사용량입니다. 막대는 몇 초마다 자동으로 새로고침되며 페이지를 다시 로드할 필요가 없습니다.',
  ...
  'settings.costDashboard.monthlyPaceHint': '현재 일일 실행 속도(평균 × 30)를 기준으로 예상한 월간 지출입니다.',
  'settings.costDashboard.budgetLimitHint': 'config.toml의 cost.monthly_limit_usd에서 읽은 월간 예산입니다.',
  ...
  'settings.costDashboard.noDataHint': '에이전트 메시지를 보내세요. 다음 제공업체 호출의 토큰 사용량이 약 10초 안에 차트에 표시됩니다.',
  'settings.search.title': '검색 엔진',
  'settings.search.menuDesc': 'OpenHuman 관리 검색을 기본값으로 사용하거나 API 키로 자체 제공업체를 연결하세요.',
  'settings.search.description': '에이전트가 사용할 검색 엔진을 선택하거나 검색 도구를 완전히 비활성화합니다. 관리형은 OpenHuman의 백엔드를 사용합니다(설정 불필요). 병렬, Brave, Querit은 API 키를 사용하여 내 컴퓨터에서 직접 실행됩니다.',
  'settings.search.engineAria': '검색 엔진',
  'settings.search.engineDisabledLabel': 'Disabled',
  'settings.search.engineDisabledDesc': '에이전트 컨텍스트 및 사용 가능한 도구 목록에서 검색 도구를 제거합니다.',
  'settings.search.engineManagedLabel': 'OpenHuman 관리됨',
  'settings.search.engineManagedDesc': '기본값입니다. OpenHuman 백엔드를 통해 라우팅되며 API 키가 필요하지 않습니다.',
  'settings.search.localManagedUnavailable': '로컬 사용자는 OpenHuman 관리 검색을 사용할 수 없습니다. 웹 검색을 활성화하려면 자체 Parallel, Brave 또는 Querit API 키를 추가하세요.',
  'settings.search.engineParallelLabel': 'Parallel',
  'settings.search.engineParallelDesc': '직접 Parallel API: 검색, 추출, 채팅, 리서치, 보강, 데이터셋 도구.',
  ...
  'settings.search.engineQueritDesc': '직접 Querit API: 사이트, 시간 범위, 국가 및 언어 필터가 있는 웹 검색.',
  'settings.search.statusConfigured': '구성됨',
  'settings.search.statusNeedsKey': 'API 키 필요',
  'settings.search.fallbackToManaged': '구성된 키가 없습니다. 키가 저장될 때까지 검색은 관리형으로 대체됩니다.',
  ...
  'settings.search.allowedSitesHint': '리서치 중 어시스턴트가 열고 읽을 수 있는 웹사이트입니다(한 줄에 호스트 하나, 예: reuters.com). 호스트에는 하위 도메인도 포함됩니다. 모든 웹 접근을 차단하려면 비워 두세요.',
  'settings.search.allowedSitesAllOn': '어시스턴트가 모든 공개 웹사이트를 열 수 있습니다. 로컬 및 비공개 주소는 계속 차단됩니다.',
  ...
  'settings.search.accessBlockAllHint': '모든 웹 접근이 차단됩니다. 어시스턴트는 어떤 웹사이트도 열거나 읽을 수 없습니다.',
  'settings.embeddings.title': '임베딩',
  'settings.embeddings.description': '시맨틱 검색을 위해 메모리를 벡터로 변환할 임베딩 제공자를 선택하세요. 제공자, 모델 또는 차원을 변경하면 저장된 벡터가 무효화되며 전체 메모리 초기화가 필요합니다.',
  ...
  'settings.embeddings.wipeBody': '임베딩 제공자, 모델 또는 차원을 변경하면 저장된 모든 메모리 벡터가 삭제됩니다. 검색이 다시 작동하려면 메모리를 재구축해야 합니다. 이 작업은 취소할 수 없습니다.',
  ...
  'settings.embeddings.vectorSearchDisabled': '벡터 검색이 비활성화되어 있습니다. 메모리 회상은 의미 순위 없이 키워드 매칭과 최신성만 사용합니다.',
  ...
  'mcp.alphaBadge': '알파',
  'mcp.alphaBannerText': 'MCP 서버 지원은 초기 알파 단계입니다. Smithery 레지스트리, 설치 흐름 및 도구 연결은 릴리스 사이에 오작동하거나 형태가 바뀔 수 있습니다.',
  ...
  'mcp.setup.secretDialog.bodySuffix': '. 입력한 값은 코어 프로세스로 직접 전송되며 AI 대화에는 절대 들어가지 않습니다.',
  ...
  'mcp.setup.secretDialog.privacyNote': '로컬 MCP 비밀 테이블에 암호화되어 저장됩니다. 로그에 남기거나 모델로 전송하지 않습니다.',
  'devices.betaBadge': '베타',
  'devices.betaText': '이 기능은 현재 베타 버전입니다. iOS 기기를 이 OpenHuman과 페어링하여 원격 클라이언트로 사용할 수 있습니다.',
  'devices.comingSoonDescription': '기기 페어링이 곧 제공됩니다. 이 페이지에서 iPhone을 페어링하고 연결된 기기를 관리할 수 있게 됩니다.',
  'devices.title': '장치',
  ...
  'devices.confirmRevokeBody': '{label}의 연결이 더 이상 허용되지 않습니다. 이 작업은 취소할 수 없습니다.',
  ...
  'mcp.health.disconnectConfirm.body': '현재 연결된 MCP 서버 {count}개의 연결을 끊습니다. 설치된 구성과 비밀 값은 유지되며 나중에 어떤 서버든 다시 연결할 수 있습니다.',
  ...
  'mcp.health.bulkPartialFailure': '{total}개 서버 중 {failed}개가 실패했습니다. 로그를 확인하세요.',
  ...
  'mcp.inventory.subtitle': '설치된 MCP 서버를 비밀 값이 없는 휴대용 매니페스트로 내보내거나 팀원의 매니페스트를 가져옵니다. 비밀 env 값은 포함되거나 가져오지 않습니다.',
  ...
  'mcp.inventory.export.empty': '아직 설치된 MCP 서버가 없어 내보낼 항목이 없습니다. 먼저 카탈로그에서 서버를 설치하세요.',
  'mcp.inventory.export.privacyTitle': '이 매니페스트에 포함되는 내용',
  'mcp.inventory.export.privacyBody': '서버 이름, 정규 이름, env 변수 KEY NAMES 및 비밀 값이 아닌 구성만 포함됩니다. 비밀 값, 기기 식별자 및 설치별 타임스탬프는 의도적으로 제거됩니다.',
  ...
  'mcp.inventory.import.trustBody': 'MCP 서버는 에이전트에 권한을 부여하는 도구입니다. 신뢰하는 출처의 매니페스트만 가져오세요. 각 설치에는 명시적인 클릭이 필요하며 자동 설치되는 항목은 없습니다.',
  'mcp.inventory.import.pasteLabel': '매니페스트 JSON 붙여넣기',
  'mcp.inventory.import.pastePlaceholder': '여기에 매니페스트를 붙여넣거나 아래에서 .json 파일을 업로드하세요.',
  ...
  'mcp.inventory.parseError.unsupportedSchema': '지원되지 않는 매니페스트 스키마입니다. 이 파일은 호환되는 내보내기 도구에서 생성되지 않았습니다.',
  ...
  'mcp.inventory.parseError.serverEnvKeysNotArray': '서버 항목의 env_keys 필드가 문자열 배열이 아닙니다.',
  'mcp.inventory.parseError.serverContainsEnv': '서버 항목에 `env` 값 맵이 포함되어 있습니다. 가져오기를 거부합니다. 매니페스트에는 env_keys(이름)만 포함되어야 하며 비밀 값은 포함할 수 없습니다.',
  'mcp.inventory.parseError.duplicateQualifiedName': '매니페스트에서 중복된 qualified_name을 찾았습니다. 각 서버는 최대 한 번만 나타나야 합니다.',
  ...
  'mcp.detail.suggestedEnvBody': '제안 값을 적용하려면 이 서버를 해당 값으로 다시 설치하세요: {keys}',
  ...
  'autonomy.maxActionsHelp': '에이전트가 롤링 1시간 동안 실행할 수 있는 최대 도구 작업 수입니다. 새 값은 다음 채팅부터 적용됩니다. 크론 작업 및 채널 리스너는 OpenHuman을 재시작할 때까지 현재 제한을 유지합니다.',
  ...
  'settings.notifications.suppressAllDesc': '포커스 상태와 관계없이 내장 앱의 모든 OS 알림 토스트를 차단합니다.',
  'settings.notifications.toggleDnd': '방해 금지 전환',
  'settings.notifications.categories': '카테고리',
  'settings.notifications.categoryFooter': '카테고리를 비활성화하면 해당 유형의 새 알림이 알림 센터에 표시되지 않습니다. 기존 알림은 삭제될 때까지 남아 있습니다.',
  'settings.billing.movedToWeb': '결제가 웹으로 이동됨',
  'settings.billing.openDashboard': '결제 대시보드 열기',
  'settings.billing.movedToWebDesc': '구독 변경, 결제 수단, 크레딧 및 인보이스는 이제 웹의 TinyHumans에서 관리됩니다.',
  ...
  'settings.tools.chooseCapabilities': 'OpenHuman이 사용자를 대신해 사용할 수 있는 기능을 선택하세요.',
  ...
  'settings.screenAwareness.macosOnly': '화면 인식 데스크톱 캡처 및 권한 제어는 현재 macOS에서만 지원됩니다.',
  ...
  'connections.walletConfigured': '로컬 EVM, BTC, Solana 및 Tron ID가 복구 문구에서 구성되었습니다.',
  ...
  'connections.privacySecurityDesc': '모든 데이터와 자격 증명은 무데이터 보존 정책으로 로컬에 저장됩니다. 사용자의 정보는 암호화되며 제3자와 절대 공유되지 않습니다.',
  ...
  'devOptions.coreModeNotSetDesc': '부트 체크 선택기가 아직 확인되지 않았습니다. 선택기에서 모드 전환을 사용하여 로컬 또는 클라우드를 선택하세요.',
  'devOptions.local': '로컬',
  ...
  'devOptions.triggerSentryTestDesc': 'Sentry 파이프라인을 확인하기 위해 태그가 지정된 오류를 발생시킵니다. 이슈 #1072 — 확인 후 제거.',
  ...
  'devOptions.appLogsDesc': '일별 롤링 로그 파일이 들어 있는 폴더를 엽니다. 문제를 보고할 때 가장 최근 파일을 첨부하세요.',
  ...
  'mnemonic.wordsInOrder': '단어를 순서대로 적어 안전한 곳에 보관하세요. 이 문구는 로컬 암호화 키와 EVM, BTC, Solana 및 Tron 지갑 ID를 보호합니다.',
  'mnemonic.cannotRecover': '이 문구는 분실하면 복구할 수 없으며 기기에서만 완전히 로컬로 유지되어야 합니다.',
  ...
  'mnemonic.enterPhraseToRestore': '로컬 지갑 ID를 복원하려면 아래에 복구 문구를 입력하거나 전체 문구를 아무 입력란에 붙여넣으세요(새 백업은 12단어, 이전 버전의 24단어 문구도 작동합니다).',
  'mnemonic.words': '단어',
  ...
  'team.leaveWarning': '팀과 모든 팀 리소스에 대한 접근 권한을 잃게 됩니다. 다시 참가하려면 새 초대가 필요합니다.',
  ...
  'voice.sttDisabledPrefix': '로컬 STT 모델이 다운로드될 때까지 음성 받아쓰기를 사용할 수 없습니다. 다음을 사용하세요:',
  ...
  'voice.debug.silenceThresholdDesc': '이 값보다 에너지가 낮은 녹음은 무음으로 처리되어 건너뜁니다. 낮을수록 더 민감합니다.',
  ...
  'voice.providers.desc': '전사 및 합성이 실행되는 위치를 선택하세요. 로컬 설치 버튼을 사용하여 바이너리 및 모델을 워크스페이스에 다운로드하세요. 로컬 공급자는 설치 완료 전에도 저장할 수 있으며 WHISPER_BIN 또는 PIPER_BIN 수동 설정이 필요 없습니다.',
  ...
  'voice.providers.whisperDownloadTitle': 'whisper.cpp와 GGML 모델을 워크스페이스에 다운로드합니다.',
  ...
  'voice.providers.piperDownloadTitle': 'Piper와 번들된 en_US-lessac-medium 음성을 워크스페이스에 다운로드합니다.',
  ...
  'voice.providers.piperVoicesDesc': '음성은 huggingface.co/rhasspy/piper-voices에서 제공됩니다. 음성을 변경하려면 새 .onnx를 다운로드하기 위해 설치/재설치를 클릭해야 할 수 있습니다.',
  'voice.providers.mascotVoice': '마스코트 음성',
  'voice.providers.mascotVoiceDescPrefix': '마스코트가 음성 답변에 사용하는 ElevenLabs 음성은 다음에서 구성됩니다',
  ...
  'voice.modal.desc': '이 공급자를 활성화하려면 API 키를 입력하세요. 저장하기 전에 연결을 테스트할 수 있습니다.',
  'voice.modal.testKey': '키 테스트',
  'voice.modal.testing': '테스트 중…',
  'voice.modal.saveAndEnable': '저장 및 활성화',
  'voice.modal.enable': 'Enable',
  'voice.modal.whisperDesc': '모델 크기를 선택하고 Whisper 바이너리 및 GGML 모델을 워크스페이스에 설치하세요. 더 큰 모델은 더 정확하지만 느립니다.',
  'voice.modal.piperDesc': '음성을 선택하고 Piper 바이너리 및 ONNX 모델을 워크스페이스에 설치하세요. Piper는 낮은 지연 시간으로 완전히 오프라인에서 실행됩니다.',
  'voice.routing.title': '음성 라우팅',
  'voice.routing.desc': '음성-텍스트 변환과 텍스트-음성 변환을 처리할 활성화된 공급자를 선택하세요.',
  ...
  'voice.routing.elevenlabsVoiceDesc': '선별된 음성을 선택하거나 ElevenLabs 대시보드에서 커스텀 음성 ID를 붙여넣으세요.',
  'voice.externalProviders.title': '외부 음성 공급자',
  'voice.externalProviders.desc': 'Deepgram, ElevenLabs 또는 OpenAI 같은 서드파티 STT/TTS API를 직접 연결하세요.',
  ...
  'composio.triageDesc': '활성화되면 들어오는 각 Composio 트리거가 이벤트를 분류하고 자동 작업을 시작할 수 있는 AI 선별 단계를 거칩니다 — 트리거당 로컬 LLM 턴 하나가 사용됩니다. 수동 검토를 선호한다면 전체 또는 통합별로 비활성화하세요. 환경 변수가',
  ...
  'localModel.usageDesc': '로컬 모델에서 실행할 하위 시스템을 선택하세요. 꺼진 항목은 클라우드를 사용합니다.',
  'localModel.enableRuntime': '로컬 AI 런타임 활성화',
  'localModel.enableRuntimeDesc': '마스터 스위치입니다. 기본값은 꺼짐이며 Ollama는 유휴 상태로 유지됩니다. 켜면 트리 요약기, 화면 인텔리전스, 자동 완성이 항상 로컬 모델을 사용합니다.',
  ...
  'screenAwareness.debug.useVisionModelDesc': '더 풍부한 컨텍스트를 위해 비전 LLM에 스크린샷을 전송합니다. 꺼져 있으면 텍스트 LLM에서 OCR 텍스트만 사용하므로 더 빠르고 비전 모델이 필요 없습니다.',
  'screenAwareness.debug.keepScreenshots': '스크린샷 유지',
  'screenAwareness.debug.keepScreenshotsDesc': '처리 후 삭제하지 않고 캡처한 스크린샷을 워크스페이스에 저장합니다',
  ...
  'memory.clearNamespaceConfirm': '네임스페이스 "{namespace}"의 모든 문서가 영구적으로 삭제됩니다. 계속하시겠습니까?',
  ...
  'providerSetup.error.credentialsRejected': '{provider}에서 자격 증명을 거부했습니다. API 키를 확인하고 다시 시도하세요.',
  'providerSetup.error.endpointNotRecognized': '{provider}에서 엔드포인트를 인식하지 못했습니다. 기본 URL을 확인하고 다시 시도하세요.',
  'providerSetup.error.providerUnavailable': '{provider}를 현재 사용할 수 없습니다. 다시 시도하거나 공급자 상태를 확인하세요.',
  'providerSetup.error.unreachable': '{provider}에 연결할 수 없습니다. 엔드포인트 URL과 네트워크 연결을 확인한 후 다시 시도하세요.',
  ...
  'notifications.routing.intelligenceDesc': '연결된 계정의 모든 알림은 로컬 AI 모델로 점수가 매겨집니다. 중요도가 높은 알림은 오케스트레이터 에이전트로 자동으로 라우팅되어 중요한 사항을 놓치지 않습니다.',
  ...
  'notifications.routing.loadSettingsError': '설정을 불러오지 못했습니다. 이 패널을 다시 열어 재시도하세요.',
  ...
  'workspace.openingVaultMessage': 'Obsidian이 열리지 않으면 obsidian.md에서 설치하거나 폴더 표시를 사용하세요. 볼트 경로:',
  'workspace.openVaultFailedTitle': 'Obsidian에서 볼트를 열 수 없습니다',
  'workspace.openVaultFailedMessage': '폴더 표시를 사용하여 볼트 디렉터리를 직접 엽니다. 볼트 경로:',
  'workspace.revealVaultFailed': '볼트 폴더를 표시할 수 없습니다',
  'workspace.revealFolder': '폴더 공개',
  'workspace.checkingVault': '확인 중…',
  'workspace.vaultNotRegisteredHelp': 'Obsidian은 볼트로 추가된 폴더만 열 수 있습니다. Obsidian에서 "폴더를 볼트로 열기"를 선택하고 아래 폴더를 선택하세요 — 한 번만 하면 됩니다. 그런 다음 볼트 보기를 다시 클릭하세요.',
  'workspace.obsidianNotFoundHelp': '이 기기에서 Obsidian을 찾을 수 없습니다. 설치하거나, 비표준 위치에 설치되어 있는 경우 고급 설정에서 구성 폴더를 설정하세요.',
  ...
  'workspace.obsidianConfigDirHint': 'obsidian.json이 포함된 폴더 경로 (예: ~/.config/obsidian). 비워두면 자동 감지됩니다.',
  ...
  'memorySources.noCustomSources': '아직 사용자 지정 소스가 없습니다. 폴더, GitHub 리포지토리, RSS 피드 또는 웹 페이지를 추가해 시작하세요.',
  ...
  'backend.cloudDescription': '서버에서 호스팅되는 빠르고 강력한 모델입니다. 즉시 사용할 수 있습니다.',
  'backend.privacyNote': '개인 데이터, 메시지 또는 키는 서버로 전송되지 않습니다.',
  'backend.local': '로컬',
  'backend.advanced': '고급',
  'backend.localDescription': 'Ollama를 사용하여 자신의 컴퓨터에서 모델을 실행합니다. 완전한 개인정보 보호를 제공하지만 설정이 필요합니다.',
  ...
  'bootCheck.webDescription': '웹에서 OpenHuman은 사용자가 제어하는 런타임에 연결됩니다. 아래에 URL과 인증 토큰을 입력하거나, 데스크톱 앱을 받아 이 컴퓨터에서 바로 실행하세요.',
  'bootCheck.preferDesktop': '모든 것을 자신의 기기에 보관하고 싶으신가요?',
  'bootCheck.downloadDesktop': '데스크톱 앱 받기',
  'bootCheck.localRecommended': '로컬에서 실행(추천)',
  'bootCheck.localDescription': '이 컴퓨터에서 바로 실행됩니다. 가장 빠르고, 완전히 비공개이며, 설정할 것이 없습니다.',
  'bootCheck.cloudMode': '클라우드에서 실행(복잡)',
  'bootCheck.cloudDescription': '다른 곳에서 호스팅 중인 런타임에 연결합니다. 24×7 온라인 상태를 유지하므로 이 기기를 계속 켜둘 필요가 없습니다.',
  ...
  'bootCheck.legacyDescription': '별도로 설치된 OpenHuman 데몬이 이 기기에서 이미 실행 중입니다. 내장 런타임이 대신 실행되기 전에 이를 정리해야 합니다.',
  'bootCheck.removing': '제거 중…',
  'bootCheck.removeContinue': '제거하고 계속',
  'bootCheck.localNeedsRestart': '로컬 런타임을 다시 시작해야 함',
  'bootCheck.localNeedsRestartDesc': '로컬 런타임의 버전이 이 앱과 다릅니다. 빠르게 다시 시작하면 다시 동기화됩니다.',
  'bootCheck.restarting': '다시 시작 중…',
  'bootCheck.restartCore': '런타임 다시 시작',
  'bootCheck.cloudNeedsUpdate': '클라우드 런타임 업데이트 필요',
  'bootCheck.cloudNeedsUpdateDesc': '클라우드 런타임의 버전이 이 앱과 다릅니다. 업데이트 프로그램을 실행하여 다시 동기화하세요.',
  'bootCheck.updating': '업데이트 중…',
  'bootCheck.updateCloudCore': '클라우드 런타임 업데이트',
  'bootCheck.versionCheckFailed': '런타임 버전 확인 실패',
  'bootCheck.versionCheckFailedDesc': '런타임이 실행 중이지만 버전을 보고하지 않습니다. 오래된 버전일 수 있습니다. 계속하려면 다시 시작하거나 업데이트하세요.',
  ...
  'bootCheck.portConflictBody': '다른 프로세스가 OpenHuman에 필요한 네트워크 포트를 사용 중입니다. 자동으로 문제를 해결해 드리겠습니다.',
  'bootCheck.portConflictFixButton': '자동 수정',
  'bootCheck.portConflictFixing': '수정 중…',
  'bootCheck.portConflictFixFailed': '자동 수정에 실패했습니다. 컴퓨터를 재시작한 후 다시 시도해 주세요.',
  ...
  'about.update.status.readyToInstallNoVersion': '새 버전이 다운로드되어 준비되었습니다. 적용하려면 다시 시작하세요.',
  ...
  'composio.expiredDescription': '{name} 도구를 다시 활성화하려면 다시 연결하세요. OpenHuman은 OAuth 액세스를 새로 고칠 때까지 이 통합을 사용할 수 없는 상태로 유지합니다.',
  'composio.envVarOverrides': '설정되어 있으며, 이 설정을 재정의합니다.',
  'composio.previewBadge': '미리보기',
  'composio.previewTooltip': '에이전트 통합이 곧 제공됩니다. 연결할 수는 있지만 에이전트는 아직 이 툴킷을 사용할 수 없습니다.',
  'memory.day.sun': '일',
  'memory.day.mon': '월',
  'memory.day.tue': '화',
  'memory.day.wed': '수',
  ...
  'app.openhumanLink.defaultBody': '아직 팝업에서 준비되지 않았습니다. 필요하면 전체 설정 페이지를 여세요.',
  ...
  'app.openhumanLink.notifications.sent': '테스트 알림이 전송되었습니다. 받지 못했다면 시스템 설정 → 알림 → OpenHuman으로 이동해 알림 허용을 켜고 배너 스타일을 지속으로 설정하세요.',
  ...
  'channels.mcp.description': 'AI에 새로운 도구를 추가하는 Model Context Protocol 서버를 탐색하고 관리합니다.',
  ...
  'channels.discord.authMode.oauth.description': 'OAuth을 통해 OpenHuman 봇을 Discord 서버에 설치합니다.',
  'channels.discord.authMode.managed_dm.description': '개인 Discord 계정을 OpenHuman 봇에 연결하세요.',
  ...
  'channels.telegram.authMode.managed_dm.description': 'OpenHuman Telegram 봇에게 직접 메시지를 보냅니다.',
  'channels.telegram.authMode.bot_token.description': '@BotFather에서 자신만의 Telegram 봇 토큰을 제공하세요.',
  ...
  'channels.telegram.remoteControlBody': '허용된 Telegram 채팅에서 /status, /sessions, /new 또는 /help를 보냅니다. 모델 라우팅은 여전히 ​​/model 및 /models를 사용합니다.',
  'channels.web.displayName': '웹',
  'channels.web.description': '내장된 웹 UI를 통해 채팅합니다.',
  'channels.web.authMode.managed_dm.description': '내장된 웹 채팅을 사용하세요. 설정이 필요하지 않습니다.',
  ...
  'iosPair.error.connectionFailed': '연결에 실패했습니다. 데스크탑 앱이 실행 중인지 확인하고 다시 시도하세요.',
  'iosPair.error.invalidQr': '유효하지 않은 QR 코드입니다. OpenHuman 페어링 코드를 스캔하고 있는지 확인하세요.',
  'iosPair.error.unreachableDesktop': '데스크탑에 연결할 수 없습니다. 두 기기가 모두 온라인 상태인지 확인하고 다시 시도하세요.',
  'iosPair.expired': 'QR code이 만료되었습니다. 데스크탑에 코드 재생성을 요청하십시오.',
  'iosPair.instructions': '데스크탑에서 OpenHuman을 열고 설정 > 기기로 이동한 후 "기기 페어링"을 탭하여 QR 코드를 표시하세요.',
  ...
  'composio.connect.dynamicsOrgNameHint': '예를 들어 myorg.crm.dynamics.com의 경우 "myorg"입니다. 전체 URL이 아닌 짧은 조직 이름만 입력하세요.',
  ...
  'composio.connect.idleDescriptionSuffix': '계정. 브라우저 창을 열면 그곳에서 접근을 승인하고, 이 앱이 자동으로 연결을 감지합니다.',
  'composio.connect.isConnected': '연결되었습니다.',
  'composio.connect.manage': '관리',
  'composio.connect.needsFieldsPrefix': '연결하려면',
  'composio.connect.needsFieldsSuffix': '좀 더 많은 정보가 필요합니다. 아래의 누락된 필드를 입력하고 다시 시도하세요.',
  'composio.connect.needsSubdomain': '연결하려면',
  'composio.connect.needsSubdomainSuffix': 'Atlassian 하위 도메인(예: acme.atlassian.net의 경우 acme)을 입력하고 다시 시도하세요.',
  ...
  'composio.connect.permissionsNoteSuffix': 'OpenHuman 자체 에이전트 권한은 아래에서 읽기, 쓰기, 관리자 토글로 제어됩니다.',
  ...
  'composio.connect.scope.writeHint': '에이전트가 이 연결을 통해 데이터를 생성하거나 수정할 수 있도록 허용합니다.',
  'composio.connect.scope.admin': '관리자',
  'composio.connect.scope.adminHint': '에이전트가 설정, 권한 또는 파괴적인 작업을 관리하도록 허용합니다.',
  'composio.connect.subdomainInvalid': '전체 URL이 아닌 짧은 하위 도메인만 입력하세요(예: "acme"). 문자, 숫자, 하이픈만 포함해야 합니다.',
  'composio.connect.subdomainRequired': '계속하려면 Atlassian 하위 도메인을 입력하세요.',
  'composio.connect.wabaIdHint': 'GET /me/businesses를 통해 찾은 다음 Meta 액세스 토큰을 사용하여 /{business_id}/owned_whatsapp_business_accounts를 GET하세요.',
  'composio.connect.wabaIdLabel': 'WABA ID 라벨',
  'composio.connect.wabaIdRequired': '계속하려면 WhatsApp Business Account ID (WABA ID)를 입력하세요.',
  ...
  'conversations.taskKanban.updateFailed': '작업을 업데이트할 수 없어 변경 사항이 저장되지 않았습니다.',
  ...
  'daemon.serviceBlockingGate.retryFailed': '다시 시도에 실패했습니다. 최신 앱 빌드를 다운로드하고 다시 시도하세요.',
  ...
  'intelligence.diagram.description': '구성된 다이어그램 엔드포인트에서 가져온 최신 로컬 아키텍처 출력입니다.',
  ...
  'intelligence.diagram.emptyDescription': '오케스트레이터에서 아키텍처 다이어그램을 생성하면 이 패널이 구성된 로컬 엔드포인트에서 새로 고침됩니다.',
  'intelligence.diagram.skillInstallCommand': 'npx skills add yizhiyanhua-ai/fireworks-tech-graph',
  'intelligence.diagram.promptExample': '현재 스웜의 아키텍처 다이어그램을 다크 터미널 스타일로 생성하세요',
  ...
  'oauth.button.loopbackTimeout': '로그인 시간 초과 — 브라우저가 OAuth 리디렉션을 완료하지 못했습니다. 다시 시도해 주세요.',
  ...
  'onboarding.contextGathering.coreAlive': 'Core에 접근 가능합니다. 처음 실행하는 데 1분 정도 걸릴 수 있습니다.',
  'onboarding.contextGathering.coreAliveProbing': '코어 연결 확인 중…',
  'onboarding.contextGathering.coreUnreachable': '코어가 응답하지 않습니다. 계속해서 나중에 다시 시도할 수 있습니다.',
  'onboarding.contextGathering.errorDesc': '채팅이 준비되었습니다. 전체 프로필은 백그라운드에서 계속 만들 예정이므로 지금 계속하고 나중에 점진적으로 개선할 수 있습니다.',
  'onboarding.contextGathering.stillWorkingDesc': '로컬 모델과 도구를 준비하는 동안 처음 실행하는 데 30~60초 정도 걸릴 수 있습니다. 언제든지 계속 채팅할 수 있습니다. 프로필 빌드는 백그라운드에서 계속 실행됩니다.',
  ...
  'pages.settings.account.migrationDesc': 'OpenClaw(또는 곧 Hermes)의 메모리와 메모를 이 작업 공간으로 마이그레이션합니다.',
  ...
  'pages.settings.account.recoveryPhraseDesc': '암호화 및 지갑 접근을 위한 BIP39 복구 문구를 관리합니다',
  ...
  'pages.settings.composioSection.description': 'Composio에서 제공하는 통합에 대한 라우팅, 트리거 및 기록입니다.',
  ...
  'pages.settings.features.desktopCompanionDesc': '화면 인식 기능이 있는 음성 도우미 — 듣고, 보고, 말하고, 가리킵니다.',
  ...
  'rewards.community.heroSubtitle': 'Discord 계정을 연결하여 독점 채널, 후원자 배지 및 백엔드 동기화 보상을 잠금 해제하세요.',
  ...
  'rewards.coupon.redeemAccepted': '{code}이(가) 승인되었습니다. 필요한 작업이 완료되면 {amount}이(가) 잠금 해제됩니다.',
  ...
  'settings.ai.openAiCompat.description': '로컬 하네스를 이 /v1 서버로 지정하면 아래에 구성된 제공업체를 통해 라우팅됩니다. 인증에는 앱 내부 코어 bearer가 아니라 여기에서 설정한 고정 키를 사용합니다.',
  ...
  'skills.mcpComingSoon.description': 'MCP 서버 관리가 곧 제공됩니다. 이 탭에서 MCP 서버 통합을 검색, 연결 및 모니터링할 수 있게 됩니다.',
  ...
  'settings.ai.localRuntimeHelper': '{label}에 연결할 수 있는 위치입니다. 기본값은 localhost입니다. 공유 인스턴스를 사용하려면 원격 호스트(예: http://10.0.0.4:11434/v1)를 가리키세요.',
  ...
  'settings.ai.or': '또는',
  'settings.ai.openRouterOauthDescription': 'OpenRouter로 로그인하고 PKCE를 사용해 사용자가 제어하는 API 키를 가져옵니다.',
  'settings.ai.connecting': '연결 중...',
  'settings.ai.backgroundLoops': '백그라운드 루프',
  'settings.ai.backgroundLoopsDesc': '채팅 메시지 없이 실행되는 항목을 확인하고, 하트비트 작업을 일시 중지하며, 최근 크레딧 원장 행을 검사합니다.',
  'settings.ai.heartbeatControls': '하트비트 제어',
  'settings.ai.heartbeatControlsDesc': '기본값은 꺼짐입니다. 활성화하면 루프가 시작되고 비활성화하면 실행 중인 작업이 중단됩니다.',
  ...
  'settings.ai.calendarMeetingChecksDesc': '활성 Google Calendar 연결의 캘린더 이벤트 목록을 호출합니다.',
  ...
  'settings.ai.cronReminderChecksDesc': '활성화된 크론 작업에서 알림에 가까운 예정 항목을 스캔합니다.',
  ...
  'settings.ai.externalDeliveryDesc': '하트비트 알림이 외부 채널로 선제적 메시지를 보낼 수 있게 합니다.',
  ...
  'settings.ai.plannerSummary': '플래너: {sourceEvents} 소스 이벤트, {sent} 전송, {deduped} 중복 제거.',
  'settings.ai.routeLabel': '경로: {route}',
  'settings.ai.on': '켜짐',
  'settings.ai.off': '꺼짐',
  'settings.ai.recentUsageLedger': '최근 사용량 원장',
  'settings.ai.recentUsageLedgerDesc': '백엔드 행은 오늘의 작업/시간을 표시합니다. 소스 태그에는 백엔드 지원이 필요합니다.',
  ...
  'settings.ai.temperatureOverrideDesc': '낮을수록 더 결정적입니다. 제공업체 기본값을 사용하려면 선택하지 않은 상태로 두세요.',
  ...
  'settings.ai.reindexingMemoryMessage': '임베딩을 다시 처리하는 중입니다. {pending}개의 메모리 항목이 현재 모델로 다시 임베딩되고 있습니다. 완료될 때까지 의미 기반 회상 성능이 줄어듭니다. 키워드 검색은 계속 작동하며, 이 창을 닫아도 재임베딩은 백그라운드에서 계속됩니다.',
  ...
  'settings.ai.routing.managedDesc': 'OpenHuman이 모든 추론을 클라우드에서 실행하고, 작업에 가장 적합한 모델을 선택하며, 비용을 최적화하고 가장 안전한 라우팅 기본값을 유지합니다.',
  'settings.ai.routing.managedMsg': 'OpenHuman이 모든 워크로드의 추론을 처리하고 비용, 품질, 보안을 고려해 최적의 경로를 자동으로 선택합니다.',
  'settings.ai.routing.useYourOwn': '자체 모델 사용',
  'settings.ai.routing.useYourOwnDesc': '제공업체와 모델 하나를 선택하고 모든 워크로드를 해당 경로로 라우팅합니다. 간단하지만 경량 추론과 대형 추론이 같은 경로를 공유하므로 비효율적일 수 있습니다.',
  'settings.ai.routing.advanced': '고급',
  'settings.ai.routing.advancedDesc': '작업별로 다른 모델을 선택합니다. 세밀한 비용 최적화와 최대 제어에 가장 적합한 옵션입니다.',
  'settings.ai.routing.customDesc': '세분화된 라우팅은 최고의 비용 최적화와 가장 많은 제어권을 제공합니다. 아래 행에서 관리형으로 유지할 워크로드, 공유 기본값을 사용할 워크로드, 특정 모델에 고정할 워크로드를 결정하세요.',
  'settings.ai.routing.chatAndConversations': '채팅 및 대화',
  'settings.ai.routing.chatDesc': '직접 사용자 상호작용, 답변, 추론, 에이전트 루프 및 코딩 도움에 사용되는 모델입니다.',
  'settings.ai.routing.backgroundTasks': '백그라운드 작업',
  'settings.ai.routing.bgTasksDesc': '요약, 하트비트, 학습 및 잠재의식 평가처럼 기본 대화 흐름 밖에서 사용되는 모델입니다.',
  'settings.ai.routing.addCustomProvider': '사용자 정의 공급자 추가',
  'settings.ai.globalModel.title': '모든 것에 대해 하나의 모델을 선택합니다.',
  'settings.ai.globalModel.desc': '모든 추론을 하나의 모델로 라우팅합니다. 더 간단하지만 경량 작업과 무거운 작업이 모두 같은 경로를 사용하므로 비용과 품질 면에서 비효율적일 수 있습니다.',
  'settings.ai.globalModel.noProviders': '먼저 제공업체를 추가하거나 연결하세요. 그런 다음 여기에서 모든 워크로드를 하나의 모델로 라우팅할 수 있습니다.',
  ...
  'settings.ai.globalModel.appliesToAll': '채팅, 추론, 코딩, 메모리, 하트비트, 학습 및 잠재의식에 동일한 제공업체와 모델을 적용합니다. 임베딩은 별도로 구성됩니다. 저장을 클릭하면 변경 사항이 저장됩니다.',
  ...
  'settings.autocomplete.completionStyle.acceptedCompletion': '수락된 완성 {count}개가 저장됨 — 향후 제안을 개인화하는 데 사용됩니다.',
  'settings.autocomplete.completionStyle.acceptedCompletions': '수락된 완성 {count}개가 저장됨 — 향후 제안을 개인화하는 데 사용됩니다.',
  ...
  'settings.autocomplete.completionStyle.noHistory': '아직 수락된 완성이 없습니다. Tab으로 제안을 수락하여 개인화를 시작하세요.',
  ...
  'settings.autocomplete.debug.disabledInSettings': '설정에서 자동완성이 비활성화되어 있습니다. 활성화하고 먼저 저장하십시오.',
  ...
  'settings.billing.inferenceBudget.noRecurringWeeklyDesc': '현재 플랜에는 반복 주간 추론 예산이 포함되어 있지 않습니다. 대신 사용 가능한 크레딧에서 사용량이 결제됩니다.',
  ...
  'settings.billing.inferenceBudget.exhaustedDesc': '구독에 포함된 사용량을 모두 소진했습니다. 다음 주기를 기다리지 않고 AI를 계속 사용하려면 크레딧을 충전하세요.',
  ...
  'settings.composio.confirmItem3': '참고: Composio 트리거(실시간 웹훅)는 아직 Direct 모드에서 실행되지 않습니다 — 동기식 도구 호출만 지원됩니다',
  ...
  'settings.composio.confirmWarning': '기존 통합(Gmail, Slack, GitHub 등 OpenHuman을 통해 연결된 통합)은 표시되지 않습니다 — OpenHuman 관리형 Composio 테넌트에 있습니다.',
  'settings.composio.intro': 'Composio는 에이전트가 호출할 수 있는 도구로 250개 이상의 외부 앱을 통합합니다. 이러한 도구 호출이 라우팅되는 방식을 선택하세요.',
  'settings.composio.title': 'Composio',
  'settings.composio.modeDirect': 'Direct(직접 API 키 사용)',
  'settings.composio.modeDirectDesc': '호출이 backend.composio.dev로 직접 이동합니다. 독립적이고 오프라인 친화적입니다. 도구 실행은 동기식으로 작동하지만, 실시간 트리거 웹훅은 아직 Direct 모드에서 라우팅되지 않습니다(후속 이슈).',
  'settings.composio.modeManaged': '관리형(OpenHuman이 대신 처리)',
  'settings.composio.modeManagedDesc': 'OpenHuman이 백엔드를 통해 도구 호출을 프록시합니다(권장). 인증은 중개되며, Composio API 키를 붙여넣을 필요가 없습니다. 웹훅은 완전히 라우팅됩니다.',
  ...
  'settings.localModel.deviceCapability.downloadingSetupDesc': 'OllamaSetup 설치 프로그램(~2GB)을 다운로드하고 압축을 푸는 중입니다. 첫 설치 시 시간이 걸릴 수 있습니다.',
  ...
  'settings.localModel.deviceCapability.installFailedDesc': 'Ollama를 사용할 수 있기 전에 설치 프로그램이 종료되었습니다. 다시 시도하려면 재시도를 클릭하거나 ollama.com에서 수동으로 설치하세요.',
  'settings.localModel.deviceCapability.installFirst': '먼저 Ollama를 실행하세요.',
  'settings.localModel.deviceCapability.installFirstDesc': '로컬 티어는 외부에서 관리되는 Ollama 엔드포인트에 의존합니다. 직접 시작하고 원하는 모델을 가져온 뒤, 런타임에 연결할 수 있을 때까지 "비활성화됨(클라우드 대체)"을 계속 사용하세요.',
  ...
  'settings.localModel.deviceCapability.localAiDisabled': '로컬 AI 비활성화됨 — 클라우드 대체 사용 중.',
  ...
  'settings.localModel.deviceCapability.presetDetails': '채팅: {chatModel} · 비전: {visionModel} · 대상 RAM: {targetRamGb}GB',
  ...
  'settings.localModel.download.promptPlaceholder': '아무 프롬프트나 입력하고 로컬 모델에서 실행하세요...',
  ...
  'settings.localModel.download.summaryHelper': 'Rust 코어를 통해 `openhuman.inference_summarize`를 호출합니다.',
  'settings.localModel.download.summarizePlaceholder': '로컬 모델로 요약할 텍스트를 붙여넣으세요...',
  ...
  'settings.localModel.download.visionImagePlaceholder': '줄마다 하나의 이미지 참조(data URI, URL 또는 로컬 경로 표시)',
  ...
  'settings.localModel.status.contextBelowMinimumBadge': '{contextLength} ctx - {required} min 미만',
  'settings.localModel.status.contextBelowMinimumTitle': '거부됨: 컨텍스트 창 {contextLength} 토큰이 메모리 계층에 필요한 {required} 토큰 최소값보다 낮습니다. 자동 잘림으로 인해 재현율이 손상될 수 있습니다.',
  'settings.localModel.status.contextOkBadge': '{contextLength} ctx ✓',
  'settings.localModel.status.contextOkTitle': '컨텍스트 창 {contextLength} 토큰은 메모리 계층 최소 {required} 토큰을 충족합니다.',
  'settings.localModel.status.contextUnknownBadge': 'ctx 알 수 없음',
  'settings.localModel.status.contextUnknownTitle': '컨텍스트 창을 알 수 없습니다. {required} 토큰 메모리 계층 최소값을 충족하는지 확인할 수 없습니다.',
  'settings.localModel.status.customLocation': '사용자 지정 위치',
  'settings.localModel.status.customLocationDesc': '사용자 지정 위치 설명',
  'settings.localModel.status.diagnosticsHint': '"진단 실행"을 클릭하여 Ollama가 실행 중이고 모델이 설치되어 있는지 확인하세요.',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc': 'OpenHuman은 이제 Ollama를 외부 추론 런타임으로 취급합니다. 직접 Ollama 서버를 시작하고 원하는 모델을 가져온 뒤 작업 라우팅을 해당 서버로 지정하세요.',
  ...
  'settings.developerMenu.messagingChannels.desc': 'Telegram/Discord 인증 모드 및 기본 채널 라우팅 구성',
  'settings.developerMenu.tools.title': '도구',
  'settings.developerMenu.tools.desc': 'OpenHuman이 사용자를 대신하여 사용할 수 있는 기능 활성화 또는 비활성화',
  ...
  'settings.developerMenu.devWorkflow.desc': 'GitHub 이슈를 선택하고 일정에 따라 PR을 여는 자율 에이전트',
  'settings.developerMenu.devWorkflow.panelDesc': '내게 할당된 GitHub 이슈를 선택하고 일정에 따라 pull request를 자동으로 여는 자율 개발자 에이전트를 구성하세요.',
  'settings.developerMenu.skillsRunner.title': '스킬 실행기',
  'settings.developerMenu.skillsRunner.desc': '번들 스킬을 즉석에서 실행합니다. 입력을 채우고 백그라운드 자율 실행을 시작하세요.',
  'settings.developerMenu.skillsRunner.panelDesc': '번들 스킬을 선택하고 선언된 입력을 채운 뒤, 기다릴 필요 없는 백그라운드 실행을 시작하세요. cron 예약 반복 작업이 필요하면 대신 개발 워크플로를 사용하세요.',
  ...
  'settings.skillsRunner.schedule.help': '이 스킬과 입력을 반복 cron 작업으로 저장합니다. 에이전트는 각 tick마다 run_skill을 호출합니다.',
  ...
  'settings.skillsRunner.repoPicker.empty': '반환된 리포지토리가 없습니다. 이 목록을 채우려면 Composio를 통해 GitHub을 연결하세요.',
  'settings.skillsRunner.repoPicker.notConnected': 'GitHub이 Composio를 통해 연결되어 있지 않습니다. 먼저 스킬 → Composio에서 연결하세요.',
  ...
  'settings.devWorkflow.notForkNote': '포크가 아닙니다. PR은 이 리포지토리를 직접 대상으로 열립니다.',
  ...
  'settings.devWorkflow.runningStatus': '에이전트가 실행 중입니다 — 이슈를 선택하고 수정 작업을 진행하는 중...',
  'settings.devWorkflow.errorNotConnected': 'GitHub이 연결되어 있지 않습니다. 먼저 설정 > 고급 > Composio에서 GitHub을 연결하세요.',
  'settings.devWorkflow.errorToolNotEnabled': '이 백엔드에서 GITHUB_LIST_REPOSITORIES_FOR_THE_AUTHENTICATED_USER 도구가 활성화되어 있지 않습니다. 관리자에게 Composio 통합에서 활성화해 달라고 요청하세요(backend#842).',
  ...
  'settings.developerMenu.eventLog.desc': '모든 에이전트, 도구, 시스템 이벤트를 색상으로 구분해 실시간으로 표시합니다.',
  ...
  'settings.developerMenu.notificationRouting.desc': '통합 경고에 대한 AI 중요도 점수 및 오케스트레이터 에스컬레이션',
  ...
  'settings.developerMenu.composioRouting.desc': '자신만의 Composio API 키를 가져와 호출을 backend.composio.dev로 직접 라우팅하세요.',
  'settings.developerMenu.integrationTriggers.title': '통합 트리거',
  'settings.developerMenu.integrationTriggers.desc': 'Composio 통합 트리거에 대한 AI 분류 설정 구성',
  ...
  'settings.mcpServer.toolsSectionDesc': '도구 노출 openhuman-core mcp 실행 시 MCP stdio 서버를 통해',
  'settings.mcpServer.configSectionTitle': '클라이언트 구성',
  'settings.mcpServer.configSectionDesc': '올바른 구성 조각을 생성하려면 MCP 클라이언트를 선택하세요.',
  'settings.mcpServer.copySnippet': '클립보드에 복사',
  'settings.mcpServer.copied': '복사되었습니다!',
  'settings.mcpServer.openConfigFile': '구성 파일 열기',
  'settings.mcpServer.binaryPathNotFound': 'OpenHuman 바이너리를 찾을 수 없습니다. 소스에서 실행하는 경우 다음을 사용하여 빌드하세요: cargo build --bin openhuman-core',
  ...
  'settings.agentAccess.menuDesc': '에이전트가 읽고 쓸 수 있는 위치와 shell 사용 가능 여부를 제어합니다.',
  ...
  'settings.agentAccess.tier.readonly.desc': '탐색을 위해 파일을 읽고 읽기 전용 명령을 실행하지만, 쓰기, 편집 또는 상태를 변경하는 작업은 절대 실행하지 않습니다.',
  'settings.agentAccess.tier.supervised.title': '편집 전 확인',
  'settings.agentAccess.tier.supervised.desc': '새 파일은 자유롭게 만들 수 있지만 기존 파일 편집, 명령 실행, 네트워크 접근 또는 설치 전에는 승인을 요청합니다.',
  'settings.agentAccess.tier.full.title': '전체 접근',
  'settings.agentAccess.tier.full.desc': '사용자 계정의 전체 접근 권한으로 명령을 실행합니다. 자격 증명 및 시스템 저장소를 제외하고 허용된 모든 위치를 읽고 쓸 수 있습니다. 파괴적 명령, 네트워크 접근, 설치는 계속 승인을 요청합니다.',
  'settings.agentAccess.defaultTag': '(기본값)',
  'settings.agentAccess.fullWarning': '⚠ 전체 접근은 사용자 계정의 전체 접근 권한으로 명령을 실행하며 샌드박스가 적용되지 않습니다. 이 컴퓨터에서 에이전트를 신뢰할 때만 활성화하세요. 자격 증명 및 시스템 디렉터리는 계속 차단되며, 파괴적 작업, 네트워크 작업, 설치 작업은 계속 승인을 요청합니다.',
  'settings.agentAccess.confine.label': '작업공간으로 제한',
  'settings.agentAccess.confine.desc': '선택한 접근 모드와 관계없이 에이전트를 작업공간 디렉터리와 허용된 폴더로 제한합니다. 끄면 항상 차단되는 자격 증명 및 시스템 디렉터리를 제외하고 사용자가 접근할 수 있는 모든 위치에 접근할 수 있습니다.',
  'settings.agentAccess.requireTaskPlanApproval.label': '작업 계획 승인 필요',
  'settings.agentAccess.requireTaskPlanApproval.desc': '할당된 에이전트가 에이전트가 작성한 작업 브리프를 실행하기 전에 일시 중지합니다.',
  'settings.agentAccess.grantedFolders': '허용된 폴더',
  'settings.agentAccess.alwaysAllow': '항상 허용된 도구',
  'settings.agentAccess.alwaysAllowDesc': '채팅에서 "항상 허용"으로 표시한 도구는 확인 없이 실행됩니다. 다시 확인을 받으려면 항목을 제거하세요.',
  'settings.agentAccess.alwaysAllowNone': '아직 항상 허용된 도구가 없습니다.',
  'settings.agentAccess.grantedDesc': '작업공간 외에 에이전트가 읽고 쓸 수 있는 폴더입니다. 자격 증명 저장소(~/.ssh, ~/.gnupg, ~/.aws, keychains)와 시스템 디렉터리(/etc, /System, C:\\Windows, …)는 허용된 폴더 안에 있어도 항상 차단됩니다.',
  ...
  'settings.appearance.helperText': '다크 모드는 전체 앱 — 채팅, 설정, 패널 — 을 어두운 팔레트로 전환합니다. "시스템과 일치"는 OS 외관을 따르며 실시간으로 업데이트됩니다.',
  'settings.appearance.tabBarHeading': '하단 탭 표시줄',
  'settings.appearance.tabBarAlwaysShowLabels': '항상 레이블 표시',
  'settings.appearance.tabBarAlwaysShowLabelsDesc': '끄면 레이블은 마우스를 가져가거나 활성 탭에 대해서만 표시됩니다.',
  'settings.mascot.active': '활성',
  'settings.mascot.characterDesc': '캐릭터 설명',
  'settings.mascot.characterHeading': '캐릭터 제목',
  'settings.mascot.customGifError': 'HTTPS .gif URL, loopback HTTP .gif URL, file:// .gif URL 또는 로컬 .gif 경로를 입력하세요.',
  ...
  'settings.mascot.voice.customDesc': 'api.elevenlabs.io/v1/voices 또는 ElevenLabs 대시보드에서 음성 ID를 찾으세요. ID만 저장되며 API 키는 백엔드에 유지됩니다.',
  ...
  'settings.mascot.voice.desc': '마스코트가 음성 응답에 사용할 ElevenLabs 음성을 선택하세요. 성별로 필터링하고, 선별된 목록에서 선택하거나, 사용자 지정 ID를 붙여넣거나, 앱이 인터페이스 언어에 맞는 음성을 선택하도록 할 수 있습니다.',
  ...
  'settings.mascot.voice.previewText': '안녕하세요, 저는 당신의 어시스턴트입니다. 음성 미리듣기입니다.',
  ...
  'settings.mascot.voice.useLocaleDefaultDesc': '현재 인터페이스 언어에 맞는 음성을 자동으로 선택합니다.',
  'settings.persona.title': '페르소나',
  'settings.persona.menuTitle': '페르소나',
  'settings.persona.menuDesc': '이름, 성격, 아바타, 음성을 하나의 어시스턴트 정체성으로 관리합니다.',
  'settings.persona.identityHeading': '정체성',
  'settings.persona.identityDesc': '어시스턴트의 표시 이름과 짧은 설명입니다. 앱에 표시되며 어시스턴트의 추론 방식은 바꾸지 않습니다.',
  ...
  'settings.persona.soul.desc': '어시스턴트가 모든 대화에서 따르는 성격 프롬프트입니다. 편집 내용은 작업공간에 저장되며 다음 응답부터 적용됩니다.',
  ...
  'settings.persona.appearanceDesc': '마스코트 색상, 사용자 지정 GIF 아바타, 응답 음성은 마스코트 설정에서 구성합니다.',
  'settings.persona.openMascotSettings': '마스코트 설정 열기',
  'settings.memoryWindow.balanced.badge': '추천',
  'settings.memoryWindow.balanced.hint': '합리적인 기본값 — 매번 추가 토큰을 많이 쓰지 않으면서 좋은 연속성을 제공합니다.',
  'settings.memoryWindow.balanced.label': '균형',
  'settings.memoryWindow.description': 'OpenHuman이 새 에이전트 실행마다 주입하는 기억된 컨텍스트의 양입니다. 창이 클수록 과거 대화를 더 잘 인식하지만, 매 실행마다 더 많은 토큰을 사용하고 비용도 더 듭니다.',
  'settings.memoryWindow.extended.badge': '더 많은 컨텍스트',
  'settings.memoryWindow.extended.hint': '각 실행에 더 많은 장기 메모리를 주입합니다. 턴당 토큰 비용이 더 높습니다.',
  'settings.memoryWindow.extended.label': '확장',
  'settings.memoryWindow.maximum.badge': '가장 높은 비용',
  'settings.memoryWindow.maximum.hint': '가장 큰 안전 창입니다. 최고의 연속성을 제공하지만 매 실행마다 토큰 비용이 의미 있게 증가합니다.',
  'settings.memoryWindow.maximum.label': '최대',
  'settings.memoryWindow.minimal.badge': '가장 저렴함',
  'settings.memoryWindow.minimal.hint': '가장 작은 메모리 창입니다. 가장 저렴하고 빠르지만 실행 간 연속성이 가장 낮습니다.',
  ...
  'skills.create.inputs.help': '스킬에 필요한 매개변수를 선언하세요. Skills Runner가 런타임에 이에 대한 양식을 렌더링합니다.',
  'skills.create.inputs.add': '입력 추가',
  'skills.create.inputs.row.name': '입력 이름',
  'skills.create.inputs.row.namePlaceholder': '예: repo',
  'skills.create.inputs.row.nameError': '영문자, 숫자, 밑줄, 대시만 사용 가능하며 영문자로 시작해야 합니다.',
  ...
  'skills.create.scopeUserHint': '~/.openhuman/skills/<slug>/SKILL.md에 작성됨 — 모든 워크스페이스에서 사용 가능.',
  ...
  'skills.install.errors.alreadyInstalledHint': '이 슬러그와 관련된 스킬이 이미 작업공간에 존재합니다. 먼저 제거하거나 `metadata.id` / `name` 머리말을 변경하세요.',
  'skills.install.errors.alreadyInstalledTitle': '스킬이 이미 설치되어 있습니다.',
  'skills.install.errors.fetchFailedHint': '요청이 성공적으로 완료되지 않았습니다. 연결 가능한 공용 파일에서 URL 지점을 확인하고 호스트가 2xx 응답을 반환했는지 확인하세요.',
  'skills.install.errors.fetchFailedTitle': '가져오기 실패',
  'skills.install.errors.fetchTimedOutHint': '원격 호스트가 제때 응답하지 않았습니다. 다시 시도하거나 제한 시간을 늘리세요(1~600초).',
  'skills.install.errors.fetchTimedOutTitle': '가져오기 시간이 초과되었습니다.',
  'skills.install.errors.fetchTooLargeHint': 'SKILL.md는 1MiB 미만이어야 합니다. 번들 리소스를 인라인하는 대신 `references/` 또는 `scripts/` 파일로 분할하세요.',
  'skills.install.errors.fetchTooLargeTitle': 'SKILL.md가 너무 큽니다.',
  'skills.install.errors.genericHint': '백엔드에서 오류를 반환했습니다. 원시 메시지는 아래와 같습니다.',
  'skills.install.errors.genericTitle': '기술을 설치할 수 없습니다.',
  'skills.install.errors.invalidSkillHint': '머리말은 비어 있지 않은 `이름` 및 `설명` 필드가 있고 `---`로 끝나는 유효한 YAML이어야 합니다.',
  'skills.install.errors.invalidSkillTitle': 'SKILL.md가 구문 분석되지 않았습니다.',
  'skills.install.errors.invalidUrlHint': '공개 HTTPS URL만 허용됩니다. 개인, 루프백 및 메타데이터 호스트가 차단됩니다.',
  'skills.install.errors.invalidUrlTitle': 'URL 거부됨',
  'skills.install.errors.unsupportedUrlHint': '직접 `.md` 링크만 작동합니다. GitHub의 경우 파일 링크(github.com/owner/repo/blob/.../SKILL.md) - 트리 및 repo 루트는 설치되지 않습니다.',
  'skills.install.errors.unsupportedUrlTitle': 'URL 형식이 지원되지 않습니다.',
  'skills.install.errors.writeFailedHint': '작업공간 기술 디렉터리에 쓸 수 없습니다. `<workspace>/.openhuman/skills/`에 대한 파일 시스템 권한을 확인하세요.',
  ...
  'skills.install.successNoNewIds': '스킬이 설치되었지만 새 스킬 ID가 나타나지 않았습니다. 카탈로그에 이미 동일한 슬러그가 있는 스킬이 포함되어 있을 수 있습니다.',
  ...
  'skills.meetingBots.bannerDesc': 'Google Meet 링크를 넣으면 OpenHuman이 게스트로 참여하여 말하고, 듣고, 반응합니다.',
  ...
  'skills.meetingBots.modalDesc': 'OpenHuman이 익명 게스트로 참여하여 비디오를 통화에 스트리밍하고 에이전트를 통해 응답합니다.',
  ...
  'skills.setup.screenIntel.deniedHint': '시스템 설정에서 권한을 허용한 후 아래를 클릭하여 다시 시작하고 변경 사항을 적용하세요.',
  ...
  'skills.setup.voice.sttNotReadyDesc': '음성 인텔리전스에는 전사용 로컬 Whisper 모델이 필요합니다. 로컬 모델 설정에서 다운로드하세요.',
  ...
  'skills.uninstall.description': '이 작업은 스킬 디렉터리와 모든 번들 리소스를 영구적으로 삭제합니다. 에이전트는 다음 턴부터 이를 더 이상 볼 수 없습니다.',
  ...
  'upsell.global.nearLimitMessage': '사용 한도의 {pct}%를 사용했습니다. 더 높은 한도를 위해 업그레이드하세요.',
  'upsell.global.nearLimitTitle': '사용 한도에 가까워지고 있습니다',
  'upsell.usageLimit.bodyBudget': '주간 한도에 도달했습니다.{reset} 한도를 피하려면 플랜을 업그레이드하거나 크레딧을 충전하세요.',
  'upsell.usageLimit.bodyRate': '10시간 추론 속도 한도에 도달했습니다.{reset} 더 높은 한도를 위해 업그레이드하세요.',
  ...
  'settings.localModel.status.manageOllamaExternal': 'OpenHuman 외부에서 Ollama 프로세스와 모델 가져오기를 관리한 다음 진단을 다시 실행하세요.',
  'settings.localModel.status.ollamaDocs': 'Ollama 문서',
  'settings.localModel.status.thenRetry': '설정 지침을 확인한 다음 런타임에 연결할 수 있게 되면 다시 시도하세요.',
  ...
  'devOptions.menuToolsDesc': 'OpenHuman이(가) 사용자를 대신하여 사용할 수 있는 기능 활성화 또는 비활성화',
  ...
  'devOptions.menuNotificationRoutingDesc': '통합 경고에 대한 AI 중요도 점수 및 오케스트레이터 에스컬레이션',
  ...
  'devOptions.menuComposioRoutingDesc': '자체 Composio API 키를 가져와 호출을 backend.composio.dev로 직접 라우팅',
  ...
  'walletBalances.errorGeneric': '지갑 잔액을 불러올 수 없습니다. 복구 문구에서 지갑을 설정하고 다시 시도하세요.',
  'settings.taskSources.title': '작업 소스',
  'settings.taskSources.subtitle': '도구의 작업을 에이전트 할 일 보드로 가져옵니다',
  'settings.taskSources.description': 'GitHub, Notion, Linear, ClickUp에서 작업 항목을 수집하고 보강한 뒤 에이전트 할 일 보드로 라우팅합니다.',
  'settings.taskSources.connectHint': '작업 소스는 연결된 계정을 사용합니다. 먼저 통합에서 계정을 연결하세요.',
  'settings.taskSources.disabledBanner': '설정에서 작업 소스가 비활성화되어 있습니다. 자동으로 폴링하려면 활성화하세요.',
  ...
  'settings.taskSources.removeConfirm': '이 작업 소스를 제거하시겠습니까? 수집된 모든 작업 기록이 삭제되며 되돌릴 수 없습니다.',
  ...
  'skills.dashboard.emptyBody': '번들 스킬을 한 번 실행하거나 반복 일정을 저장하면 여기에 표시됩니다.',
  ...
  'skills.new.placeholderBody': '편집 양식이 곧 제공됩니다. 지금은 러너 페이지의 "새 스킬" 버튼을 사용하세요.',
  'settings.agents.title': '에이전트',
  'settings.agents.subtitle': '위임에 사용할 수 있는 에이전트를 관리하세요. 기본 제공 에이전트와 직접 만든 사용자 지정 에이전트를 포함합니다.',
  ...
  'settings.agents.editor.toolsHint': '한 줄에 도구 이름을 하나씩 입력하세요. 모든 도구에는 *를 사용하세요.',
  'settings.agents.editor.defaultsNote': '기본 제공 에이전트를 편집하면 나중에 재설정할 수 있는 재정의로 저장됩니다.',
  ...
  'settings.agentsSection.description': '에이전트와 그 자율성, 그리고 이 컴퓨터에서 액세스할 수 있는 항목을 관리하세요.',
  ...
  'settings.agents.editor.toolsAllowAllHint': '이 에이전트는 사용 가능한 모든 도구를 사용할 수 있습니다.',
  ...
  'settings.agents.editor.builtInReadonly': '기본 제공 에이전트는 편집할 수 없습니다. 에이전트 목록에서 활성화, 비활성화 또는 초기화할 수 있습니다.',
};
