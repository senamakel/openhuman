...
//!
//! Every handler reaches the module-backed [`MemoryToolMemory`](crate::memory::api::provider::MemoryToolMemory)
//! API through [`MemoryGuard`](crate::memory::guard::MemoryGuard),
...
async fn tool_memory_guard() -> Result<Arc<crate::memory::guard::MemoryGuard>, String> {
