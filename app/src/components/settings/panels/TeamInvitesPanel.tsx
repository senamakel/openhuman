        ...
        <div className="p-4 space-y-4">
          ...
          {isLoadingInvites && invites.length === 0 ? (
                ...
                return (
                  <div
                    ...
                    className={`rounded-xl border p-3 ${
                      isInactive
                        ? 'border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 opacity-60'
                        : 'border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900'
                    }`}>
                      ...
                      <div className="flex items-center gap-2">
                        <code
                          className={`text-sm font-mono px-2 py-1 rounded-lg ${
                            isInactive
                              ? 'text-stone-500 dark:text-neutral-400 dark:text-neutral-400 bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800'
                              : 'text-stone-900 dark:text-neutral-100 dark:text-neutral-100 bg-stone-200 dark:bg-neutral-800 dark:bg-neutral-800'
                          }`}>
                          {invite.code}
                        </code>
                        {status === 'expired' && (
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-lg transition-colors ${
                            status === 'active'
                              ? 'text-stone-500 dark:text-neutral-400 dark:text-neutral-400 hover:text-stone-900 dark:hover:text-neutral-100 dark:text-neutral-100 dark:hover:text-neutral-100 dark:text-neutral-100 hover:bg-stone-100 dark:hover:bg-neutral-800 dark:bg-neutral-800 dark:hover:bg-neutral-800 dark:bg-neutral-800'
                              : 'text-stone-600 dark:text-neutral-300 dark:text-neutral-300 cursor-not-allowed'
                          }`}
                        ...
                        {isAdmin && status === 'active' && (
                          <button
                            ...
                            className="p-1.5 rounded-lg text-stone-500 dark:text-neutral-400 dark:text-neutral-400 hover:text-coral-400 hover:bg-coral-500/10 transition-colors disabled:opacity-50"
                    ...
                    <div className="flex items-center gap-3 text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400">
                      <span>
            ...
            <div className="text-center py-8">
              <svg
                className="w-10 h-10 mx-auto text-stone-600 dark:text-neutral-300 dark:text-neutral-300 mb-3"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24">
                <path
                ...
                <div className="space-y-4">
                  <div className="text-sm text-stone-400 dark:text-neutral-500 dark:text-neutral-500">
                    <p>
                      ...
                      <code className="text-stone-900 dark:text-neutral-100 dark:text-neutral-100 bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800 px-1.5 py-0.5 rounded font-mono text-xs">
                        {inviteToRevoke.code}
                      </code>
                      ?
                    </p>
