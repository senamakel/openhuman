...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.denied.next': "Rien à faire — elle n'a pas été exécutée. Redemandez si vous changez d'avis.",
  'conversations.toolFailure.approvalExpired.cause': "La demande d'approbation a expiré avant que quiconque réponde.",
  'conversations.toolFailure.approvalExpired.next': "Redemandez pour l'exécuter — OpenHuman ne réessaiera pas tout seul.",
