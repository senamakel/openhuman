...
const messages: TranslationMap = {
  ...
  'subconscious.scratchpadInfo': 'Podświadomość utrzymuje trwały notatnik obserwacji między cyklami. Sprawdź Ustawienia → Dostęp agenta, aby skonfigurować tryb i częstotliwość.',
