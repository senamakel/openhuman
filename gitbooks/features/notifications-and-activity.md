...
Triage assigns each notification an **action**, which maps to a fixed 0.0–1.0 importance score:
...
| `importance_threshold` | Minimum score (0.0–1.0) to display; `0.0` shows everything                  |
