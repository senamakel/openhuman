...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'কাউন্সিল',
  'modelCouncil.title': 'মডেল কাউন্সিল',
  'modelCouncil.intro':
    'একটি প্রশ্ন করুন, একাধিক মডেল থেকে সমান্তরালে স্বাধীন উত্তর নিন, তারপর একজন চেয়ার কোথায় তারা একমত, কোথায় দ্বিমত, এবং কে কী আলাদা যোগ করেছে তা সংশ্লেষ করে।',
  'modelCouncil.listTitle': 'কাউন্সিল',
  'modelCouncil.listIntro':
    'একটি সংরক্ষিত কাউন্সিল বেছে নিন, তার এজেন্ট ও বিচারক সম্পাদনা করুন, অথবা নির্দিষ্ট ধরনের সিদ্ধান্তের জন্য নতুন কাউন্সিল তৈরি করুন।',
  'modelCouncil.addCouncil': 'নতুন কাউন্সিল',
  'modelCouncil.openCouncil': 'কাউন্সিল খুলুন',
  'modelCouncil.editCouncil': 'কাউন্সিল সম্পাদনা করুন',
  'modelCouncil.editCurrentCouncil': 'বর্তমান কাউন্সিল সম্পাদনা করুন',
  'modelCouncil.editCouncilAria': '{name} সম্পাদনা করুন',
  'modelCouncil.deleteCouncilAria': '{name} মুছুন',
  'modelCouncil.backToCouncils': 'কাউন্সিলে ফিরে যান',
  'modelCouncil.saveCouncil': 'কাউন্সিল সংরক্ষণ করুন',
  'modelCouncil.savingCouncil': 'সংরক্ষণ হচ্ছে…',
  'modelCouncil.cancelEdit': 'বাতিল',
  'modelCouncil.loadingCouncils': 'কাউন্সিল লোড হচ্ছে…',
  'modelCouncil.noCouncils': 'এখনও কোনো কাউন্সিল নেই। শুরু করতে একটি যোগ করুন।',
  'modelCouncil.noCouncilDescription': 'কোনো বিবরণ নেই',
  'modelCouncil.registryErrorPrefix': 'কাউন্সিল রেজিস্ট্রি ব্যর্থ:',
  'modelCouncil.councilNameLabel': 'কাউন্সিলের নাম',
  'modelCouncil.councilDescriptionLabel': 'বিবরণ',
  'modelCouncil.councilDescriptionPlaceholder': 'এই কাউন্সিল কখন ব্যবহার করবেন',
  'modelCouncil.selectModel': 'নির্বাচন',
  'modelCouncil.modelPickerHelp': 'রাউটিং ইঙ্গিত বেছে নিন বা নির্দিষ্ট প্রোভাইডার মডেল পিন করুন।',
  'modelCouncil.closeModelPicker': 'বন্ধ',
  'modelCouncil.modelPickerHints': 'ইঙ্গিত',
  'modelCouncil.modelPickerProviderModel': 'প্রোভাইডার + মডেল',
  'modelCouncil.modelProviderLabel': 'মডেল প্রোভাইডার',
  'modelCouncil.modelIdLabel': 'মডেল আইডি',
  'modelCouncil.useProviderModel': 'প্রোভাইডার মডেল ব্যবহার করুন',
  'modelCouncil.questionLabel': 'প্রশ্ন',
  'modelCouncil.questionPlaceholder': 'কাউন্সিলকে একটি প্রশ্ন করুন…',
  'modelCouncil.membersLabel': 'সদস্য মডেল',
  'modelCouncil.maxMembersNote': '{max} পর্যন্ত',
  ...
  'modelCouncil.modelHint.default': 'ডিফল্ট',
  'modelCouncil.modelHint.chat': 'চ্যাট',
  'modelCouncil.modelHint.reasoning': 'যুক্তি',
  'modelCouncil.modelHint.code': 'কোড',
  'modelCouncil.modelHint.summarize': 'সারাংশ',
  'modelCouncil.defaultSeat.analyst.name': 'বিশ্লেষক',
  'modelCouncil.defaultSeat.analyst.brief': 'প্রমাণ, অনুমান এবং ঝুঁকি।',
  'modelCouncil.defaultSeat.builder.name': 'নির্মাতা',
  'modelCouncil.defaultSeat.builder.brief': 'বাস্তবায়নের ব্যবহারিক পথ।',
  'modelCouncil.defaultSeat.skeptic.name': 'সন্দেহকারী',
  'modelCouncil.defaultSeat.skeptic.brief': 'ব্যর্থতার ধরন এবং অনুপস্থিত প্রসঙ্গ।',
  'modelCouncil.defaultCouncilName': 'নতুন কাউন্সিল',
  'modelCouncil.defaultJudgeName': 'প্রধান বিচারক',
  'modelCouncil.untitledCouncilName': 'শিরোনামহীন কাউন্সিল',
  ...
  'modelCouncil.debateRoundsLabel': 'বিতর্কের পালা',
  'modelCouncil.debateRoundsHelp':
    'বিচারক চূড়ান্ত সংশ্লেষ লেখার আগে প্রতিটি জুরার একাধিক পালা ধরে বিতর্ক চালিয়ে যায়।',
  ...
  'modelCouncil.rosterHelp':
    'প্রতিটি জুরার ডিফল্ট এজেন্ট নিতে পারে, সংরক্ষিত প্রোফাইল ব্যবহার করতে পারে, অথবা এই রানের জন্য কাস্টম প্রোফাইল হতে পারে।',
  'modelCouncil.loadingProfiles': 'প্রোফাইল লোড হচ্ছে…',
  'modelCouncil.jurorLabel': 'জুরার {n}',
  ...
  'modelCouncil.memberProfileAria': 'জুরার {n} প্রোফাইল',
  'modelCouncil.memberNameAria': 'জুরার {n} নাম',
  'modelCouncil.memberNamePlaceholder': 'এজেন্টের নাম',
  'modelCouncil.profileModelPlaceholder': 'প্রোফাইল মডেল ওভাররাইড করুন',
  'modelCouncil.memberBriefAria': 'জুরার {n} ব্রিফ',
  'modelCouncil.memberBriefPlaceholder': 'এই জুরারের দৃষ্টিভঙ্গি',
  'modelCouncil.jurorFallback': 'জুরার',
  ...
  'modelCouncil.liveScratchpadHelp':
    'প্রতিটি রাউন্ডের পর জুরার আপডেট এখানে যোগ হয়, তারপর পরের রাউন্ডে পাঠানো হয়।',
  'modelCouncil.liveScratchpadBadge': 'লাইভ',
  'modelCouncil.scratchpadRoundHeading': 'রাউন্ড {round} আপডেট',
  'modelCouncil.scratchpadNoResponse': 'কোনো উত্তর নেই',
  'modelCouncil.chairLabel': 'চেয়ার মডেল',
  'modelCouncil.chairPlaceholder': 'যেমন claude-opus-4-8',
  'modelCouncil.chairHelp': 'চেয়ার প্রতিটি সদস্যের উত্তর পড়ে সংশ্লেষ লেখে।',
  'modelCouncil.run': 'কাউন্সিল আহ্বান করুন',
  'modelCouncil.running': 'কাউন্সিল আহ্বান হচ্ছে…',
  'modelCouncil.runningHint': 'সদস্যদের সমান্তরালে জিজ্ঞাসা করা হচ্ছে, তারপর সংশ্লেষ করা হচ্ছে…',
  'modelCouncil.deliberationHeading': 'কাউন্সিল আলোচনা',
  'modelCouncil.deliberationHelp':
    'শেয়ার করা reasoning ফাইল ব্যবহারের সময় মাসকটগুলো প্রতিটি এজেন্টকে ভাবতে দেখায়।',
  'modelCouncil.debateRoundInstruction':
    'এ পর্যন্ত অন্য জুরাররা যা বলেছে তার জবাব দিন। মতবিরোধ ধরে রাখুন, প্রয়োজন হলে নিজের মত সংশোধন করুন, এবং বর্তমান উপসংহার স্পষ্ট রাখুন।',
  'modelCouncil.debateFinalInstruction':
    'এটি আপনার শেষ জুরার পালা। প্রমাণ যেখানে সমর্থন করে সেখানে একমত হন, বাকি মতবিরোধ উল্লেখ করুন, এবং বিচারককে পরিষ্কার উপসংহার দিন।',
  'modelCouncil.roundLabel': 'রাউন্ড {round}',
  'modelCouncil.currentRoundThinking': 'পরের পালা চালিয়ে যাচ্ছে…',
  'modelCouncil.thinkingBadge': 'ভাবছে',
  'modelCouncil.thinkingWithBrief': 'এই দৃষ্টিভঙ্গি থেকে কাজ করছে: {brief}',
  'modelCouncil.thought.evidence':
    'প্রমাণ, অনুমান, এবং শেয়ার করা reasoning ফাইলে আগে থেকেই যা আছে তা যাচাই করছে।',
  'modelCouncil.thought.plan': 'ব্যবহারিক পথ এবং কোথায় বাস্তবায়ন আটকে যেতে পারে তা আঁকছে।',
  'modelCouncil.thought.risk': 'ব্যর্থতার ধরন, অনুপস্থিত প্রসঙ্গ, এবং দুর্বল উপসংহার খুঁজছে।',
  'modelCouncil.thought.tradeoffs':
    'বিচারককে সংক্ষিপ্ত অবস্থান দেওয়ার আগে বিনিময়গুলো তুলনা করছে।',
  'modelCouncil.thought.synthesis':
    'বিচারক যেন প্রকৃত মতবিরোধ তুলনা করতে পারে, সে জন্য আলাদা দৃষ্টিভঙ্গি প্রস্তুত করছে।',
  'modelCouncil.judgeWaitingBadge': 'বিচারক',
  'modelCouncil.judgeWaitingThought':
    'জুরারদের উত্তরের জন্য অপেক্ষা করছে, তারপর সংশ্লেষ করতে শেয়ার করা reasoning ফাইল পড়ছে।',
  'modelCouncil.judgeSynthesizingBadge': 'সংশ্লেষ করছে',
  'modelCouncil.judgeSynthesizingThought': 'লাইভ জুরার ভাবনা পড়ে চূড়ান্ত কাউন্সিল সংশ্লেষ লিখছে।',
  'modelCouncil.errorPrefix': 'কাউন্সিল ব্যর্থ:',
  'modelCouncil.resultsHeading': 'কাউন্সিল ফলাফল',
  'modelCouncil.memberAnswered': 'উত্তর দিয়েছে',
  'modelCouncil.memberFailed': 'ব্যর্থ',
  'modelCouncil.synthesisHeading': 'সংশ্লেষ',
  'modelCouncil.synthesisBy': '{model} দ্বারা',
  'modelCouncil.usageHeading': 'বিতর্ক ব্যবহার',
  'modelCouncil.usageEstimated':
    'কাউন্সিল RPC-তে প্রোভাইডার ব্যবহার যুক্ত না হওয়া পর্যন্ত বিতর্ক প্রম্পট ও উত্তরের ভিত্তিতে অনুমান।',
  'modelCouncil.usageEstimatedBadge': 'আনুমানিক টোকেন',
  'modelCouncil.usageInputTokens': 'ইনপুট',
  'modelCouncil.usageOutputTokens': 'আউটপুট',
  'modelCouncil.usageTotalTokens': 'মোট',
