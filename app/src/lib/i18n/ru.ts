...
const messages: TranslationMap = {
  ...
  'flows.promptBar.heroSubtitle': 'Скажите конструктору, что автоматизировать, и просмотрите его предложение.',
  ...
  'flows.copilot.subtitle': 'Запрашивайте изменения и проверяйте каждое предложение перед применением.',
  ...
  'flows.copilot.emptyState': 'Опишите изменение этого процесса, и конструктор предложит обновление.',
  ...
  'flows.import.error': 'Не удалось импортировать этот рабочий процесс. Проверьте файл и попробуйте снова.',
