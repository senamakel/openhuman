...
const messages: TranslationMap = {
  ...
  'settings.theme.autoForkHint': 'Modificando un preset le tue modifiche vengono salvate automaticamente come nuovo tema personalizzato.',
  'settings.theme.title': 'Studio Temi',
  'settings.theme.menuDesc': 'Personalizza completamente colori e caratteri, oppure scegli un tema predefinito.',
  'settings.theme.presetsHeading': 'Temi',
  'settings.theme.builtInBadge': 'Predefinito',
  'settings.theme.customBadge': 'Personalizzato',
  'settings.theme.customizeHint': 'I temi predefiniti sono di sola lettura. Duplica questo tema per modificarne colori e caratteri.',
  ...
  'settings.theme.contrastWarn': 'Contrasto ridotto tra testo e sfondo — questo tema potrebbe risultare difficile da leggere.',
  ...
  'settings.theme.importHint': 'Incolla il JSON di un tema esportato per aggiungerlo come tema personalizzato.',
