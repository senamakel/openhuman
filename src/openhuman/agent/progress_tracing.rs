...
//! and token/cost figures. Tool arguments, streamed text/thinking deltas, raw
//! error strings, and filesystem paths are **never** recorded, honoring the
//! project's "never log secrets or full PII" rule. The content-bearing
//! [`AgentProgress`] variants (`TextDelta`, `ThinkingDelta`,
