...
//! [`crate::agent::bus::mock_agent_run_turn`]) compose on top of
...
/// [`crate::agent::bus::use_real_agent_handler`] that need the
...
/// conveniences (e.g.
/// [`crate::agent::bus::mock_agent_run_turn`]) should compose
