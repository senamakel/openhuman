...
const id4: TranslationMap = {
  ...
  'conversations.toolTimeline.turn':
    'giliran ${subagent.childIteration}/${subagent.childMaxIterations}',
  ...
  'intelligence.memoryChunk.scoreBars.ariaScore':
    '${sig.name} skor ${(pct * 100).toFixed(0)} persen',
  ...
  'settings.autocomplete.completionStyle.acceptedCompletion':
    '${String(historyEntries.length)} pelengkapan yang diterima disimpan — digunakan untuk mempersonalisasi saran mendatang.',
