...
const fr3: TranslationMap = {
  ...
  'app.connectionIndicator.reconnecting': 'Reconnexion en cours',
  ...
  'app.openhumanLink.notifications.sent': 'Envoyé',
  ...
  'app.routeLoading.initializing': 'Initialisation',
  ...
  'app.update.progress.downloaded': '${formatBytes(downloaded)} téléchargés',
  ...
  'channels.discord.picker.serverChannelSelection': 'Sélection du canal du serveur',
