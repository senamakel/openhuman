...
// Bahasa Indonesia chunk 4/5. Translated from chunks/en-4.ts.
const id4: TranslationMap = {
  'chat.unsubscribeApproval.approve': 'Memproses...',
  'chat.unsubscribeApproval.approved': 'Disetujui',
  ...
  'chat.unsubscribeApproval.title': 'Judul',
  ...
  'commandPalette.shortcutHint': 'Petunjuk pintasan',
  ...
  'composio.connect.connectionFailed': 'Koneksi gagal (status: ${hit.status}).',
  ...
  'composio.connect.permissionsNote': 'Catatan izin',
  'composio.connect.permissionsNoteSuffix': 'Akhiran catatan izin',
  ...
  'composio.connect.subdomainInvalid': 'Subdomain tidak valid',
  ...
  'composio.triggers.loadError': 'Tidak dapat memuat pemicu: {msg}',
  ...
  'conversations.toolTimeline.turn': 'giliran ${subagent.childIteration}/${subagent.childMaxIterations}',
  ...
  'daemon.serviceBlockingGate.downloadLatest': 'Unduh terbaru',
  'daemon.serviceBlockingGate.retryCore': 'Mencoba ulang...',
  ...
  'home.banners.earlyBirdFirstSub': 'Sub pertama early bird',
  'home.banners.earlyBirdOn': 'Early bird aktif',
  'home.banners.earlyBirdTitle': 'Judul early bird',
  ...
  'intelligence.memoryChunk.detail.embeddingInfo': 'Info embedding',
  ...
  'intelligence.memoryChunk.mentioned.chunkOne': 'Satu chunk',
  'intelligence.memoryChunk.mentioned.chunkOther': 'Beberapa chunk',
  'intelligence.memoryChunk.mentioned.heading': 'd i s e b u t k a n',
  'intelligence.memoryChunk.scoreBars.ariaScore': '${sig.name} skor ${(pct * 100).toFixed(0)} persen',
  'intelligence.memoryChunk.scoreBars.atThreshold': 'Di ambang batas',
  'intelligence.memoryChunk.scoreBars.dropped': 'Dihapus',
  'intelligence.memoryChunk.scoreBars.heading': 'm e n g a p a &nbsp; d i s i m p a n',
  'intelligence.memoryChunk.scoreBars.kept': 'Disimpan',
  'intelligence.memoryText.entityTypePrefix': 'Jenis entitas: ${seg.value}',
  ...
  'intelligence.screenDebug.captureFailed': 'Tangkapan gagal',
  'intelligence.screenDebug.captureSuccess': 'Tangkapan berhasil',
  ...
  'intelligence.tasks.activeBoardOne': 'Satu papan aktif',
  ...
  'notifications.card.importanceTitle': 'Kepentingan: ${(n.importance_score * 100).toFixed(0)}%',
  ...
  'onboarding.contextGathering.errorDesc': 'Deskripsi error',
  ...
  'rewards.community.achievementsUnlocked': 'Pencapaian terbuka',
  ...
  'rewards.community.discordMember': 'Anggota Discord',
  ...
  'rewards.community.joinDiscord': 'Bergabung ke Discord',
  ...
  'rewards.coupon.noCodes': 'Tidak ada kode',
  ...
  'rewards.coupon.redeemAccepted': 'Penukaran diterima',
  'rewards.coupon.redeemButton': 'Menukarkan...',
  'rewards.coupon.redeemSuccess': 'Penukaran berhasil',
  'rewards.coupon.redeemedCodes': 'Kode yang ditukarkan',
  'rewards.coupon.redeeming': 'Menukarkan...',
  'rewards.coupon.statusApplied': 'Status diterapkan',
  'rewards.coupon.statusPendingAction': 'Status menunggu tindakan',
  'rewards.coupon.statusRedeemed': 'Status ditukarkan',
  ...
  'settings.autocomplete.completionStyle.acceptedCompletion': '${String(historyEntries.length)} pelengkapan yang diterima disimpan — digunakan untuk mempersonalisasi saran mendatang.',
  'settings.autocomplete.completionStyle.acceptedCompletions': '${String(historyEntries.length)} pelengkapan yang diterima disimpan — digunakan untuk mempersonalisasi saran mendatang.',
