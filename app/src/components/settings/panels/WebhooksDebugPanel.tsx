      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          <button
            ...
            disabled={loading}
            className="rounded-lg border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 px-3 py-1.5 font-medium text-stone-700 dark:text-neutral-200 dark:text-neutral-200 hover:bg-stone-100 dark:hover:bg-neutral-800 dark:bg-neutral-800 dark:hover:bg-neutral-800 dark:bg-neutral-800 disabled:opacity-50">
            ...
            <div className="space-y-2">
              {registrations.map(registration => (
                <div
                  ...
                  className="rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 p-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex gap-1 text-[10px]">
                      <span className="rounded-full bg-stone-200 dark:bg-neutral-800 dark:bg-neutral-800 px-2 py-0.5 text-stone-600 dark:text-neutral-300 dark:text-neutral-300">
                  ...
                  <div className="mt-1 text-[11px] text-stone-500 dark:text-neutral-400 dark:text-neutral-400 font-mono break-all">
                    {backendUrl
        ...
        <section className="space-y-2">
          ...
          {logs.length === 0 ? (
            ...
            <div className="space-y-2">
                ...
                <button
                  ...
                  className={`w-full rounded-xl border p-3 text-left transition-colors ${
                    selectedLog?.correlation_id === entry.correlation_id
                      ...
                      : 'border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 hover:bg-stone-100 dark:hover:bg-neutral-800 dark:bg-neutral-800 dark:hover:bg-neutral-800 dark:bg-neutral-800'
                  }`}>
              ...
              {selectedLog && (
                <div className="rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 p-3 space-y-3">
                  <div>
                    <div className="text-xs font-semibold text-stone-900 dark:text-neutral-100 dark:text-neutral-100">
                      {selectedLog.method} {selectedLog.path}
                    </div>
                    <div className="text-[10px] text-stone-400 dark:text-neutral-500 dark:text-neutral-500 font-mono">
