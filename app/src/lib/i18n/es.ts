...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'Observación de solo lectura cada 30 minutos. Solo acceso a memoria y archivos.',
  'subconscious.mode.aggressive.title': 'Agresivo',
  'subconscious.mode.aggressive.desc': 'Acceso completo a herramientas cada 5 minutos. Puede escribir, crear agentes y delegar tareas.',
