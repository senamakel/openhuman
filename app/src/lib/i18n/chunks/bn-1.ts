...
const bn1: TranslationMap = {
  ...
  'settings.search.localManagedUnavailable':
    'এক্স.qx1x স্থানীয় ব্যবহারকারীদের জন্য অনুসন্ধান উপলব্ধ নয়। আপনার নিজের xqxqx; xqx3x, বা কিউরিএক্সএক্সএক্সএক্সএক্সxx, অথবা ওয়েব অনুসন্ধানের জন্য সক্রিয় করুন।',
