        ...
        <div className="p-4 space-y-4">
          ...
          <div className="rounded-xl border border-stone-200 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100">{team.name}</h3>
          ...
          <div className="space-y-1">
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-3 rounded-xl border border-stone-200 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 hover:bg-stone-100 dark:hover:bg-neutral-800 dark:bg-neutral-800 transition-all text-left">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-sm text-stone-900 dark:text-neutral-100">Members</div>
                  <p className="text-xs text-stone-500 dark:text-neutral-400">Manage team members and roles</p>
                </div>
              </div>
              <svg
            ...
            <button
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-sm text-stone-900 dark:text-neutral-100">Invites</div>
                  <p className="text-xs text-stone-500 dark:text-neutral-400">Generate and manage invite codes</p>
                </div>
              </div>
              <svg
                className="w-4 h-4 text-stone-500 dark:text-neutral-400"
            ...
            <button
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-sm text-stone-900 dark:text-neutral-100">Team Settings</div>
                  <p className="text-xs text-stone-500 dark:text-neutral-400">Edit team name and settings</p>
                </div>
              </div>
              <svg
                className="w-4 h-4 text-stone-500 dark:text-neutral-400"
              ...
              <button
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-500 dark:text-neutral-400">Permanently delete this team</p>
                  </div>
                </div>
                <svg
          ...
          {isEditModalOpen && (
            <div className="fixed inset-0 bg-stone-900/40 flex items-center justify-center z-50 p-4">
              <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 w-full max-w-md border border-stone-200 dark:border-neutral-800">
                <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 mb-4">Edit Team Settings</h3>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm bg-stone-50 dark:bg-neutral-800/60 border border-stone-200 dark:border-neutral-800 rounded-xl text-stone-900 dark:text-neutral-100 placeholder-stone-400 focus:outline-none focus:border-primary-500/50"
          ...
          {isDeleteModalOpen && (
            <div className="fixed inset-0 bg-stone-900/40 flex items-center justify-center z-50 p-4">
              <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 w-full max-w-md border border-stone-200 dark:border-neutral-800">
                <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 mb-4">Delete Team</h3>
                ...
                <div className="space-y-4">
                  <div className="text-sm text-stone-400 dark:text-neutral-500">
                    <p>
                      ...
                      <strong className="text-stone-900 dark:text-neutral-100">{teamEntry?.team.name}</strong>?
                    </p>
