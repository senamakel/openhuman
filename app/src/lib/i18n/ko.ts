...
const messages: TranslationMap = {
  ...
  'memory.tab.council': '협의회',
  'modelCouncil.title': '모델 협의회',
  'modelCouncil.intro':
    '하나의 질문을 던지고 여러 모델의 독립 답변을 병렬로 받은 뒤, 의장이 어디에 동의하고 어디에 이견이 있으며 각 모델이 무엇을 더했는지 종합합니다.',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro':
    '저장된 협의회를 선택하거나 에이전트와 판사를 편집하거나 특정 결정 유형에 맞는 새 협의회를 만드세요.',
  'modelCouncil.addCouncil': '새 협의회',
  'modelCouncil.openCouncil': '협의회 열기',
  'modelCouncil.editCouncil': '협의회 편집',
  'modelCouncil.editCurrentCouncil': '현재 협의회 편집',
  'modelCouncil.editCouncilAria': '{name} 편집',
  'modelCouncil.deleteCouncilAria': '{name} 삭제',
  'modelCouncil.backToCouncils': '협의회로 돌아가기',
  'modelCouncil.saveCouncil': '협의회 저장',
  'modelCouncil.savingCouncil': '저장 중…',
  'modelCouncil.cancelEdit': '취소',
  'modelCouncil.loadingCouncils': '협의회 로드 중…',
  'modelCouncil.noCouncils': '아직 협의회가 없습니다. 하나 추가해 시작하세요.',
  'modelCouncil.noCouncilDescription': '설명 없음',
  'modelCouncil.registryErrorPrefix': '협의회 레지스트리 실패:',
  'modelCouncil.councilNameLabel': '협의회 이름',
  'modelCouncil.councilDescriptionLabel': '설명',
  'modelCouncil.councilDescriptionPlaceholder': '이 협의회를 사용할 때',
  'modelCouncil.selectModel': '선택',
  'modelCouncil.modelPickerHelp': '라우팅 힌트를 선택하거나 정확한 제공자 모델을 고정하세요.',
  'modelCouncil.closeModelPicker': '닫기',
  'modelCouncil.modelPickerHints': '힌트',
  'modelCouncil.modelPickerProviderModel': '제공자 + 모델',
  'modelCouncil.modelProviderLabel': '모델 제공자',
  'modelCouncil.modelIdLabel': '모델 ID',
  'modelCouncil.useProviderModel': '제공자 모델 사용',
  'modelCouncil.questionLabel': '질문',
  'modelCouncil.questionPlaceholder': '협의회에 질문하기…',
  'modelCouncil.membersLabel': '멤버 모델',
  'modelCouncil.maxMembersNote': '최대 {max}',
  'modelCouncil.memberPlaceholder': '예: gpt-5.2',
  'modelCouncil.memberAria': '멤버 모델 {n}',
  'modelCouncil.removeMemberAria': '멤버 모델 {n} 제거',
  'modelCouncil.addMember': '+ 모델 추가',
  'modelCouncil.modelHint.default': '기본',
  'modelCouncil.modelHint.chat': '채팅',
  'modelCouncil.modelHint.reasoning': '추론',
  'modelCouncil.modelHint.code': '코드',
  'modelCouncil.modelHint.summarize': '요약',
  'modelCouncil.defaultSeat.analyst.name': '분석가',
  'modelCouncil.defaultSeat.analyst.brief': '근거, 가정, 위험.',
  'modelCouncil.defaultSeat.builder.name': '빌더',
  'modelCouncil.defaultSeat.builder.brief': '실용적인 구현 경로.',
  'modelCouncil.defaultSeat.skeptic.name': '회의론자',
  'modelCouncil.defaultSeat.skeptic.brief': '실패 모드와 누락된 맥락.',
  'modelCouncil.defaultCouncilName': '새 협의회',
  'modelCouncil.defaultJudgeName': '수석 판사',
  'modelCouncil.untitledCouncilName': '제목 없는 협의회',
  'modelCouncil.settingsTitle': '위원회 설정',
  'modelCouncil.settingsSummary': '배심원 {count}명 · 판사: {judge}',
  'modelCouncil.juryCountLabel': '배심원 수',
  'modelCouncil.debateRoundsLabel': '토론 차례',
  'modelCouncil.debateRoundsHelp':
    '판사가 최종 종합을 작성하기 전에 각 배심원이 여러 차례 토론을 이어갑니다.',
  ...
  'modelCouncil.liveScratchpadHelp':
    '각 라운드 후 배심원 업데이트가 여기에 추가되고 다음 라운드에 반영됩니다.',
  'modelCouncil.liveScratchpadBadge': '라이브',
  ...
  'modelCouncil.chairHelp': '의장은 모든 멤버 답변을 읽고 종합을 작성합니다.',
  'modelCouncil.run': '협의회 소집',
  'modelCouncil.running': '소집 중…',
  'modelCouncil.runningHint': '멤버에게 병렬로 묻고, 이후 종합 중…',
  'modelCouncil.deliberationHeading': '협의회 숙의',
  'modelCouncil.deliberationHelp':
    '공유 추론 파일이 사용되는 동안 마스코트가 각 에이전트의 사고를 보여줍니다.',
  'modelCouncil.debateRoundInstruction':
    '지금까지의 다른 배심원에게 응답하세요. 이견을 보존하고, 필요하면 관점을 수정하며, 현재 결론을 명확히 유지하세요.',
  'modelCouncil.debateFinalInstruction':
    '이것은 마지막 배심원 차례입니다. 근거가 지지하는 곳에서는 수렴하고, 남은 이견을 밝히며, 판사에게 명확한 결론을 전달하세요.',
  'modelCouncil.roundLabel': '라운드 {round}',
  'modelCouncil.currentRoundThinking': '다음 차례 계속 중…',
  'modelCouncil.thinkingBadge': '생각 중',
  'modelCouncil.thinkingWithBrief': '이 관점에서 작업 중: {brief}',
  'modelCouncil.thought.evidence':
    '근거, 가정, 공유 추론 파일에 이미 담긴 내용을 확인하는 중입니다.',
  'modelCouncil.thought.plan': '실용적인 경로와 실행이 막힐 수 있는 지점을 그리는 중입니다.',
  'modelCouncil.thought.risk': '실패 모드, 빠진 맥락, 취약한 결론을 찾는 중입니다.',
  'modelCouncil.thought.tradeoffs':
    '판사에게 간결한 입장을 전달하기 전에 절충점을 비교하는 중입니다.',
  'modelCouncil.thought.synthesis':
    '판사가 실제 이견을 비교할 수 있도록 distinct한 관점을 준비하는 중입니다.',
  'modelCouncil.judgeWaitingBadge': '판사',
  'modelCouncil.judgeWaitingThought': '배심원 답변을 기다린 뒤 공유 추론 파일을 읽어 종합합니다.',
  'modelCouncil.judgeSynthesizingBadge': '종합 중',
  'modelCouncil.judgeSynthesizingThought':
    '실시간 배심원 생각을 읽고 최종 협의회 종합을 작성하는 중입니다.',
  'modelCouncil.errorPrefix': '협의회 실패:',
  'modelCouncil.resultsHeading': '협의회 결과',
  'modelCouncil.memberAnswered': '응답함',
  'modelCouncil.memberFailed': '실패',
  'modelCouncil.synthesisHeading': '종합',
  'modelCouncil.synthesisBy': '{model} 제공',
  'modelCouncil.usageHeading': '토론 사용량',
  'modelCouncil.usageEstimated':
    '제공자 사용량이 협의회 RPC에 연결될 때까지 토론 프롬프트와 응답으로 추정합니다.',
  'modelCouncil.usageEstimatedBadge': '예상 토큰',
  'modelCouncil.usageInputTokens': '입력',
  'modelCouncil.usageOutputTokens': '출력',
  'modelCouncil.usageTotalTokens': '합계',
