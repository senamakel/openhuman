...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.denied.next': 'Nada a fazer — ela não foi executada. Peça novamente se mudar de ideia.',
  'conversations.toolFailure.approvalExpired.cause': 'A solicitação de aprovação expirou antes que alguém respondesse.',
  'conversations.toolFailure.approvalExpired.next': 'Peça novamente para executá-la — o OpenHuman não tentará de novo sozinho.',
