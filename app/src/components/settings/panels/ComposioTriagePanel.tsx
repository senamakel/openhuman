  ...
  return (
    <div>
      ...
      <div className="p-4 space-y-5">
        ...
        <div className="rounded-2xl border border-stone-200 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60/60 p-4 space-y-1">
          <button
            type="button"
            role="switch"
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-stone-500 dark:text-neutral-400 mt-0.5">{t('composio.triggersStillRecorded')}</p>
            </div>
            <div
        ...
        <div className={`space-y-2 ${triageDisabled ? 'opacity-40 pointer-events-none' : ''}`}>
          <label className="block text-sm font-medium text-stone-800 dark:text-neutral-100" htmlFor="disabled-toolkits">
          ...
          <input
            ...
            className="w-full rounded-xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-3 py-2 text-sm text-stone-900 dark:text-neutral-100 placeholder-stone-400 focus:border-primary-400 focus:outline-none focus:ring-1 focus:ring-primary-400 disabled:cursor-not-allowed"
          />
        </div>
