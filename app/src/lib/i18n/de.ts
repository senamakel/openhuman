...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'Rat',
  'modelCouncil.title': 'Modellrat',
  'modelCouncil.intro':
    'Stelle eine Frage, erhalte unabhängige Antworten von mehreren Modellen parallel, und lasse den Vorsitz zusammenfassen, wo sie übereinstimmen, wo sie abweichen und was jedes einzigartig beiträgt.',
  'modelCouncil.listTitle': 'Räte',
  'modelCouncil.listIntro':
    'Wähle einen gespeicherten Rat, bearbeite seine Agenten und den Richter oder erstelle einen neuen Rat für eine bestimmte Entscheidungsart.',
  ...
  'modelCouncil.savingCouncil': 'Speichern…',
  'modelCouncil.cancelEdit': 'Abbrechen',
  'modelCouncil.loadingCouncils': 'Räte werden geladen…',
  'modelCouncil.noCouncils': 'Noch keine Räte. Füge einen hinzu, um zu beginnen.',
  'modelCouncil.noCouncilDescription': 'Keine Beschreibung',
  'modelCouncil.registryErrorPrefix': 'Ratsregister fehlgeschlagen:',
  'modelCouncil.councilNameLabel': 'Name des Rats',
  'modelCouncil.councilDescriptionLabel': 'Beschreibung',
  'modelCouncil.councilDescriptionPlaceholder': 'Wann dieser Rat verwendet werden soll',
  'modelCouncil.selectModel': 'Auswählen',
  'modelCouncil.modelPickerHelp':
    'Wähle einen Routing-Hinweis oder pinne ein genaues Provider-Modell.',
  'modelCouncil.closeModelPicker': 'Schließen',
  'modelCouncil.modelPickerHints': 'Hinweise',
  'modelCouncil.modelPickerProviderModel': 'Provider + Modell',
  'modelCouncil.modelProviderLabel': 'Modell-Provider',
  'modelCouncil.modelIdLabel': 'Modell-ID',
  'modelCouncil.useProviderModel': 'Provider-Modell verwenden',
  'modelCouncil.questionLabel': 'Frage',
  'modelCouncil.questionPlaceholder': 'Stelle dem Rat eine Frage…',
  ...
  'modelCouncil.modelHint.default': 'Standard',
  'modelCouncil.modelHint.chat': 'Chat',
  'modelCouncil.modelHint.reasoning': 'Reasoning',
  'modelCouncil.modelHint.code': 'Code',
  'modelCouncil.modelHint.summarize': 'Zusammenfassen',
  'modelCouncil.defaultSeat.analyst.name': 'Analyst',
  'modelCouncil.defaultSeat.analyst.brief': 'Evidenz, Annahmen und Risiken.',
  'modelCouncil.defaultSeat.builder.name': 'Builder',
  'modelCouncil.defaultSeat.builder.brief': 'Praktischer Umsetzungspfad.',
  'modelCouncil.defaultSeat.skeptic.name': 'Skeptiker',
  'modelCouncil.defaultSeat.skeptic.brief': 'Fehlermodi und fehlender Kontext.',
  'modelCouncil.defaultCouncilName': 'Neuer Rat',
  'modelCouncil.defaultJudgeName': 'Vorsitzender Richter',
  'modelCouncil.untitledCouncilName': 'Unbenannter Rat',
  ...
  'modelCouncil.debateRoundsHelp':
    'Jeder Juror debattiert über mehrere Runden weiter, bevor der Richter die finale Synthese schreibt.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Juror-Aktualisierungen werden nach jeder Runde hier angehängt und dann in die nächste Runde eingespeist.',
  'modelCouncil.liveScratchpadBadge': 'Live',
  'modelCouncil.scratchpadRoundHeading': 'Aktualisierungen Runde {round}',
  'modelCouncil.scratchpadNoResponse': 'Keine Antwort',
  'modelCouncil.chairLabel': 'Vorsitzmodell',
  'modelCouncil.chairPlaceholder': 'z. B. claude-opus-4-8',
  'modelCouncil.chairHelp': 'Der Vorsitz liest jede Mitgliederantwort und schreibt die Synthese.',
  'modelCouncil.run': 'Rat einberufen',
  'modelCouncil.running': 'Rat wird einberufen…',
  'modelCouncil.runningHint': 'Mitglieder werden parallel abgefragt, danach wird synthetisiert…',
  'modelCouncil.deliberationHeading': 'Beratung des Rats',
  'modelCouncil.deliberationHelp':
    'Maskottchen zeigen jeden Agenten beim Denken, während die gemeinsame Reasoning-Datei genutzt wird.',
  'modelCouncil.debateRoundInstruction':
    'Antworte auf die bisherigen Juroren. Bewahre Meinungsverschiedenheiten, überarbeite deine Sicht, wenn es angebracht ist, und halte dein aktuelles Fazit klar.',
  'modelCouncil.debateFinalInstruction':
    'Dies ist deine letzte Jurorenrunde. Konvergiere dort, wo die Evidenz es stützt, benenne verbleibende Uneinigkeit und gib dem Richter ein klares Fazit.',
  'modelCouncil.roundLabel': 'Runde {round}',
  'modelCouncil.currentRoundThinking': 'Setzt die nächste Runde fort…',
  'modelCouncil.thinkingBadge': 'Denkt',
  'modelCouncil.thinkingWithBrief': 'Arbeitet aus dieser Perspektive: {brief}',
  'modelCouncil.thought.evidence':
    'Prüft Evidenz, Annahmen und was die gemeinsame Reasoning-Datei bereits erfasst.',
  'modelCouncil.thought.plan':
    'Skizziert den praktischen Pfad und wo die Umsetzung stecken bleiben könnte.',
  'modelCouncil.thought.risk':
    'Sucht nach Fehlermodi, fehlendem Kontext und fragilen Schlussfolgerungen.',
  'modelCouncil.thought.tradeoffs':
    'Vergleicht Abwägungen, bevor dem Richter eine knappe Position übergeben wird.',
  'modelCouncil.thought.synthesis':
    'Bereitet eine eigenständige Sicht vor, damit der Richter echte Uneinigkeit vergleichen kann.',
  'modelCouncil.judgeWaitingBadge': 'Richter',
  'modelCouncil.judgeWaitingThought':
    'Wartet auf Jurorantworten und liest dann die gemeinsame Reasoning-Datei zur Synthese.',
  'modelCouncil.judgeSynthesizingBadge': 'Synthetisiert',
  'modelCouncil.judgeSynthesizingThought':
    'Liest die Live-Gedanken der Juroren und schreibt die finale Ratssynthese.',
  'modelCouncil.errorPrefix': 'Rat fehlgeschlagen:',
  'modelCouncil.resultsHeading': 'Ratsergebnisse',
  'modelCouncil.memberAnswered': 'Beantwortet',
  'modelCouncil.memberFailed': 'Fehlgeschlagen',
  'modelCouncil.synthesisHeading': 'Synthese',
  'modelCouncil.synthesisBy': 'von {model}',
  'modelCouncil.usageHeading': 'Debattennutzung',
  'modelCouncil.usageEstimated':
    'Geschätzt aus Debattenprompts und Antworten, bis Provider-Nutzung an den Rats-RPC angebunden ist.',
  'modelCouncil.usageEstimatedBadge': 'Geschätzte Tokens',
  'modelCouncil.usageInputTokens': 'Eingabe',
  'modelCouncil.usageOutputTokens': 'Ausgabe',
  'modelCouncil.usageTotalTokens': 'Gesamt',
