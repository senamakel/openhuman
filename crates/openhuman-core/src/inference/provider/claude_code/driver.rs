...
use crate::util::text::utf8_safe_prefix_at_byte_boundary;
...
use crate::inference::provider::types::{ChatResponse, ProviderDelta};
...
pub async fn run_turn(ctx: TurnContext<'_>) -> anyhow::Result<ChatResponse> {
    ...
    match crate::mcp::server::ensure_local_http().await {
