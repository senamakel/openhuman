    ...
    <div className="z-10 relative">
      ...
      <div className="max-w-2xl mx-auto w-full p-4 space-y-4">
        ...
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 p-4 space-y-3">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 dark:text-neutral-100">Runtime</h3>
          <div className="text-sm text-stone-700 dark:text-neutral-200 dark:text-neutral-200 space-y-1">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={isLoading}
              className="rounded-lg border border-stone-300 dark:border-neutral-700 dark:border-neutral-700 bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800 px-3 py-2 text-sm text-stone-700 dark:text-neutral-200 dark:text-neutral-200 disabled:opacity-50">
        ...
        {/* ------------------------------------------------------------------ */}
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 p-4 space-y-3">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 dark:text-neutral-100">Test</h3>
          <div className="space-y-1">
            <div className="text-xs text-stone-600 dark:text-neutral-300 dark:text-neutral-300">Context Override (optional)</div>
            <textarea
          ...
          {focusDebug && (
            <pre className="max-h-48 overflow-auto rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 p-2 text-xs text-stone-700 dark:text-neutral-200 dark:text-neutral-200">
              {focusDebug}
            </pre>
          )}
        </section>
        ...
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 p-4 space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 dark:text-neutral-100">Live Logs</h3>
            <button
              type="button"
              onClick={clearLogs}
              className="rounded-lg border border-stone-300 dark:border-neutral-700 dark:border-neutral-700 bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800 px-3 py-1.5 text-xs text-stone-700 dark:text-neutral-200 dark:text-neutral-200">
              Clear
            </button>
          </div>
          <pre className="max-h-56 overflow-auto rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 p-2 text-xs text-stone-700 dark:text-neutral-200 dark:text-neutral-200">
        ...
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 p-4 space-y-3">
          ...
          <label className="flex items-center justify-between rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 px-3 py-2">
            <span className="text-sm text-stone-700 dark:text-neutral-200 dark:text-neutral-200">Debounce Ms</span>
            <input
              type="number"
              min={50}
              max={2000}
              ...
              className="w-28 rounded border border-stone-300 dark:border-neutral-700 dark:border-neutral-700 bg-white dark:bg-neutral-900 dark:bg-neutral-900 px-2 py-1 text-xs text-stone-700 dark:text-neutral-200 dark:text-neutral-200"
            />
          </label>
          <label className="flex items-center justify-between rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 px-3 py-2">
            <span className="text-sm text-stone-700 dark:text-neutral-200 dark:text-neutral-200">Max Characters</span>
            <input
              type="number"
              min={32}
              max={1200}
          ...
          <label className="flex items-center justify-between rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 px-3 py-2">
            <span className="text-sm text-stone-700 dark:text-neutral-200 dark:text-neutral-200">Overlay TTL Ms</span>
            <input
              type="number"
              min={300}
              max={10000}
          ...
          <div className="space-y-1">
            <div className="text-xs text-stone-600 dark:text-neutral-300 dark:text-neutral-300">Style Instructions</div>
            <textarea
          ...
          <div className="space-y-1">
            <div className="text-xs text-stone-600 dark:text-neutral-300 dark:text-neutral-300">Style Examples (one per line)</div>
            <textarea
        ...
        <section className="rounded-2xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-white dark:bg-neutral-900 dark:bg-neutral-900 p-4 space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 dark:text-neutral-100">Personalization History</h3>
            <button
              type="button"
          ...
          {historyEntries.length > 0 && (
            <div className="max-h-48 overflow-y-auto rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 p-2 space-y-1">
              {historyEntries.map((entry, idx) => (
                <div
                  key={`${String(entry.timestamp_ms)}-${String(idx)}`}
                  className="flex flex-col gap-0.5 rounded-lg bg-white dark:bg-neutral-900 dark:bg-neutral-900 px-2 py-1.5 text-xs border border-stone-100 dark:border-neutral-800 dark:border-neutral-800">
                  <div className="flex items-center gap-2 text-stone-500 dark:text-neutral-400 dark:text-neutral-400">
                    <span className="shrink-0">
                      {new Date(entry.timestamp_ms).toLocaleString()}
                    </span>
                    {entry.app_name && (
                      <span className="rounded bg-stone-100 dark:bg-neutral-800 dark:bg-neutral-800 px-1 text-stone-600 dark:text-neutral-300 dark:text-neutral-300">
                        {entry.app_name}
                      </span>
                    )}
                  </div>
                  <div className="flex items-baseline gap-1 text-stone-700 dark:text-neutral-200 dark:text-neutral-200 truncate">
                    <span className="shrink-0 text-stone-400 dark:text-neutral-500 dark:text-neutral-500">…</span>
                    <span className="truncate text-stone-500 dark:text-neutral-400 dark:text-neutral-400">{entry.context.slice(-40)}</span>
                    <span className="shrink-0 text-stone-400 dark:text-neutral-500 dark:text-neutral-500">→</span>
