...
const messages: TranslationMap = {
  ...
  'onboarding.welcome.heroTitle': '你的工作与生活 AI 中枢',
  'onboarding.welcome.heroSubtitle':
    'OpenHuman 连接你的工具，自动化你的任务，并交付结果 — 一切都在你的桌面上完成。',
  'onboarding.welcome.inputTitle': '连接',
  'onboarding.welcome.inputDesc': '关联你的工具、账户和服务。一切汇聚于一处。',
  'onboarding.welcome.hubTitle': '自动化',
  'onboarding.welcome.hubDesc': '你的助手在你互联的世界中工作 — 管理、组织和执行。',
  'onboarding.welcome.outputTitle': '交付',
  'onboarding.welcome.outputDesc': '在你需要的地方获取摘要、已完成的任务和洞察。',
  'onboarding.welcome.capability1Title': '管理工作',
  'onboarding.welcome.capability1Desc':
    '让你的助手处理邮件、安排会议，并在所有工具中跟踪项目进度。',
  'onboarding.welcome.capability2Title': '自动化一切',
  'onboarding.welcome.capability2Desc': '设置自动运行的例行任务 — 晨间简报、每日摘要和定期任务。',
  'onboarding.welcome.capability3Title': '保持私密',
  'onboarding.welcome.capability3Desc': '你的数据留在你的设备上。你控制什么离开以及去向何处。',
