        ...
        <div className="p-4 space-y-4">
          ...
          {isLoadingMembers && members.length === 0 ? (
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-3 text-sm text-stone-500 dark:text-neutral-400">Loading members...</span>
            </div>
          ) : (
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {isCurrentUser(member) && (
                          <span className="text-[10px] text-stone-500 dark:text-neutral-400">(You)</span>
                        )}
                      </div>
                      {member.user.username && (
                        <p className="text-xs text-stone-500 dark:text-neutral-400 truncate">@{member.user.username}</p>
                      )}
                    </div>
                  </div>
          ...
          {memberToRemove && (
            <div className="fixed inset-0 bg-stone-900/50 flex items-center justify-center z-50 p-4">
              <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 w-full max-w-md border border-stone-200 dark:border-neutral-800">
                <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 mb-4">Remove Team Member</h3>
                ...
                <div className="space-y-4">
                  <div className="text-sm text-stone-400 dark:text-neutral-500">
                    <p>
                      ...
                      <strong className="text-stone-900 dark:text-neutral-100">{displayName(memberToRemove)}</strong> from
                      the team?
                    </p>
          ...
          {roleChangeConfirmation && (
            <div className="fixed inset-0 bg-stone-900/50 flex items-center justify-center z-50 p-4">
              <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 w-full max-w-md border border-stone-200 dark:border-neutral-800">
                <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 mb-4">Change Member Role</h3>
