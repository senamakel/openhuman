...
//! |---|---|---|
//! | `crate::medulla` (here) | OpenHuman as a Medulla **client** | outbound HTTP/SSE to the backend |
//! | `crate::platform::socket::medulla` | OpenHuman as a Medulla **worker** | inbound Socket.IO from a remote operator |
//!
