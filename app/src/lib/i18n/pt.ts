...
const messages: TranslationMap = {
  ...
  'settings.tokenUsage.menuDesc': 'Configurações de compressão e quantos tokens e dólares elas economizaram',
  ...
  'settings.tokenUsage.compressionDesc': 'Compactação ciente do conteúdo de grandes saídas de ferramentas antes de entrarem no contexto do modelo.',
  ...
  'settings.tokenUsage.searchDesc': 'Ordenar a saída de grep/busca por relevância, mantendo as melhores correspondências.',
  ...
  'settings.tokenUsage.mlDesc': 'Modelo ModernBERT local para texto simples (requer ambiente de execução Python).',
  'settings.tokenUsage.ccrTitle': 'Cache e recuperação (CCR)',
  'settings.tokenUsage.ccrDesc': 'Os originais compactados ficam em cache para que o agente possa buscar o texto completo sob demanda.',
  'settings.tokenUsage.ccrEnabled': 'Manter originais para recuperação',
  'settings.tokenUsage.ccrEnabledDesc': 'Descarregar o original e adicionar um marcador de recuperação para que nada se perca.',
  'settings.tokenUsage.ccrMinTokens': 'Tamanho mínimo para armazenar em cache',
  'settings.tokenUsage.ccrMinTokensDesc': 'Armazenar em cache e compactar com perdas apenas os resultados estimados nesse número de tokens ou mais.',
