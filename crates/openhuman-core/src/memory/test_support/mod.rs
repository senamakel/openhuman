...
pub(crate) fn install_memory_driver_for_test(config: &crate::config::Config) {
...
pub(crate) async fn settle_memory_module() {
    use crate::modules::ops::LoadError;

    match crate::modules::ops::ensure_loaded_within(
        &crate::memory::binding::test_module_config(),
        crate::memory::binding::MODULE_ID,
