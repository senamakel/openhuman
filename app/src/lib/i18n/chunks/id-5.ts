...
const id5: TranslationMap = {
  ...
  'settings.localModel.status.issuesFound': '${diagnostics.issues.length} masalah ditemukan',
  ...
  'skills.meetingBots.comingSoon': '${selected.label} segera hadir',
  ...
  'skills.meetingBots.sendTo': 'Kirim ke ${selected.label}',
