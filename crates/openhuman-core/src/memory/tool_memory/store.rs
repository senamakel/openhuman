...
//! [`Arc<dyn Memory>`](crate::memory::Memory) the host already
...
use crate::memory::api::tool_memory::{tool_memory_namespace, ToolMemoryPriority, ToolMemoryRule};
...
impl ToolMemoryStore {
    ...
    pub async fn record(
        ...
        source: crate::memory::api::tool_memory::ToolMemorySource,
        tags: Vec<String>,
