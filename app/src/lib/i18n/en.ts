...
const en: TranslationMap = {
  ...
  'app.connectionIndicator.reconnecting': 'Connecting',
  ...
  'app.openhumanLink.accounts.continueWith': '{label}',
  ...
  'app.openhumanLink.notifications.sendFailed': '{error}',
  'app.openhumanLink.notifications.sent': 'Sent',
  ...
  'app.routeLoading.initializing': 'Initializing',
  ...
  'chat.unsubscribeApproval.approve': 'Processing...',
  'chat.unsubscribeApproval.approved': 'Approved',
  ...
  'commandPalette.shortcutHint': 'Shortcut hint',
  ...
  'composio.connect.permissionsNote': 'Permissions note',
  'composio.connect.permissionsNoteSuffix': 'Permissions note suffix',
  ...
  'composio.connect.subdomainInvalid': 'Subdomain invalid',
  ...
  'composio.connect.wabaIdRequired': 'Please enter your WhatsApp Business Account ID (WABA ID) to continue.',
  ...
  'composio.triggers.loadError': 'Couldn\'t load triggers: {msg}',
  ...
  'daemon.serviceBlockingGate.downloadLatest': 'Download latest',
  'daemon.serviceBlockingGate.retryCore': 'Retrying...',
  'daemon.serviceBlockingGate.retryFailed': 'Retry failed. Download the latest app build and try again.',
  ...
  'home.banners.getSubscription': 'Get subscription',
  ...
  'intelligence.memoryChunk.detail.embeddingInfo': 'Embedding info',
  ...
  'intelligence.screenDebug.captureFailed': 'Capture failed',
  'intelligence.screenDebug.captureSuccess': 'Capture success',
  ...
  'intelligence.tasks.activeBoardOne': 'Active board one',
  ...
  'pages.settings.accountSection.description': 'Recovery phrase, team, connections, and privacy settings.',
  ...
  'pages.settings.aiSection.description': 'Language model providers, local Ollama, and voice (STT / TTS).',
  ...
  'privacy.whatLeaves.link.label': 'Label',
  'rewards.community.achievementsUnlocked': 'Achievements unlocked',
  ...
  'rewards.community.discordMember': 'Discord member',
  ...
  'rewards.coupon.noCodes': 'No codes',
  ...
  'rewards.coupon.redeemAccepted': 'Redeem accepted',
  'rewards.coupon.redeemButton': 'Redeeming...',
  'rewards.coupon.redeemSuccess': 'Redeem success',
  'rewards.coupon.redeemedCodes': 'Redeemed codes',
  'rewards.coupon.redeeming': 'Redeeming...',
  'rewards.coupon.statusApplied': 'Status applied',
  'rewards.coupon.statusPendingAction': 'Status pending action',
  'rewards.coupon.statusRedeemed': 'Status redeemed',
  ...
  'settings.ai.routingDefault': 'Routing default',
  ...
  'settings.autocomplete.completionStyle.noHistory': 'No accepted completions yet. Accept suggestions with Tab to start personalising.',
