  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="h-7 inline-flex items-center gap-1.5 rounded-lg border border-line bg-surface hover:bg-stone-50 dark:hover:bg-neutral-800/60 text-xs font-medium text-content-secondary transition-colors px-2">
        <svg
          aria-hidden="true"
