...
/// evaluates it under.
///
/// Reuses [`curated_scope_for`](tinymemory_core::sync::composio::providers::curated_scope_for),
...
/// [`classify_unknown`](tinymemory_core::sync::composio::providers::classify_unknown)
...
pub(crate) async fn classify_composio_action_for_tier(slug: &str) -> CommandClass {
    use tinymemory_core::sync::composio::providers::{curated_scope_for, ToolScope};
