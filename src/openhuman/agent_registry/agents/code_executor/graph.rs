//! LangGraph-compatible execution chain for the `code_executor` built-in agent.
//!
...
/// The `code_executor` agent's execution chain.
pub fn graph() -> GraphBlueprint {
    blueprint::canonical_turn("code_executor")
}
