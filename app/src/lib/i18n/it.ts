...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'Osservazione in sola lettura ogni 30 minuti. Solo accesso a memoria e file.',
  'subconscious.mode.aggressive.title': 'Aggressivo',
  'subconscious.mode.aggressive.desc': 'Accesso completo agli strumenti ogni 5 minuti. Può scrivere, creare agenti e delegare compiti.',
  'subconscious.mode.aggressiveWarning': 'La modalità aggressiva concede al subconscio accesso completo agli strumenti, inclusa scrittura e creazione di sotto-agenti.',
