    ...
    <div data-testid="settings-privacy-panel">
      ...
      <div>
        <div className="p-4 space-y-4">
          ...
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-wider text-stone-400 dark:text-neutral-500 dark:text-neutral-500 mb-3 px-1">
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          ...
                          {cap.privacy.destinations.length > 0 && (
                            <p className="text-xs text-stone-400 dark:text-neutral-500 dark:text-neutral-500 mt-1">
          ...
          <div className="p-4 bg-stone-50 dark:bg-neutral-800/60 dark:bg-neutral-800/60 rounded-xl border border-stone-200 dark:border-neutral-800 dark:border-neutral-800">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-xs text-stone-500 dark:text-neutral-400 dark:text-neutral-400 leading-relaxed">
