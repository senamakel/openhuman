...
const messages: TranslationMap = {
  ...
  'subconscious.mode.simple.desc': 'Nur-Lese-Beobachtung alle 30 Minuten. Nur Speicher- und Dateizugriff.',
  'subconscious.mode.aggressive.title': 'Aggressiv',
  'subconscious.mode.aggressive.desc': 'Voller Werkzeugzugriff alle 5 Minuten. Kann schreiben, Agenten starten und Aufgaben delegieren.',
  'subconscious.mode.aggressiveWarning': 'Aggressiver Modus gewährt dem Unterbewusstsein vollen Werkzeugzugriff einschließlich Schreiben und Sub-Agenten-Erstellung.',
