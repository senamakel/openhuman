...
const WebviewHost = ({ accountId, provider }: WebviewHostProps) => {
  ...
  return (
    <div
      ref={ref}
      className="relative h-full w-full overflow-hidden rounded-2xl border border-stone-200/70 dark:border-neutral-800/70 bg-stone-100 dark:bg-neutral-800 shadow-soft"
      ...
      {isTimeout ? (
        <div
          ...
          className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-4 bg-stone-50/95 dark:bg-neutral-800/95 px-6 text-center"
          role="status"
          aria-live="polite"
