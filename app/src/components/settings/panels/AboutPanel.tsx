    ...
    <div className="z-10 relative">
      ...
      <div className="p-4 space-y-4">
        <div className="rounded-xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4">
          <div className="text-xs text-stone-500 dark:text-neutral-400">{t('settings.about.version')}</div>
          <div className="mt-1 text-lg font-semibold text-stone-900 dark:text-neutral-100">v{APP_VERSION}</div>
        ...
        <div className="rounded-xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4">
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-1 text-xs text-stone-500 dark:text-neutral-400 leading-relaxed">{summary}</div>
              {lastCheckedAt && (
        ...
        <div className="rounded-xl border border-stone-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4">
          <div className="text-sm font-medium text-stone-900 dark:text-neutral-100">{t('settings.about.releases')}</div>
          ...
          <button
            ...
            className="mt-3 px-3 py-1.5 rounded-lg border border-stone-200 dark:border-neutral-800 text-stone-700 dark:text-neutral-200 hover:bg-stone-100 dark:hover:bg-neutral-800/60 text-xs transition-colors">
