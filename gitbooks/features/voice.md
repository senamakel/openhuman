...
- Streams audio out to STT in real time, transcribes everyone in the call, and writes structured notes into the [Memory Tree](memory-tree.md) as the meeting progresses.
...
- [Memory Tree](memory-tree.md) — where Meet transcripts and notes live.
