...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'Consiglio',
  'modelCouncil.title': 'Consiglio dei modelli',
  'modelCouncil.intro':
    'Fai una domanda, ottieni risposte indipendenti da più modelli in parallelo, poi un presidente sintetizza dove concordano, dove divergono e cosa ciascuno aggiunge.',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro':
    'Scegli un consiglio salvato, modifica agenti e giudice, oppure crea un nuovo consiglio per un tipo specifico di decisione.',
  ...
  'modelCouncil.savingCouncil': 'Salvataggio…',
  'modelCouncil.cancelEdit': 'Annulla',
  'modelCouncil.loadingCouncils': 'Caricamento consigli…',
  ...
  'modelCouncil.registryErrorPrefix': 'Registro consigli non riuscito:',
  'modelCouncil.councilNameLabel': 'Nome del consiglio',
  'modelCouncil.councilDescriptionLabel': 'Descrizione',
  'modelCouncil.councilDescriptionPlaceholder': 'Quando usare questo consiglio',
  'modelCouncil.selectModel': 'Seleziona',
  'modelCouncil.modelPickerHelp':
    'Seleziona un suggerimento di routing o fissa un modello provider esatto.',
  'modelCouncil.closeModelPicker': 'Chiudi',
  'modelCouncil.modelPickerHints': 'Suggerimenti',
  'modelCouncil.modelPickerProviderModel': 'Provider + modello',
  'modelCouncil.modelProviderLabel': 'Provider del modello',
  'modelCouncil.modelIdLabel': 'ID modello',
  'modelCouncil.useProviderModel': 'Usa modello provider',
  'modelCouncil.questionLabel': 'Domanda',
  ...
  'modelCouncil.modelHint.default': 'Predefinito',
  'modelCouncil.modelHint.chat': 'Chat',
  'modelCouncil.modelHint.reasoning': 'Ragionamento',
  'modelCouncil.modelHint.code': 'Codice',
  'modelCouncil.modelHint.summarize': 'Riassumi',
  'modelCouncil.defaultSeat.analyst.name': 'Analista',
  'modelCouncil.defaultSeat.analyst.brief': 'Prove, ipotesi e rischi.',
  'modelCouncil.defaultSeat.builder.name': 'Costruttore',
  'modelCouncil.defaultSeat.builder.brief': 'Percorso pratico di implementazione.',
  'modelCouncil.defaultSeat.skeptic.name': 'Scettico',
  'modelCouncil.defaultSeat.skeptic.brief': 'Modalità di errore e contesto mancante.',
  'modelCouncil.defaultCouncilName': 'Nuovo consiglio',
  'modelCouncil.defaultJudgeName': 'Giudice capo',
  'modelCouncil.untitledCouncilName': 'Consiglio senza titolo',
  ...
  'modelCouncil.debateRoundsHelp':
    'Ogni giurato continua a discutere per più turni prima che il giudice scriva la sintesi finale.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Gli aggiornamenti dei giurati vengono aggiunti qui dopo ogni round e poi passati al round successivo.',
  'modelCouncil.liveScratchpadBadge': 'Live',
  'modelCouncil.scratchpadRoundHeading': 'Aggiornamenti round {round}',
  ...
  'modelCouncil.running': 'Convocazione…',
  ...
  'modelCouncil.deliberationHelp':
    'Le mascotte mostrano ogni agente mentre pensa durante l’uso del file di ragionamento condiviso.',
  'modelCouncil.debateRoundInstruction':
    'Rispondi agli altri giurati finora. Mantieni i disaccordi, rivedi la tua posizione quando serve e rendi esplicita la conclusione attuale.',
  'modelCouncil.debateFinalInstruction':
    'Questo è il tuo ultimo turno da giurato. Convergi dove le prove lo supportano, segnala il disaccordo rimanente e consegna al giudice una conclusione chiara.',
  'modelCouncil.roundLabel': 'Round {round}',
  'modelCouncil.currentRoundThinking': 'Continua il turno successivo…',
  'modelCouncil.thinkingBadge': 'Sta pensando',
  'modelCouncil.thinkingWithBrief': 'Lavora da questa prospettiva: {brief}',
  'modelCouncil.thought.evidence':
    'Controlla prove, ipotesi e ciò che il file di ragionamento condiviso contiene già.',
  'modelCouncil.thought.plan':
    'Abbozza il percorso pratico e dove l’esecuzione potrebbe bloccarsi.',
  'modelCouncil.thought.risk': 'Cerca modalità di errore, contesto mancante e conclusioni fragili.',
  'modelCouncil.thought.tradeoffs':
    'Confronta i compromessi prima di consegnare al giudice una posizione concisa.',
  'modelCouncil.thought.synthesis':
    'Prepara una visione distinta così il giudice può confrontare veri disaccordi.',
  'modelCouncil.judgeWaitingBadge': 'Giudice',
  'modelCouncil.judgeWaitingThought':
    'Attende le risposte dei giurati, poi legge il file di ragionamento condiviso per sintetizzare.',
  'modelCouncil.judgeSynthesizingBadge': 'Sintesi',
  'modelCouncil.judgeSynthesizingThought':
    'Legge i pensieri live dei giurati e scrive la sintesi finale del consiglio.',
  'modelCouncil.errorPrefix': 'Consiglio non riuscito:',
  'modelCouncil.resultsHeading': 'Risultati del consiglio',
  'modelCouncil.memberAnswered': 'Risposto',
  'modelCouncil.memberFailed': 'Non riuscito',
  'modelCouncil.synthesisHeading': 'Sintesi',
  'modelCouncil.synthesisBy': 'da {model}',
  'modelCouncil.usageHeading': 'Uso del dibattito',
  'modelCouncil.usageEstimated':
    'Stimato da prompt e risposte del dibattito finché l’uso del provider non viene collegato all’RPC del consiglio.',
  'modelCouncil.usageEstimatedBadge': 'Token stimati',
  'modelCouncil.usageInputTokens': 'Input',
  'modelCouncil.usageOutputTokens': 'Output',
  'modelCouncil.usageTotalTokens': 'Totale',
