    ...
    <div>
      ...
      <div className="p-4 space-y-4">
        <section className="space-y-1">
          <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 dark:text-neutral-100">{t('cron.scheduledJobs')}</h3>
          <p className="text-xs text-stone-400 dark:text-neutral-500 dark:text-neutral-500">{t('cron.manageCronJobs')}</p>
        </section>
