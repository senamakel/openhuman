...
const messages: TranslationMap = {
  ...
  'settings.tokenUsage.compressionDesc': '대용량 도구 출력이 모델 컨텍스트에 들어가기 전에 콘텐츠를 인식하여 압축합니다.',
  ...
  'settings.tokenUsage.searchDesc': 'grep/검색 출력을 관련성 순으로 정렬하고 상위 일치 항목을 유지합니다.',
  ...
  'settings.tokenUsage.ccrDesc': '압축된 원본이 캐시되어 에이전트가 필요할 때 전체 텍스트를 가져올 수 있습니다.',
  'settings.tokenUsage.ccrEnabled': '복구를 위해 원본 유지',
  'settings.tokenUsage.ccrEnabledDesc': '원본을 오프로드하고 검색 표식을 추가하여 아무것도 손실되지 않도록 합니다.',
  'settings.tokenUsage.ccrMinTokens': '캐시할 최소 크기',
  'settings.tokenUsage.ccrMinTokensDesc': '이 토큰 수 이상으로 추정되는 결과만 캐시하고 손실 압축합니다.',
