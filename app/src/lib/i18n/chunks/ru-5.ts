...
const ru5: TranslationMap = {
  ...
  'settings.composio.apiKeyStoredPlaceholder': '••••••••••••  (ключ сохранён — вставь новый для замены)',
  ...
  'settings.localModel.deviceCapability.installOllamaFirst': 'Сначала установи Ollama для использования этого уровня',
