...
- `src/openhuman/agent/harness/session/agent_tool_exec.rs` and `src/openhuman/tinyagents/middleware.rs` — call `tool_registry::denials::record(...)` to log agent-tool policy denials.
