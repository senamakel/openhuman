        ...
        <div className="p-4 space-y-4">
          ...
          {isLoadingInvites && invites.length === 0 ? (
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-3 text-sm text-stone-500 dark:text-neutral-400">Loading invites...</span>
            </div>
          ) : invites.length > 0 ? (
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-lg transition-colors ${
                            status === 'active'
                              ? 'text-stone-500 dark:text-neutral-400 hover:text-stone-900 dark:hover:text-neutral-100 dark:text-neutral-100 hover:bg-stone-100 dark:hover:bg-neutral-800 dark:bg-neutral-800'
          ...
          {inviteToRevoke && (
            <div className="fixed inset-0 bg-stone-900/50 flex items-center justify-center z-50 p-4">
              <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 w-full max-w-md border border-stone-200 dark:border-neutral-800">
                <h3 className="text-sm font-semibold text-stone-900 dark:text-neutral-100 mb-4">Revoke Invite Code</h3>
