...
//! [`crate::agent::tinyagents::journal`] — it opens the same
...
/// [`crate::agent::tinyagents::journal::read_run_events`] uses). Best-effort:
...
/// ([`crate::agent::tinyagents::journal::read_run_status`] /
