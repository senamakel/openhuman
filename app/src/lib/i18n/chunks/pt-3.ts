...
const pt3: TranslationMap = {
  ...
  'app.connectionIndicator.reconnecting': 'Conectando',
  ...
  'app.openhumanLink.notifications.sent': 'Enviado',
  ...
  'app.routeLoading.initializing': 'Inicializando',
  ...
  'channels.discord.picker.serverChannelSelection': 'Seleção de canal do servidor',
