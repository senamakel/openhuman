...
const bn3: TranslationMap = {
  ...
  'app.connectionIndicator.reconnecting': 'সংযোগ হচ্ছে',
  ...
  'app.openhumanLink.notifications.sent': 'পাঠানো হয়েছে',
  ...
  'app.routeLoading.initializing': 'শুরু হচ্ছে',
  ...
  'app.update.progress.downloaded': '${formatBytes(downloaded)} ডাউনলোড হয়েছে',
  ...
  'channels.discord.picker.serverChannelSelection': 'সার্ভার চ্যানেল নির্বাচন',
