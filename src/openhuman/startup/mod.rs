...
//!
//! Keeps transport bootstrap code focused on orchestration while domain-specific
//! startup concerns (such as one-shot workspace migrations) live behind a
//! stable, product-level entrypoint.
