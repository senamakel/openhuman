...
const messages: TranslationMap = {
  ...
  'subconscious.scratchpadInfo': 'El subconsciente mantiene un bloc de notas persistente de observaciones a través de los ciclos. Consulta Configuración → Acceso del agente para configurar el modo y la frecuencia.',
