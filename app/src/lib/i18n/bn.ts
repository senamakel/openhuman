...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.approvalExpired.cause': 'কেউ সাড়া দেওয়ার আগেই অনুমোদনের অনুরোধের মেয়াদ শেষ হয়ে গেছে।',
  'conversations.toolFailure.approvalExpired.next': 'এটি চালাতে আবার বলুন — OpenHuman নিজে থেকে পুনরায় চেষ্টা করবে না।',
