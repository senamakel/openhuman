...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.denied.next': 'कुछ नहीं करना है — यह चलाई नहीं गई। मन बदलें तो फिर से कहें।',
  'conversations.toolFailure.approvalExpired.cause': 'किसी के जवाब देने से पहले ही अनुमोदन अनुरोध की समय-सीमा समाप्त हो गई।',
  'conversations.toolFailure.approvalExpired.next': 'इसे चलाने के लिए फिर से कहें — OpenHuman इसे स्वयं दोबारा नहीं आज़माएगा।',
