...
const BillingPanel = () => {
  ...
  const hasActive =
    ...
    false;
  const planExpiry =
    activeTeam?.team.subscription?.planExpiry ?? user?.subscription?.planExpiry;
        ...
        <div className="space-y-2">
            ...
            <div className="flex items-center justify-between mb-1.5">
              ...
              {usage && (
                <span className="text-xs text-stone-400">
                  {Math.round(
                    ((usage.dailyTokenLimit - usage.remainingTokens) /
          ...
          <div className="flex items-center justify-center gap-2 px-4">
            <button
              ...
              className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${billingInterval === "monthly"
            ...
            <button
              ...
              className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${billingInterval === "annual"
                ? "bg-primary-500/20 text-primary-400 border border-primary-500/30"
                : "text-stone-400 hover:text-stone-300"
                }`}
            >
          ...
          <div className="space-y-2 px-4">
            {PLANS.map((plan) => {
              ...
              return (
                <div
                  key={plan.tier}
                  className={`rounded-2xl border p-3 transition-all ${isCurrent
                  ...
                  <div className="flex items-start justify-between mb-2">
                    ...
                    {isUpgrade && (
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors flex-shrink-0 ${isPurchasing
          ...
          <div className="flex items-center justify-between rounded-xl bg-stone-800/40 border border-stone-700/40 p-3 mx-4">
            ...
            <button
              ...
              className={`relative w-10 h-5 rounded-full transition-colors ${paymentMethod === "crypto"
                ? "bg-primary-500"
                : "bg-stone-600"
                }`}
              role="switch"
            ...
            >
              <span
                className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white transition-transform ${paymentMethod === "crypto"
                  ? "translate-x-5"
                  : "translate-x-0"
                  }`}
              />
              ...
              <ul className="space-y-1.5 text-xs text-stone-300">
                ...
                {currentTier === "FREE" && (
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Save up to 20% with annual plans and never worry about
                      hitting limits
                    </span>
                  </li>
                )}
