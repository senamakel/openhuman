...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'परिषद',
  'modelCouncil.title': 'मॉडल परिषद',
  'modelCouncil.intro':
    'एक प्रश्न पूछें, कई मॉडलों से समानांतर स्वतंत्र उत्तर लें, फिर अध्यक्ष यह संश्लेषित करता है कि वे कहाँ सहमत हैं, कहाँ असहमत हैं और प्रत्येक क्या अलग जोड़ता है।',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro':
    'सहेजी गई परिषद चुनें, उसके एजेंट और न्यायाधीश संपादित करें, या किसी खास निर्णय के लिए नई परिषद बनाएँ।',
  ...
  'modelCouncil.savingCouncil': 'सहेजा जा रहा है…',
  'modelCouncil.cancelEdit': 'रद्द करें',
  'modelCouncil.loadingCouncils': 'परिषदें लोड हो रही हैं…',
  'modelCouncil.noCouncils': 'अभी कोई परिषद नहीं है। शुरू करने के लिए एक जोड़ें।',
  ...
  'modelCouncil.councilDescriptionLabel': 'विवरण',
  'modelCouncil.councilDescriptionPlaceholder': 'इस परिषद का उपयोग कब करें',
  'modelCouncil.selectModel': 'चुनें',
  'modelCouncil.modelPickerHelp': 'रूटिंग संकेत चुनें या सटीक प्रदाता मॉडल पिन करें।',
  'modelCouncil.closeModelPicker': 'बंद करें',
  'modelCouncil.modelPickerHints': 'संकेत',
  ...
  'modelCouncil.useProviderModel': 'प्रदाता मॉडल उपयोग करें',
  'modelCouncil.questionLabel': 'प्रश्न',
  'modelCouncil.questionPlaceholder': 'परिषद से प्रश्न पूछें…',
  'modelCouncil.membersLabel': 'सदस्य मॉडल',
  'modelCouncil.maxMembersNote': '{max} तक',
  'modelCouncil.memberPlaceholder': 'जैसे gpt-5.2',
  'modelCouncil.memberAria': 'सदस्य मॉडल {n}',
  'modelCouncil.removeMemberAria': 'सदस्य मॉडल {n} हटाएँ',
  'modelCouncil.addMember': '+ मॉडल जोड़ें',
  'modelCouncil.modelHint.default': 'डिफ़ॉल्ट',
  'modelCouncil.modelHint.chat': 'चैट',
  'modelCouncil.modelHint.reasoning': 'तर्क',
  'modelCouncil.modelHint.code': 'कोड',
  'modelCouncil.modelHint.summarize': 'सारांश',
  'modelCouncil.defaultSeat.analyst.name': 'विश्लेषक',
  'modelCouncil.defaultSeat.analyst.brief': 'साक्ष्य, अनुमान और जोखिम।',
  'modelCouncil.defaultSeat.builder.name': 'निर्माता',
  'modelCouncil.defaultSeat.builder.brief': 'व्यावहारिक कार्यान्वयन पथ।',
  'modelCouncil.defaultSeat.skeptic.name': 'संशयवादी',
  'modelCouncil.defaultSeat.skeptic.brief': 'विफलता के तरीके और अनुपस्थित संदर्भ।',
  'modelCouncil.defaultCouncilName': 'नई परिषद',
  'modelCouncil.defaultJudgeName': 'मुख्य न्यायाधीश',
  'modelCouncil.untitledCouncilName': 'शीर्षकहीन परिषद',
  ...
  'modelCouncil.debateRoundsLabel': 'बहस की बारी',
  'modelCouncil.debateRoundsHelp':
    'न्यायाधीश अंतिम संश्लेषण लिखने से पहले प्रत्येक जुरर कई बारी तक बहस करता रहता है।',
  ...
  'modelCouncil.liveScratchpadHelp':
    'हर राउंड के बाद जुरर अपडेट यहाँ जोड़े जाते हैं और फिर अगले राउंड में भेजे जाते हैं।',
  'modelCouncil.liveScratchpadBadge': 'लाइव',
  'modelCouncil.scratchpadRoundHeading': 'राउंड {round} अपडेट',
  'modelCouncil.scratchpadNoResponse': 'कोई उत्तर नहीं',
  'modelCouncil.chairLabel': 'अध्यक्ष मॉडल',
  'modelCouncil.chairPlaceholder': 'जैसे claude-opus-4-8',
  'modelCouncil.chairHelp': 'अध्यक्ष प्रत्येक सदस्य का उत्तर पढ़ता है और संश्लेषण लिखता है।',
  'modelCouncil.run': 'परिषद बुलाएँ',
  'modelCouncil.running': 'बुलाई जा रही है…',
  'modelCouncil.runningHint': 'सदस्यों से समानांतर पूछताछ, फिर संश्लेषण…',
  'modelCouncil.deliberationHeading': 'परिषद विचार-विमर्श',
  'modelCouncil.deliberationHelp':
    'साझा reasoning फ़ाइल उपयोग में होने पर मैस्कॉट हर एजेंट को सोचते हुए दिखाते हैं।',
  'modelCouncil.debateRoundInstruction':
    'अब तक के दूसरे जुररों को उत्तर दें। असहमतियों को बनाए रखें, ज़रूरत पड़ने पर अपना दृष्टिकोण संशोधित करें, और अपना वर्तमान निष्कर्ष स्पष्ट रखें।',
  'modelCouncil.debateFinalInstruction':
    'यह आपकी अंतिम जुरर बारी है। जहाँ साक्ष्य समर्थन करे वहाँ सहमति बनाएँ, शेष असहमति बताएं, और न्यायाधीश को स्पष्ट निष्कर्ष दें।',
  'modelCouncil.roundLabel': 'राउंड {round}',
  'modelCouncil.currentRoundThinking': 'अगली बारी जारी…',
  'modelCouncil.thinkingBadge': 'सोच रहा है',
  'modelCouncil.thinkingWithBrief': 'इस दृष्टिकोण से काम कर रहा है: {brief}',
  'modelCouncil.thought.evidence':
    'साक्ष्य, अनुमान और साझा reasoning फ़ाइल में पहले से दर्ज बातों की जाँच कर रहा है।',
  'modelCouncil.thought.plan':
    'व्यावहारिक रास्ता और जहाँ क्रियान्वयन अटक सकता है, उसका खाका बना रहा है।',
  'modelCouncil.thought.risk': 'विफलता के तरीके, अनुपस्थित संदर्भ और कमज़ोर निष्कर्ष खोज रहा है।',
  'modelCouncil.thought.tradeoffs':
    'न्यायाधीश को संक्षिप्त स्थिति देने से पहले विकल्पों की तुलना कर रहा है।',
  'modelCouncil.thought.synthesis':
    'अलग दृष्टिकोण तैयार कर रहा है ताकि न्यायाधीश वास्तविक असहमति की तुलना कर सके।',
  'modelCouncil.judgeWaitingBadge': 'न्यायाधीश',
  'modelCouncil.judgeWaitingThought':
    'जुररों के उत्तरों की प्रतीक्षा कर रहा है, फिर संश्लेषण के लिए साझा reasoning फ़ाइल पढ़ेगा।',
  'modelCouncil.judgeSynthesizingBadge': 'संश्लेषण',
  'modelCouncil.judgeSynthesizingThought': 'लाइव जुरर विचार पढ़कर अंतिम परिषद संश्लेषण लिख रहा है।',
  'modelCouncil.errorPrefix': 'परिषद विफल:',
  'modelCouncil.resultsHeading': 'परिषद परिणाम',
  'modelCouncil.memberAnswered': 'उत्तर दिया',
  'modelCouncil.memberFailed': 'विफल',
  'modelCouncil.synthesisHeading': 'संश्लेषण',
  'modelCouncil.synthesisBy': '{model} द्वारा',
  'modelCouncil.usageHeading': 'बहस उपयोग',
  'modelCouncil.usageEstimated':
    'जब तक प्रदाता उपयोग परिषद RPC से नहीं जुड़ता, बहस prompts और उत्तरों से अनुमानित।',
  'modelCouncil.usageEstimatedBadge': 'अनुमानित टोकन',
  'modelCouncil.usageInputTokens': 'इनपुट',
  'modelCouncil.usageOutputTokens': 'आउटपुट',
  'modelCouncil.usageTotalTokens': 'कुल',
