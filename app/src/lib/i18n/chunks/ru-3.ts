...
const ru3: TranslationMap = {
  ...
  'app.connectionIndicator.reconnecting': 'Подключение',
  ...
  'app.openhumanLink.notifications.sent': 'Отправлено',
  ...
  'app.routeLoading.initializing': 'Инициализация',
  ...
  'app.update.progress.downloaded': '${formatBytes(downloaded)} загружено',
  ...
  'channels.discord.picker.serverChannelSelection': 'Выбор канала сервера',
