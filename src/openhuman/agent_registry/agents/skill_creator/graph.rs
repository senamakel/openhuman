//! LangGraph-compatible execution chain for the `skill_creator` built-in agent.
//!
...
/// The `skill_creator` agent's execution chain.
pub fn graph() -> GraphBlueprint {
    blueprint::canonical_turn("skill_creator")
}
