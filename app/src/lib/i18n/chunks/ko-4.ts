...
const ko4: TranslationMap = {
  ...
  'composio.connect.dynamicsOrgNameHint': 'For example, "myorg" for myorg.crm.dynamics.com. Enter the short org name only, not the full URL.',
  'composio.connect.needsFieldsPrefix': 'To connect',
  'composio.connect.needsFieldsSuffix': 'we need a bit more information. Fill in the missing fields below and try again.',
  'composio.connect.requiredFieldEmpty': 'This field is required.',
  'composio.connect.wabaIdHint': 'Find it via GET /me/businesses then GET /{business_id}/owned_whatsapp_business_accounts using your Meta access token.',
  ...
  'pages.settings.account.migrationDesc': 'Migrate memory and notes from OpenClaw (or, soon, Hermes) into this workspace.',
  ...
  'pages.settings.features.desktopCompanionDesc': 'Voice assistant with screen awareness — listens, sees, speaks, points',
