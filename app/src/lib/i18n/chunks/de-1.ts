...
const de1: TranslationMap = {
  ...
  'settings.search.localManagedUnavailable':
    'OpenHuman Die verwaltete Suche ist für lokale Benutzer nicht verfügbar. Fügen Sie Ihren eigenen Parallel-, Brave- oder Querit-API-Schlüssel hinzu, um die Websuche zu aktivieren.',
