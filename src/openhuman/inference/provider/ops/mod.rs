...
pub use http_error::{
    api_error,
    is_backend_auth_failure,
    is_budget_exhausted_http_400,
    is_context_window_exceeded_message,
    is_custom_openai_upstream_bad_request_http_400,
    is_provider_access_policy_denied_http_403,
    is_provider_config_rejection_http,
    log_budget_exhausted_http_400,
    log_context_window_exceeded,
    log_custom_openai_upstream_bad_request_http_400,
    log_provider_access_policy_denied_http_403,
...
pub use models::{
    ...
    list_configured_models_from_config,
    merge_openai_codex_model_hints,
    model_items_from_body,
    parse_models_response,
    synthesize_local_runtime_entry,
    ModelInfo,
};

pub use provider_factory::{
    canonical_china_provider_name,
