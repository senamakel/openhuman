//! Resolving channel secrets that live outside `config.toml` (keyring /
//! credentials store), and per-channel HTTP client construction.
...
pub(super) fn resolve_yuanbao_app_secret(
...
pub(super) fn resolve_email_password(
