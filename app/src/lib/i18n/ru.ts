...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'Совет',
  'modelCouncil.title': 'Совет моделей',
  'modelCouncil.intro':
    'Задайте один вопрос, получите независимые ответы от нескольких моделей параллельно, а затем председатель сведет воедино, где они согласны, где расходятся и что каждая добавляет.',
  'modelCouncil.listTitle': 'Советы',
  'modelCouncil.listIntro':
    'Выберите сохраненный совет, измените его агентов и судью или создайте новый совет для конкретного типа решения.',
  'modelCouncil.addCouncil': 'Новый совет',
  'modelCouncil.openCouncil': 'Открыть совет',
  'modelCouncil.editCouncil': 'Изменить совет',
  'modelCouncil.editCurrentCouncil': 'Изменить текущий совет',
  'modelCouncil.editCouncilAria': 'Изменить {name}',
  ...
  'modelCouncil.questionLabel': 'Вопрос',
  'modelCouncil.questionPlaceholder': 'Задайте совету вопрос…',
  'modelCouncil.membersLabel': 'Модели участников',
  'modelCouncil.maxMembersNote': 'до {max}',
  'modelCouncil.memberPlaceholder': 'например gpt-5.2',
  ...
  'modelCouncil.modelHint.default': 'По умолчанию',
  'modelCouncil.modelHint.chat': 'Чат',
  'modelCouncil.modelHint.reasoning': 'Рассуждение',
  'modelCouncil.modelHint.code': 'Код',
  'modelCouncil.modelHint.summarize': 'Сводка',
  'modelCouncil.defaultSeat.analyst.name': 'Аналитик',
  'modelCouncil.defaultSeat.analyst.brief': 'Доказательства, допущения и риски.',
  'modelCouncil.defaultSeat.builder.name': 'Строитель',
  'modelCouncil.defaultSeat.builder.brief': 'Практический путь реализации.',
  'modelCouncil.defaultSeat.skeptic.name': 'Скептик',
  'modelCouncil.defaultSeat.skeptic.brief': 'Сценарии сбоев и недостающий контекст.',
  'modelCouncil.defaultCouncilName': 'Новый совет',
  'modelCouncil.defaultJudgeName': 'Главный судья',
  'modelCouncil.untitledCouncilName': 'Совет без названия',
  ...
  'modelCouncil.debateRoundsHelp':
    'Каждый присяжный продолжает дебаты несколько раундов, прежде чем судья напишет финальный синтез.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Обновления присяжных добавляются сюда после каждого раунда, а затем передаются в следующий раунд.',
  'modelCouncil.liveScratchpadBadge': 'Вживую',
  ...
  'modelCouncil.chairPlaceholder': 'например claude-opus-4-8',
  'modelCouncil.chairHelp': 'Председатель читает каждый ответ участников и пишет синтез.',
  'modelCouncil.run': 'Созвать совет',
  'modelCouncil.running': 'Созыв совета…',
  'modelCouncil.runningHint': 'Запрашиваем участников параллельно, затем синтезируем…',
  'modelCouncil.deliberationHeading': 'Обсуждение совета',
  'modelCouncil.deliberationHelp':
    'Маскоты показывают, как каждый агент думает, пока используется общий файл рассуждений.',
  'modelCouncil.debateRoundInstruction':
    'Ответьте другим присяжным на текущем этапе. Сохраняйте разногласия, пересматривайте мнение при необходимости и явно формулируйте текущий вывод.',
  'modelCouncil.debateFinalInstruction':
    'Это ваш финальный ход присяжного. Сойдитесь там, где это поддерживают доказательства, отметьте оставшиеся разногласия и передайте судье ясный вывод.',
  'modelCouncil.roundLabel': 'Раунд {round}',
  'modelCouncil.currentRoundThinking': 'Продолжает следующий ход…',
  'modelCouncil.thinkingBadge': 'Думает',
  'modelCouncil.thinkingWithBrief': 'Работает с этой перспективой: {brief}',
  'modelCouncil.thought.evidence':
    'Проверяет доказательства, допущения и то, что уже зафиксировано в общем файле рассуждений.',
  'modelCouncil.thought.plan': 'Намечает практический путь и места, где исполнение может застрять.',
  'modelCouncil.thought.risk': 'Ищет сценарии сбоев, недостающий контекст и хрупкие выводы.',
  'modelCouncil.thought.tradeoffs': 'Сравнивает компромиссы перед передачей судье краткой позиции.',
  'modelCouncil.thought.synthesis':
    'Готовит отдельную точку зрения, чтобы судья мог сравнить реальные разногласия.',
  'modelCouncil.judgeWaitingBadge': 'Судья',
  'modelCouncil.judgeWaitingThought':
    'Ждет ответы присяжных, затем читает общий файл рассуждений для синтеза.',
  'modelCouncil.judgeSynthesizingBadge': 'Синтез',
  'modelCouncil.judgeSynthesizingThought':
    'Читает живые мысли присяжных и пишет финальный синтез совета.',
  'modelCouncil.errorPrefix': 'Совет завершился ошибкой:',
  'modelCouncil.resultsHeading': 'Результаты совета',
  'modelCouncil.memberAnswered': 'Ответил',
  'modelCouncil.memberFailed': 'Ошибка',
  'modelCouncil.synthesisHeading': 'Синтез',
  'modelCouncil.synthesisBy': 'от {model}',
  'modelCouncil.usageHeading': 'Использование дебатов',
  'modelCouncil.usageEstimated':
    'Оценка по промптам и ответам дебатов, пока использование провайдера не подключено к RPC совета.',
  'modelCouncil.usageEstimatedBadge': 'Оценка токенов',
  'modelCouncil.usageInputTokens': 'Ввод',
  'modelCouncil.usageOutputTokens': 'Вывод',
  'modelCouncil.usageTotalTokens': 'Всего',
