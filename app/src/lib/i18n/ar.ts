...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'المجلس',
  'modelCouncil.title': 'مجلس النماذج',
  'modelCouncil.intro':
    'اطرح سؤالا واحدا، واحصل على إجابات مستقلة من عدة نماذج بالتوازي، ثم يلخص الرئيس مواضع الاتفاق والاختلاف وما يضيفه كل نموذج بشكل فريد.',
  'modelCouncil.listTitle': 'المجالس',
  'modelCouncil.listIntro':
    'اختر مجلسا محفوظا، أو عدل وكلاءه وقاضيه، أو أنشئ مجلسا جديدا لنوع محدد من القرارات.',
  'modelCouncil.addCouncil': 'مجلس جديد',
  'modelCouncil.openCouncil': 'افتح المجلس',
  'modelCouncil.editCouncil': 'عدّل المجلس',
  'modelCouncil.editCurrentCouncil': 'عدّل المجلس الحالي',
  'modelCouncil.editCouncilAria': 'عدّل {name}',
  'modelCouncil.deleteCouncilAria': 'احذف {name}',
  'modelCouncil.backToCouncils': 'العودة إلى المجالس',
  'modelCouncil.saveCouncil': 'احفظ المجلس',
  'modelCouncil.savingCouncil': 'جار الحفظ…',
  'modelCouncil.cancelEdit': 'إلغاء',
  'modelCouncil.loadingCouncils': 'جار تحميل المجالس…',
  'modelCouncil.noCouncils': 'لا توجد مجالس بعد. أضف مجلسا للبدء.',
  'modelCouncil.noCouncilDescription': 'لا يوجد وصف',
  'modelCouncil.registryErrorPrefix': 'فشل سجل المجلس:',
  'modelCouncil.councilNameLabel': 'اسم المجلس',
  'modelCouncil.councilDescriptionLabel': 'الوصف',
  'modelCouncil.councilDescriptionPlaceholder': 'متى يستخدم هذا المجلس',
  'modelCouncil.selectModel': 'اختيار',
  'modelCouncil.modelPickerHelp': 'اختر تلميح توجيه أو ثبت نموذج مزود محددا.',
  'modelCouncil.closeModelPicker': 'إغلاق',
  'modelCouncil.modelPickerHints': 'تلميحات',
  'modelCouncil.modelPickerProviderModel': 'المزود + النموذج',
  'modelCouncil.modelProviderLabel': 'مزود النموذج',
  'modelCouncil.modelIdLabel': 'معرف النموذج',
  'modelCouncil.useProviderModel': 'استخدم نموذج المزود',
  'modelCouncil.questionLabel': 'السؤال',
  'modelCouncil.questionPlaceholder': 'اطرح سؤالا على المجلس…',
  'modelCouncil.membersLabel': 'نماذج الأعضاء',
  'modelCouncil.maxMembersNote': 'حتى {max}',
  'modelCouncil.memberPlaceholder': 'مثلا gpt-5.2',
  'modelCouncil.memberAria': 'نموذج العضو {n}',
  'modelCouncil.removeMemberAria': 'إزالة نموذج العضو {n}',
  'modelCouncil.addMember': '+ أضف نموذجا',
  'modelCouncil.modelHint.default': 'افتراضي',
  'modelCouncil.modelHint.chat': 'دردشة',
  'modelCouncil.modelHint.reasoning': 'استدلال',
  'modelCouncil.modelHint.code': 'كود',
  'modelCouncil.modelHint.summarize': 'تلخيص',
  'modelCouncil.defaultSeat.analyst.name': 'محلل',
  'modelCouncil.defaultSeat.analyst.brief': 'الأدلة والافتراضات والمخاطر.',
  'modelCouncil.defaultSeat.builder.name': 'منفذ',
  'modelCouncil.defaultSeat.builder.brief': 'مسار التنفيذ العملي.',
  'modelCouncil.defaultSeat.skeptic.name': 'مشاكك',
  'modelCouncil.defaultSeat.skeptic.brief': 'أنماط الفشل والسياق الناقص.',
  'modelCouncil.defaultCouncilName': 'مجلس جديد',
  'modelCouncil.defaultJudgeName': 'القاضي الرئيسي',
  'modelCouncil.untitledCouncilName': 'مجلس بلا عنوان',
  ...
  'modelCouncil.debateRoundsLabel': 'أدوار النقاش',
  'modelCouncil.debateRoundsHelp':
    'يواصل كل محلف النقاش عبر عدة أدوار قبل أن يكتب القاضي الخلاصة النهائية.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'تضاف تحديثات المحلفين هنا بعد كل جولة، ثم تدخل في الجولة التالية.',
  'modelCouncil.liveScratchpadBadge': 'مباشر',
  ...
  'modelCouncil.chairPlaceholder': 'مثلا claude-opus-4-8',
  'modelCouncil.chairHelp': 'يقرأ الرئيس كل إجابة من الأعضاء ويكتب الخلاصة.',
  'modelCouncil.run': 'اعقد المجلس',
  'modelCouncil.running': 'جار عقد المجلس…',
  'modelCouncil.runningHint': 'جار سؤال الأعضاء بالتوازي، ثم كتابة الخلاصة…',
  'modelCouncil.deliberationHeading': 'مداولات المجلس',
  'modelCouncil.deliberationHelp':
    'تعرض الشخصيات كل وكيل وهو يفكر بينما يكون ملف التفكير المشترك قيد الاستخدام.',
  'modelCouncil.debateRoundInstruction':
    'استجب لما قاله المحلفون الآخرون حتى الآن. حافظ على نقاط الخلاف، وراجع رأيك عند الحاجة، واجعل استنتاجك الحالي واضحا.',
  'modelCouncil.debateFinalInstruction':
    'هذا هو دورك الأخير كمحلف. تقارب حيث تدعم الأدلة ذلك، واذكر الخلاف المتبقي، وسلم القاضي استنتاجا واضحا.',
  'modelCouncil.roundLabel': 'الجولة {round}',
  'modelCouncil.currentRoundThinking': 'جار متابعة الدور التالي…',
  'modelCouncil.thinkingBadge': 'يفكر',
  'modelCouncil.thinkingWithBrief': 'يعمل من هذا المنظور: {brief}',
  'modelCouncil.thought.evidence': 'يفحص الأدلة والافتراضات وما سجله ملف التفكير المشترك بالفعل.',
  'modelCouncil.thought.plan': 'يرسم المسار العملي وأماكن تعثر التنفيذ.',
  'modelCouncil.thought.risk': 'يبحث عن أنماط الفشل والسياق الناقص والاستنتاجات الهشة.',
  'modelCouncil.thought.tradeoffs': 'يقارن المفاضلات قبل تسليم القاضي موقفا موجزا.',
  'modelCouncil.thought.synthesis': 'يحضّر رؤية مميزة حتى يتمكن القاضي من مقارنة الخلاف الحقيقي.',
  'modelCouncil.judgeWaitingBadge': 'القاضي',
  'modelCouncil.judgeWaitingThought': 'ينتظر إجابات المحلفين، ثم يقرأ ملف التفكير المشترك للتلخيص.',
  'modelCouncil.judgeSynthesizingBadge': 'يلخص',
  'modelCouncil.judgeSynthesizingThought':
    'يقرأ أفكار المحلفين المباشرة ويكتب خلاصة المجلس النهائية.',
  'modelCouncil.errorPrefix': 'فشل المجلس:',
  'modelCouncil.resultsHeading': 'نتائج المجلس',
  'modelCouncil.memberAnswered': 'أجاب',
  'modelCouncil.memberFailed': 'فشل',
  'modelCouncil.synthesisHeading': 'الخلاصة',
  'modelCouncil.synthesisBy': 'بواسطة {model}',
  'modelCouncil.usageHeading': 'استخدام النقاش',
  'modelCouncil.usageEstimated':
    'تقدير من مطالبات النقاش واستجاباته إلى أن يرفق استخدام المزود بنداء RPC الخاص بالمجلس.',
  'modelCouncil.usageEstimatedBadge': 'رموز مقدرة',
  'modelCouncil.usageInputTokens': 'الإدخال',
  'modelCouncil.usageOutputTokens': 'الإخراج',
  'modelCouncil.usageTotalTokens': 'الإجمالي',
