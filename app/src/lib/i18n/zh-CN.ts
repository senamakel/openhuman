...
const messages: TranslationMap = {
  ...
  'memory.tab.council': '委员会',
  'modelCouncil.title': '模型委员会',
  'modelCouncil.intro':
    '提出一个问题，并行获得多个模型的独立回答，然后由主席综合它们的共识、分歧以及各自的独特贡献。',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro': '选择已保存的委员会，编辑其代理和法官，或为特定决策类型创建新委员会。',
  'modelCouncil.addCouncil': '新委员会',
  ...
  'modelCouncil.backToCouncils': '返回委员会',
  'modelCouncil.saveCouncil': '保存委员会',
  'modelCouncil.savingCouncil': '保存中…',
  'modelCouncil.cancelEdit': '取消',
  'modelCouncil.loadingCouncils': '正在加载委员会…',
  'modelCouncil.noCouncils': '还没有委员会。添加一个即可开始。',
  'modelCouncil.noCouncilDescription': '无描述',
  'modelCouncil.registryErrorPrefix': '委员会注册表失败：',
  'modelCouncil.councilNameLabel': '委员会名称',
  'modelCouncil.councilDescriptionLabel': '描述',
  'modelCouncil.councilDescriptionPlaceholder': '何时使用此委员会',
  'modelCouncil.selectModel': '选择',
  'modelCouncil.modelPickerHelp': '选择路由提示或固定精确的提供商模型。',
  'modelCouncil.closeModelPicker': '关闭',
  'modelCouncil.modelPickerHints': '提示',
  'modelCouncil.modelPickerProviderModel': '提供商 + 模型',
  'modelCouncil.modelProviderLabel': '模型提供商',
  'modelCouncil.modelIdLabel': '模型 ID',
  'modelCouncil.useProviderModel': '使用提供商模型',
  'modelCouncil.questionLabel': '问题',
  'modelCouncil.questionPlaceholder': '向委员会提问…',
  'modelCouncil.membersLabel': '成员模型',
  'modelCouncil.maxMembersNote': '最多 {max}',
  ...
  'modelCouncil.modelHint.default': '默认',
  'modelCouncil.modelHint.chat': '聊天',
  'modelCouncil.modelHint.reasoning': '推理',
  'modelCouncil.modelHint.code': '代码',
  'modelCouncil.modelHint.summarize': '总结',
  'modelCouncil.defaultSeat.analyst.name': '分析师',
  'modelCouncil.defaultSeat.analyst.brief': '证据、假设和风险。',
  'modelCouncil.defaultSeat.builder.name': '构建者',
  'modelCouncil.defaultSeat.builder.brief': '实际实施路径。',
  'modelCouncil.defaultSeat.skeptic.name': '质疑者',
  'modelCouncil.defaultSeat.skeptic.brief': '失败模式和缺失背景。',
  'modelCouncil.defaultCouncilName': '新委员会',
  'modelCouncil.defaultJudgeName': '首席法官',
  'modelCouncil.untitledCouncilName': '未命名委员会',
  ...
  'modelCouncil.debateRoundsHelp': '每位陪审员会持续多轮辩论，然后法官再撰写最终综合。',
  ...
  'modelCouncil.liveScratchpadHelp': '每轮结束后，陪审员更新会追加到这里，并进入下一轮。',
  'modelCouncil.liveScratchpadBadge': '实时',
  'modelCouncil.scratchpadRoundHeading': '第 {round} 轮更新',
  'modelCouncil.scratchpadNoResponse': '无回应',
  'modelCouncil.chairLabel': '主席模型',
  'modelCouncil.chairPlaceholder': '例如 claude-opus-4-8',
  'modelCouncil.chairHelp': '主席会阅读每位成员的回答并撰写综合。',
  'modelCouncil.run': '召集委员会',
  'modelCouncil.running': '正在召集…',
  'modelCouncil.runningHint': '正在并行询问成员，然后综合…',
  'modelCouncil.deliberationHeading': '委员会审议',
  'modelCouncil.deliberationHelp': '共享推理文件生效时，吉祥物会展示每个代理正在思考。',
  'modelCouncil.debateRoundInstruction':
    '回应目前其他陪审员的观点。保留分歧，必要时修正看法，并明确当前结论。',
  'modelCouncil.debateFinalInstruction':
    '这是你的最后一轮陪审员发言。在证据支持处形成共识，指出剩余分歧，并交给法官清晰结论。',
  'modelCouncil.roundLabel': '第 {round} 轮',
  'modelCouncil.currentRoundThinking': '继续下一轮…',
  'modelCouncil.thinkingBadge': '思考中',
  'modelCouncil.thinkingWithBrief': '从这个视角工作：{brief}',
  'modelCouncil.thought.evidence': '正在检查证据、假设以及共享推理文件已捕捉的内容。',
  'modelCouncil.thought.plan': '正在梳理实际路径以及执行可能卡住的地方。',
  'modelCouncil.thought.risk': '正在寻找失败模式、缺失上下文和脆弱结论。',
  'modelCouncil.thought.tradeoffs': '在向法官交付简洁立场前比较权衡。',
  'modelCouncil.thought.synthesis': '正在准备独立观点，方便法官比较真实分歧。',
  'modelCouncil.judgeWaitingBadge': '法官',
  'modelCouncil.judgeWaitingThought': '等待陪审员回答，然后读取共享推理文件进行综合。',
  'modelCouncil.judgeSynthesizingBadge': '正在综合',
  'modelCouncil.judgeSynthesizingThought': '正在读取实时陪审员想法并撰写最终委员会综合。',
  'modelCouncil.errorPrefix': '委员会失败：',
  'modelCouncil.resultsHeading': '委员会结果',
  'modelCouncil.memberAnswered': '已回答',
  'modelCouncil.memberFailed': '失败',
  'modelCouncil.synthesisHeading': '综合',
  'modelCouncil.synthesisBy': '由 {model}',
  'modelCouncil.usageHeading': '辩论用量',
  'modelCouncil.usageEstimated': '在提供商用量接入委员会 RPC 前，根据辩论提示和回答估算。',
  'modelCouncil.usageEstimatedBadge': '估算令牌',
  'modelCouncil.usageInputTokens': '输入',
  'modelCouncil.usageOutputTokens': '输出',
  'modelCouncil.usageTotalTokens': '总计',
