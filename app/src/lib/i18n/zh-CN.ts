...
const messages: TranslationMap = {
  ...
  'flows.templates.daily-digest.description': '按计划，代理编写简短摘要并发布到频道。',
  ...
  'flows.templates.webhook-triage.description': '传入的 Webhook 由代理分流，然后通知你。',
  ...
  'flows.templates.ask-agent.name': '询问代理',
  'flows.templates.ask-agent.description': '一个简单的手动触发器，将任务交给代理。',
