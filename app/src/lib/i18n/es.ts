...
const messages: TranslationMap = {
  ...
  'memory.tab.council': 'Consejo',
  'modelCouncil.title': 'Consejo de modelos',
  'modelCouncil.intro':
    'Haz una pregunta, recibe respuestas independientes de varios modelos en paralelo y luego un presidente sintetiza dónde coinciden, dónde discrepan y qué aporta cada uno.',
  'modelCouncil.listTitle': 'Consejos',
  'modelCouncil.listIntro':
    'Elige un consejo guardado, edita sus agentes y juez, o crea un consejo nuevo para un tipo concreto de decisión.',
  ...
  'modelCouncil.backToCouncils': 'Volver a consejos',
  ...
  'modelCouncil.noCouncils': 'Todavía no hay consejos. Agrega uno para empezar.',
  'modelCouncil.noCouncilDescription': 'Sin descripción',
  'modelCouncil.registryErrorPrefix': 'Falló el registro de consejos:',
  ...
  'modelCouncil.modelPickerHelp':
    'Selecciona una pista de enrutamiento o fija un modelo exacto de proveedor.',
  'modelCouncil.closeModelPicker': 'Cerrar',
  'modelCouncil.modelPickerHints': 'Pistas',
  ...
  'modelCouncil.memberPlaceholder': 'p. ej. gpt-5.2',
  ...
  'modelCouncil.modelHint.default': 'Predeterminado',
  'modelCouncil.modelHint.chat': 'Chat',
  'modelCouncil.modelHint.reasoning': 'Razonamiento',
  'modelCouncil.modelHint.code': 'Código',
  'modelCouncil.modelHint.summarize': 'Resumir',
  'modelCouncil.defaultSeat.analyst.name': 'Analista',
  'modelCouncil.defaultSeat.analyst.brief': 'Evidencia, supuestos y riesgo.',
  'modelCouncil.defaultSeat.builder.name': 'Constructor',
  'modelCouncil.defaultSeat.builder.brief': 'Ruta práctica de implementación.',
  'modelCouncil.defaultSeat.skeptic.name': 'Escéptico',
  'modelCouncil.defaultSeat.skeptic.brief': 'Modos de fallo y contexto faltante.',
  'modelCouncil.defaultCouncilName': 'Nuevo consejo',
  'modelCouncil.defaultJudgeName': 'Juez principal',
  'modelCouncil.untitledCouncilName': 'Consejo sin título',
  ...
  'modelCouncil.debateRoundsHelp':
    'Cada jurado sigue debatiendo durante varios turnos antes de que el juez escriba la síntesis final.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Las actualizaciones de los jurados se agregan aquí después de cada ronda y luego pasan a la siguiente.',
  'modelCouncil.liveScratchpadBadge': 'En vivo',
  ...
  'modelCouncil.chairPlaceholder': 'p. ej. claude-opus-4-8',
  'modelCouncil.chairHelp':
    'El presidente lee cada respuesta de los miembros y escribe la síntesis.',
  'modelCouncil.run': 'Convocar consejo',
  'modelCouncil.running': 'Convocando…',
  'modelCouncil.runningHint': 'Consultando miembros en paralelo y luego sintetizando…',
  'modelCouncil.deliberationHeading': 'Deliberación del consejo',
  'modelCouncil.deliberationHelp':
    'Las mascotas muestran a cada agente pensando mientras se usa el archivo de razonamiento compartido.',
  'modelCouncil.debateRoundInstruction':
    'Responde a los otros jurados hasta ahora. Conserva los desacuerdos, revisa tu postura cuando corresponda y deja explícita tu conclusión actual.',
  'modelCouncil.debateFinalInstruction':
    'Este es tu turno final como jurado. Converge donde la evidencia lo respalde, señala el desacuerdo restante y entrega al juez una conclusión clara.',
  'modelCouncil.roundLabel': 'Ronda {round}',
  'modelCouncil.currentRoundThinking': 'Continuando el siguiente turno…',
  ...
  'modelCouncil.thought.evidence':
    'Revisando evidencia, supuestos y lo que ya captura el archivo de razonamiento compartido.',
  'modelCouncil.thought.plan': 'Esbozando la ruta práctica y dónde podría atascarse la ejecución.',
  'modelCouncil.thought.risk':
    'Buscando modos de fallo, contexto faltante y conclusiones frágiles.',
  'modelCouncil.thought.tradeoffs':
    'Comparando compensaciones antes de entregar al juez una postura concisa.',
  'modelCouncil.thought.synthesis':
    'Preparando una visión distinta para que el juez compare desacuerdos reales.',
  'modelCouncil.judgeWaitingBadge': 'Juez',
  'modelCouncil.judgeWaitingThought':
    'Esperando las respuestas de los jurados y luego leyendo el archivo compartido para sintetizar.',
  'modelCouncil.judgeSynthesizingBadge': 'Sintetizando',
  'modelCouncil.judgeSynthesizingThought':
    'Leyendo los pensamientos en vivo de los jurados y escribiendo la síntesis final.',
  'modelCouncil.errorPrefix': 'El consejo falló:',
  'modelCouncil.resultsHeading': 'Resultados del consejo',
  'modelCouncil.memberAnswered': 'Respondió',
  'modelCouncil.memberFailed': 'Falló',
  ...
  'modelCouncil.usageEstimated':
    'Estimado a partir de prompts y respuestas del debate hasta que el uso del proveedor se adjunte al RPC del consejo.',
  'modelCouncil.usageEstimatedBadge': 'Tokens estimados',
  'modelCouncil.usageInputTokens': 'Entrada',
  'modelCouncil.usageOutputTokens': 'Salida',
