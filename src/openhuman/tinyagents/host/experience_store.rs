...
//! [`AgentExperienceCaptureHook`](crate::openhuman::agent_experience::AgentExperienceCaptureHook)
...
//! confined to
//! [`AGENT_EXPERIENCE_NAMESPACE`](crate::openhuman::agent_experience::AGENT_EXPERIENCE_NAMESPACE)
...
//!    [`redact_text`](crate::openhuman::agent_experience::redact_text) over the
...
mod tests {
    ...
    async fn secrets_are_redacted_before_they_reach_the_store() {
        ...
        assert!(found[0].outcome.contains("[redacted]"));
    }
    ...
    fn writes_stay_inside_the_procedural_namespace() {
        ...
        assert_eq!(
            crate::openhuman::agent_experience::AGENT_EXPERIENCE_NAMESPACE,
            "agent_experience"
        );
    }
