      ...
      <div
        ...
        <div className="p-6 pb-4">
          <div className="flex items-center gap-3">
            {modal.destructive && (
              <div className="w-10 h-10 rounded-full bg-coral-50 dark:bg-coral-500/100/10 flex items-center justify-center flex-shrink-0">
                <svg
            ...
            <div className="flex-1">
              <h2 className="text-lg font-semibold text-stone-900 dark:text-neutral-100">{modal.title}</h2>
