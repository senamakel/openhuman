...
const zhCN4: TranslationMap = {
  'chat.unsubscribeApproval.approve': '处理中...',
  'chat.unsubscribeApproval.approved': '已批准',
  'chat.unsubscribeApproval.denied': '✕ 请求已拒绝。',
  'chat.unsubscribeApproval.deny': '拒绝',
  'chat.unsubscribeApproval.processing': '处理中...',
  'chat.unsubscribeApproval.title': '审批请求',
  ...
  'commandPalette.shortcutHint': '快捷键提示',
  ...
  'composio.connect.idleDescription': '未连接',
  'composio.connect.idleDescriptionSuffix': '点击连接',
  'composio.connect.isConnected': '已连接',
  'composio.connect.manage': '管理',
  'composio.connect.needsSubdomain': '需要子域名',
  'composio.connect.needsSubdomainSuffix': '请输入子域名继续',
  'composio.connect.oauthComplete': 'OAuth 已完成',
  'composio.connect.oauthTimeout': 'OAuth 超时',
  'composio.connect.permissions': '权限',
  'composio.connect.permissionsDefault': '默认启用读写权限',
  'composio.connect.permissionsNote': '权限说明',
  'composio.connect.permissionsNoteSuffix': '权限说明补充',
  ...
  'composio.connect.subdomainInvalid': '子域名无效',
  ...
  'composio.triggers.listenFrom': '来自 {toolkitName} 的触发器',
  'composio.triggers.loadError': '无法加载触发器：{msg}',
  'composio.triggers.needsConfiguration': '需要配置',
  'composio.triggers.noneAvailable': '{toolkitName} 暂无可用触发器。',
  ...
  'daemon.serviceBlockingGate.retryCore': '重试中...',
  ...
  'home.banners.earlyBirdFirstSub': '首次订阅早鸟优惠',
  'home.banners.earlyBirdOn': '早鸟优惠进行中',
  'home.banners.earlyBirdTitle': '早鸟优惠',
  ...
  'intelligence.memoryChunk.detail.embeddingInfo': '嵌入信息',
  ...
  'intelligence.memoryChunk.mentioned.chunkOther': '多个片段',
  'intelligence.memoryChunk.mentioned.heading': '提及',
  'intelligence.memoryChunk.scoreBars.ariaScore': '评分',
  'intelligence.memoryChunk.scoreBars.atThreshold': '在阈值处',
  ...
  'intelligence.screenDebug.captureFailed': '捕获失败',
  'intelligence.screenDebug.captureSuccess': '捕获成功',
  ...
  'intelligence.tasks.activeBoardOne': '1 个活跃看板',
  'intelligence.tasks.activeBoardOther': '{count} 个看板',
  ...
  'onboarding.contextGathering.errorDesc': '构建档案时出现错误，请重试。',
  ...
  'privacy.whatLeaves.link.label': '标签',
  'rewards.community.achievementsUnlocked': '已解锁成就',
  ...
  'rewards.community.discordMember': 'Discord 成员',
  ...
  'rewards.coupon.redeemAccepted': '兑换已受理',
  'rewards.coupon.redeemButton': '兑换中...',
  'rewards.coupon.redeemSuccess': '兑换成功',
  'rewards.coupon.redeemedCodes': '已兑换代码',
  'rewards.coupon.redeeming': '兑换中...',
  'rewards.coupon.statusApplied': '已应用',
  'rewards.coupon.statusPendingAction': '等待操作',
  ...
  'settings.ai.addCloudProvider': '编辑提供商',
  ...
  'settings.ai.routingDefault': '默认路由',
