          ...
          <SettingsSection>
            ...
            {existingJob.last_output && (
              <div className="px-4 pb-4">
                ...
                <pre className="px-3 py-2 rounded-md bg-surface-subtle border border-neutral-200 dark:border-neutral-700 text-[11px] text-content-secondary font-mono whitespace-pre-wrap break-words max-h-48 overflow-y-auto">
                  {existingJob.last_output}
                </pre>
              </div>
            )}
                    ...
                    {runHistory.map(run => (
                      <div key={run.id} className="rounded bg-surface">
                        ...
                        {expandedRunId === run.id && run.output && (
                          <pre className="mx-2 mb-2 px-3 py-2 rounded-md bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 text-[11px] text-content-secondary font-mono whitespace-pre-wrap break-words max-h-64 overflow-y-auto">
                            {run.output}
                          </pre>
                        )}
                        {expandedRunId === run.id && !run.output && (
        ...
        {!existingJob && (
          <>
            ...
            {selectedRepo && !forkLoading && !forkInfo && (
              <div className="px-3 py-2 rounded-md bg-surface-muted border border-neutral-200 dark:border-neutral-700">
