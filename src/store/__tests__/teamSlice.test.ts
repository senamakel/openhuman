...
describe("teamSlice", () => {
  ...
  describe("fetchTeams", () => {
    ...
    it("should populate teams on fulfilled", () => {
      ...
      const state = reducer(
        initialState,
        fetchTeams.fulfilled(teams, "", undefined),
      );
  ...
  describe("fetchMembers", () => {
    it("should populate members on fulfilled", () => {
      ...
      const state = reducer(
        initialState,
        fetchMembers.fulfilled(members, "", "team-1"),
      );
    ...
    it("should set error on rejected", () => {
      const state = reducer(
        initialState,
        fetchMembers.rejected(null, "", "team-1", "Forbidden"),
      );
  ...
  describe("fetchInvites", () => {
    it("should populate invites on fulfilled", () => {
      ...
      const state = reducer(
        initialState,
        fetchInvites.fulfilled(invites, "", "team-1"),
      );
    ...
    it("should set error on rejected", () => {
      const state = reducer(
        initialState,
        fetchInvites.rejected(null, "", "team-1", "Not found"),
      );
